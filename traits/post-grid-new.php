    ...
    public function new_render_stylica_markup( $settings = [], $post = null ) {
		...
		<div class="skt-pg-item">
			<?php if ( 'yes' === $featured_image && has_post_thumbnail() ): ?>
				<div class="skt-pg-thumb-area">
					<a href="<?php echo esc_url( get_the_permalink( get_the_ID() ) ); ?>" class="skt-pg-thumb">
						<?php the_post_thumbnail( esc_attr($featured_image_size) );?>
						<?php echo esc_attr(sktaddonselementorextra_devider_shape( $devider_shape ));?>
                    </a>
                </div>
			<?php endif;?>
			<div class="skt-pg-content-area">
    ...
    protected function new_render_excerpt( $excerpt_length = false ) {
        ...
        ?>
			<div class="skt-pg-excerpt">
				<?php printf( '<p>%1$s</p>', esc_attr(skt_addons_elementor_pro_get_excerpt( get_the_ID()), $excerpt_length ) );?>
			</div>
		<?php
}
