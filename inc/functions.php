...
function skt_addons_elementor_do_shortcode($tag, array $atts = [], $content = null) {
	...
	$tag = esc_attr($tag); // Resolved escaping
...
function skt_addons_elementor_get_css_cursors() {
	return [
		...
		'alias'        => __('Alias', 'skt-addons-for-elementor'),
		'all-scroll'   => __('All scroll', 'skt-addons-for-elementor'),
		'auto'         => __('Auto', 'skt-addons-for-elementor'),
		'cell'         => __('Cell', 'skt-addons-for-elementor'),
		'context-menu' => __('Context menu', 'skt-addons-for-elementor'),
		'col-resize'   => __('Col-resize', 'skt-addons-for-elementor'),
		'copy'         => __('Copy', 'skt-addons-for-elementor'),
		'crosshair'    => __('Crosshair', 'skt-addons-for-elementor'),
		'e-resize'     => __('E-resize', 'skt-addons-for-elementor'),
		'ew-resize'    => __('EW-resize', 'skt-addons-for-elementor'),
		'grab'         => __('Grab', 'skt-addons-for-elementor'),
		'grabbing'     => __('Grabbing', 'skt-addons-for-elementor'),
		'help'         => __('Help', 'skt-addons-for-elementor'),
		'move'         => __('Move', 'skt-addons-for-elementor'),
		'n-resize'     => __('N-resize', 'skt-addons-for-elementor'),
		'ne-resize'    => __('NE-resize', 'skt-addons-for-elementor'),
		'nesw-resize'  => __('NESW-resize', 'skt-addons-for-elementor'),
		'ns-resize'    => __('NS-resize', 'skt-addons-for-elementor'),
		'nw-resize'    => __('NW-resize', 'skt-addons-for-elementor'),
		'nwse-resize'  => __('NWSE-resize', 'skt-addons-for-elementor'),
		'no-drop'      => __('No-drop', 'skt-addons-for-elementor'),
		'not-allowed'  => __('Not-allowed', 'skt-addons-for-elementor'),
		'pointer'      => __('Pointer', 'skt-addons-for-elementor'),
		'progress'     => __('Progress', 'skt-addons-for-elementor'),
		'row-resize'   => __('Row-resize', 'skt-addons-for-elementor'),
		's-resize'     => __('S-resize', 'skt-addons-for-elementor'),
		'se-resize'    => __('SE-resize', 'skt-addons-for-elementor'),
		'sw-resize'    => __('SW-resize', 'skt-addons-for-elementor'),
		'text'         => __('Text', 'skt-addons-for-elementor'),
		'url'          => __('URL', 'skt-addons-for-elementor'),
		'w-resize'     => __('W-resize', 'skt-addons-for-elementor'),
		'wait'         => __('Wait', 'skt-addons-for-elementor'),
		'zoom-in'      => __('Zoom-in', 'skt-addons-for-elementor'),
		'zoom-out'     => __('Zoom-out', 'skt-addons-for-elementor'),
...
function skt_addons_elementor_get_css_blend_modes() {
	return [
		...
		'multiply'    => __('Multiply', 'skt-addons-for-elementor'),
		'screen'      => __('Screen', 'skt-addons-for-elementor'),
		'overlay'     => __('Overlay', 'skt-addons-for-elementor'),
		'darken'      => __('Darken', 'skt-addons-for-elementor'),
		'lighten'     => __('Lighten', 'skt-addons-for-elementor'),
		'color-dodge' => __('Color Dodge', 'skt-addons-for-elementor'),
		'color-burn'  => __('Color Burn', 'skt-addons-for-elementor'),
		'saturation'  => __('Saturation', 'skt-addons-for-elementor'),
		'difference'  => __('Difference', 'skt-addons-for-elementor'),
		'exclusion'   => __('Exclusion', 'skt-addons-for-elementor'),
		'hue'         => __('Hue', 'skt-addons-for-elementor'),
		'color'       => __('Color', 'skt-addons-for-elementor'),
		'luminosity'  => __('Luminosity', 'skt-addons-for-elementor'),
	];
}
...
function skt_addons_elementor_render_icon($settings = [], $old_icon_id = 'icon', $new_icon_id = 'selected_icon', $attributes = []) {
	...
	if (skt_addons_elementor_is_elementor_version('>=', '2.6.0') && ($is_new || $migrated)) {
		...
		printf('<i %s></i>', \Elementor\Utils::render_html_attributes($attributes)); // phpcs:ignore  WordPress.Security.EscapeOutput.OutputNotEscaped 
	}
}
...
function skt_addons_elementor_get_allowed_html_desc($level = 'basic') {
	...
	/* translators: translate support text */
	return sprintf(__('This input field has support for the following HTML tags: %1$s', 'skt-addons-for-elementor'), '<code>' . esc_html($tags_str) . '</code>');
}
...
function sktaddonselementorextra_get_local_time($format = 'Y-m-d h:i:s A') {
	$local_time_zone = sanitize_text_field(isset($_COOKIE['SktLocalTimeZone']) && !empty($_COOKIE['SktLocalTimeZone']) ? str_replace('GMT ', 'GMT+', sanitize_text_field(wp_unslash($_COOKIE['SktLocalTimeZone']))) : date_default_timezone_get());
...
function skt_addons_elementor_get_credentials($key = '') {
	...
	if(!empty($key)) {
		return isset($creds[$key])? $creds[$key]: esc_html__('invalid key', 'skt-addons-for-elementor');
	}
	return $creds;
}
...
function skt_addons_elementor_show_plugin_missing_alert( $plugin ) {
	if ( current_user_can( 'activate_plugins' ) && $plugin ) {
		printf(
			...
			esc_attr($plugin) . esc_attr__( ' is missing! Please install and activate ', 'skt-addons-for-elementor' ) . esc_attr($plugin) . '.'
			);
	}
}
