...
class Floating_Effects {
	...
	public static function register( Element_Base $element ) {
		$element->start_controls_section(
			...
			[
				'label' => __( 'Floating Effects', 'skt-addons-for-elementor' ) . skt_addons_elementor_get_section_icon(),
		...
		$element->add_control(
			...
			[
				...
				'labels' => [
					__( 'From', 'skt-addons-for-elementor' ),
					__( 'To', 'skt-addons-for-elementor' ),
				],
				'scales' => 1,
				'handles' => 'range',
				'condition' => [
