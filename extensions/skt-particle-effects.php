        ...
        if (  ( 'section' === $element->get_name() && 'section_background' === $section_id ) || ( 'column' === $element->get_name() && 'section_style' === $section_id ) ) {
            ...
            $element->start_controls_section(
                ...
                [
                    ...
                    'label' => __( 'SKT Particle Effects', 'skt-addons-for-elementor' ) . skt_addons_elementor_get_section_icon(),
                ]
            );
            ...
            $element->add_control(
                ...
                [
                    ...
                    'label'        => __( 'Enable Particle Background', 'skt-addons-for-elementor' ),
                    'default'      => '',
            ...
            $element->add_control(
                ...
                [
                    ...
                    'default'     => 'nasa',
                    'options'     => [
                        'default' => __( 'Polygon', 'skt-addons-for-elementor' ),
                        'nasa'    => __( 'NASA', 'skt-addons-for-elementor' ),
                        'snow'    => __( 'Snow', 'skt-addons-for-elementor' ),
            ...
            $element->add_control(
                ...
                [
                    ...
                    'raw'             => __( 'Add custom JSON for the Particle Background below. To generate a completely customized background style follow steps below - ', 'skt-addons-for-elementor' ),
            ...
            $element->add_control(
                ...
                [
                    'type'            => Controls_Manager::RAW_HTML,
					/* translators: translate supportive raw text */
                    'raw'             => sprintf( __( '1. Visit a link %1$s here %2$s and choose required attributes for particle </br></br> 2. Once a custom style is created, download JSON from "Download current config (json)" link </br></br> 3. Copy JSON code from the downloaded file and paste it below', 'skt-addons-for-elementor' ), '<a href="https://vincentgarreau.com/particles.js/" target="_blank" rel="noopener">', '</a>' ),
                    'content_classes' => 'skt-editor-doc skt-editor-description',
                    'condition'       => [
                        'skt_addons_elementor_enable_particles' => 'yes',
                        'skt_addons_elementor_particles_styles' => 'custom',
            ...
            $element->add_control(
                ...
                [
                    'label'       => __( 'Particle Color', 'skt-addons-for-elementor' ),
            ...
            $element->add_control(
                ...
                [
                    'label'       => __( 'Flow Direction', 'skt-addons-for-elementor' ),
                    'type'        => Controls_Manager::SELECT,
                    'default'     => 'bottom',
                    'options'     => [
            ...
            $element->add_control(
                ...
                [
                    'type'         => Controls_Manager::SWITCHER,
                    'label'        => __( 'Advanced Settings', 'skt-addons-for-elementor' ),
                    'default'      => 'no',
                    'label_on'     => __( 'Yes', 'skt-addons-for-elementor' ),
                    'label_off'    => __( 'No', 'skt-addons-for-elementor' ),
                    'return_value' => 'yes',
            ...
            $element->add_control(
                ...
                [
                    'label'       => __( 'Number of Particles', 'skt-addons-for-elementor' ),
                    'type'        => Controls_Manager::SLIDER,
                    'range'       => [
                        'px' => [
                            'min' => 1,
            ...
            $element->add_control(
                ...
                [
                    'label'       => __( 'Particle Size', 'skt-addons-for-elementor' ),
                    'type'        => Controls_Manager::SLIDER,
                    'range'       => [
                        'px' => [
                            'min' => 1,
            ...
            $element->add_control(
                ...
                [
                    'label'       => __( 'Move Speed', 'skt-addons-for-elementor' ),
                    'type'        => Controls_Manager::SLIDER,
                    'range'       => [
                        'px' => [
                            'min' => 1,
            ...
            $element->add_control(
                ...
                [
                    'type'         => Controls_Manager::SWITCHER,
                    'label'        => __( 'Enable Hover Effect', 'skt-addons-for-elementor' ),
                    'default'      => 'no',
                    'label_on'     => __( 'Yes', 'skt-addons-for-elementor' ),
                    'label_off'    => __( 'No', 'skt-addons-for-elementor' ),
                    'return_value' => 'yes',
            ...
            $element->add_control(
                ...
                [
                    'type'            => Controls_Manager::RAW_HTML,
                    'raw'             => __( 'Particle hover effect will not work in the following scenarios - </br></br> 1. In the Elementor backend editor</br></br> 2. Content/Spacer added in the section/column occupies the entire space and leaves it inaccessible. Adding padding to the section/column can resolve this.', 'skt-addons-for-elementor' ),
    ...
    public static function _before_render( $element ) {
        ...
        if ( 'yes' === $settings['skt_addons_elementor_enable_particles'] ) {
            ...
            if ( 'custom' === $settings['skt_addons_elementor_particles_styles'] ) {
                $element->add_render_attribute( '_wrapper', 'data-skt-partdata', wp_json_encode( json_decode( $settings['skt_addons_elementor_particle_json'] ) ) );
            }
        }
    }
