...
class Shape_Divider {
	...
	public static function update_shape_list( Element_Base $element ) {
		...
		$element->update_control(
			...
			[
				...
				'groups' => [
					[
						'label' => __( 'Disable', 'skt-addons-for-elementor' ),
						'options' => [
							'' => __( 'None', 'skt-addons-for-elementor' ),
						],
					],
					[
						'label' => __( 'Default Shapes', 'skt-addons-for-elementor' ),
						'options' => $default_shapes,
					],
					[
						'label' => __( 'SKT Shapes', 'skt-addons-for-elementor' ),
	...
	public static function additional_shape_divider( $shape_list ) {
		$skt_addons_elementor_shapes = [
			'abstract-web' => [
				'title' => _x( 'Abstract Web', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'crossline' => [
				'title' => _x( 'Crossline', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'droplet' => [
				'title' => _x( 'Droplet', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'flame' => [
				'title' => _x( 'Flame', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'frame' => [
				'title' => _x( 'Frame', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'half-circle' => [
				'title' => _x( 'Half Circle', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'multi-cloud' => [
				'title' => _x( 'Multi Cloud', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'multi-wave' => [
				'title' => _x( 'Multi Wave', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'smooth-zigzag' => [
				'title' => _x( 'Smooth Zigzag', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'splash' => [
				'title' => _x( 'Splash', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'splash2' => [
				'title' => _x( 'Splash 2', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'torn-paper' => [
				'title' => _x( 'Torn Paper', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'brush' => [
				'title' => _x( 'Brush', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'sports' => [
				'title' => _x( 'Sports', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'landscape' => [
				'title' => _x( 'Landscape', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'nature' => [
				'title' => _x( 'Nature', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'desert' => [
				'title' => _x( 'Desert', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'under-water' => [
				'title' => _x( 'Under Water', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'cityscape-layer' => [
				'title' => _x( 'Cityscape Layer', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'drop' => [
				'title' => _x( 'Drop', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'mosque' => [
				'title' => _x( 'Mosque', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'christmas' => [
				'title' => _x( 'Christmas', 'Shapes', 'skt-addons-for-elementor' ),
			...
			'christmas2' => [
				'title' => _x( 'Christmas 2', 'Shapes', 'skt-addons-for-elementor' ),
