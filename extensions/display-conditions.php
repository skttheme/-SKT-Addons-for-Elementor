...
class Display_Conditions {
	...
	public function add_controls( $element, $args ) {
		...
		$element->add_control(
			...
			[
				'label'              => __( 'Display Condition', 'skt-addons-for-elementor' ),
		...
		$element->add_control(
			...
			[
				...
				'default'   => 'show',
				'options'   => [
					'show' => __( 'Show Element', 'skt-addons-for-elementor' ),
					'hide' => __( 'Hide Element', 'skt-addons-for-elementor' ),
				],
				'condition' => [
		...
		$element->add_control(
			...
			[
				'label'     => __( 'When', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'and',
				'options'   => [
					'and' => __( 'All Conditions Met', 'skt-addons-for-elementor' ),
					'or'  => __( 'Any Condition Met', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'_skt_addons_elementor_condition_enable' => 'yes',
				],
		...
		$element->add_control(
			...
			[
				'label'       => __( 'Timezone', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::SELECT,
				'description' => __( 'You can change Server', 'skt-addons-for-elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', admin_url() . '/options-general.php', __( 'Timezone', 'skt-addons-for-elementor' ) ),
				'default'     => 'server',
				'options'     => [
					'server' => __( 'Server Timezone', 'skt-addons-for-elementor' ),
					'local'  => __( 'Local Timezone', 'skt-addons-for-elementor' ),
				],
				'condition'   => [
					'_skt_addons_elementor_condition_enable' => 'yes',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'options'     => [
					'is'  => __( 'Is', 'skt-addons-for-elementor' ),
					'not' => __( 'Is not', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$element->add_control(
			...
			[
				'label'       => __( 'Conditions', 'skt-addons-for-elementor' ),
