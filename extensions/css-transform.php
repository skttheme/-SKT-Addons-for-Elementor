...
class CSS_Transform {
	...
	public static function register( Element_Base $element ) {
		$element->start_controls_section(
			...
			[
				'label' => __( 'CSS Transform', 'skt-addons-for-elementor' ) . skt_addons_elementor_get_section_icon(),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Enable', 'skt-addons-for-elementor' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Translate', 'skt-addons-for-elementor' ),
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Translate X', 'skt-addons-for-elementor' ),
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Translate Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$element->add_control(
			...
			[
				'label' => __( 'Mode', 'skt-addons-for-elementor' ),
				...
				'options' => [
					...
					'loose' => [
						'title' => __( 'Loose', 'skt-addons-for-elementor' ),
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Rotate X', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Rotate Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$element->add_control(
			...
			[
				'label' => __( 'Scale', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'return_value' => 'yes',
				'condition' => [
					'skt_addons_elementor_transform_fx' => 'yes',
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Scale (X)', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'default' => [
					'size' => 1
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Scale Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'default' => [
					'size' => 1
		...
		$element->add_control(
			...
			[
				'label' => __( 'Skew', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'return_value' => 'yes',
				'condition' => [
					'skt_addons_elementor_transform_fx' => 'yes',
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Skew X', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['deg'],
				'range' => [
					'px' => [
		...
		$element->add_responsive_control(
			...
			[
				'label' => __( 'Skew Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['deg'],
				'range' => [
					'px' => [
