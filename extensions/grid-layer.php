...
class Grid_Layer {
	...
	public static function add_controls_section( $element ) {
		$element->start_controls_section(
			...
			[
				'label' => __( 'Grid Layer', 'skt-addons-for-elementor' ) . skt_addons_elementor_get_section_icon(),
		...
		$element->add_control(
			...
			[
				'label'     => __( 'Grid Layer', 'skt-addons-for-elementor' ),
				'description'     => __( 'Use "Cmd/Ctrl + Shift + G" to On/Off Grid Layer', 'skt-addons-for-elementor' ),
		...
		$element->add_control(
			...
			[
				...
				'raw' => __( 'This feature is avilable only in editor and only for design purpose.', 'skt-addons-for-elementor' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Grid Layer On', 'skt-addons-for-elementor' ),
