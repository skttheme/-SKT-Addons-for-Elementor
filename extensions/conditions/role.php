...
class Role  extends Condition {
	...
	public function get_title() {
		return __( 'User Role', 'skt-addons-for-elementor' );
	}
	...
	public function get_repeater_control(array $condition) {
		...
		return [
			...
			'description' 	=> sprintf('<strong>%s</strong>%s',__( 'Note: ', 'skt-addons-for-elementor' ),__( 'This condition applies only to logged in users.', 'skt-addons-for-elementor' )),
			'default' 		=> 'subscriber',
			'label_block' 	=> true,
