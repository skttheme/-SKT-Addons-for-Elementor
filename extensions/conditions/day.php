...
class Day  extends Condition {
	...
	public function get_title() {
		return __( 'Day', 'skt-addons-for-elementor' );
	}
	...
	public function get_repeater_control(array $condition) {
		return[
			...
			'label_block' => true,
			'options' => [
				'monday'    => __( 'Monday', 'skt-addons-for-elementor' ),
				'tuesday'   => __( 'Tuesday', 'skt-addons-for-elementor' ),
				'wednesday' => __( 'Wednesday', 'skt-addons-for-elementor' ),
				'thursday'  => __( 'Thursday', 'skt-addons-for-elementor' ),
				'friday'    => __( 'Friday', 'skt-addons-for-elementor' ),
				'saturday'  => __( 'Saturday', 'skt-addons-for-elementor' ),
				'sunday'    => __( 'Sunday', 'skt-addons-for-elementor' ),
			],
			'condition'	=> $condition,
		];
	}
