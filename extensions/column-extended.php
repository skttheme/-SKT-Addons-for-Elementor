...
class Column_Extended {
    ...
    public static function add_controls( Element_Column $element ) {
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Custom Column Width', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'separator' => 'before',
                'label_block' => true,
                'description' => __( 'Here you can set the column width the way you always wanted to! e.g 250px, 50%, calc(100% - 250px)', 'skt-addons-for-elementor' ),
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Column Order', 'skt-addons-for-elementor' ),
				...
				/* translators: translate description text */
                    __( 'Column ordering is a great addition for responsive design. You can learn more about CSS order property from %1$sMDN%2$s.', 'skt-addons-for-elementor' ),
                    '<a
