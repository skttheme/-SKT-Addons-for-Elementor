...
<div class="skt-dashboard-panel">
    <div class="skt-dashboard-panel__header">
        <div class="skt-dashboard-panel__header-content">
            <p class="f16"><?php /* translators: translate feature text */ printf( esc_html__( 'Here is the list of all %1$s features. You can enable or disable features from here to optimize loading speed and Elementor editor experience. %2$sAfter enabling or disabling any feature make sure to click the Save Changes button.%3$s', 'skt-addons-for-elementor' ), esc_attr($total_features_count), '<strong>', '</strong>' ); ?></p>

            <div class="skt-action-list">
                <button type="button" class="skt-action--btn" data-action="enable_feature"><?php esc_html_e( 'Enable All', 'skt-addons-for-elementor' ); ?></button>
                <button type="button" class="skt-action--btn" data-action="disable_feature"><?php esc_html_e( 'Disable All', 'skt-addons-for-elementor' ); ?></button>
            </div>
        </div>
    </div>
