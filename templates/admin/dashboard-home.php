    ...
    <div class="skt-home-body">
        <div class="skt-row skt-py-5 skt-align-items-center">
            <div class="skt-col skt-col-6">
                ...
                <h3 class="skt-feature-title"><?php esc_html_e('Documentation', 'skt-addons-for-elementor'); ?></h3>
                <p class="f18"><?php esc_html_e('We have created documentation for you. It will help you to understand how our plugin works.', 'skt-addons-for-elementor'); ?></p>
                <a class="skt-btn skt-btn-primary" target="_blank" rel="noopener" href="https://sktthemesdemo.net/documentation/skt-addons-for-elementor-documentation"><?php esc_html_e('View Documentation', 'skt-addons-for-elementor'); ?></a>
            </div>
            <div class="skt-col skt-col-6">
