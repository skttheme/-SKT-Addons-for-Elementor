...
<div class="skt-dashboard-panel">
    <div class="skt-dashboard-panel__header">
        <div class="skt-dashboard-panel__header-content">
            <p class="f16"><?php /* translators: translate info text */ printf(esc_html__('You can enter credentials from here. %1$sAfter changing any input make sure to click the Save Changes button.%2$s', 'skt-addons-for-elementor'), '<strong>', '</strong>'); ?></p>
        </div>
    </div>
        ...
        ?>
            <div class="<?php echo esc_attr($class_attr); ?>">
                <div class="skt-dashboard-credentials__item-title-wrap">
                    <?php if ($is_pro) : ?>
                        <span class="skt-dashboard-credentials__item-badge"><?php esc_html_e('Pro', 'skt-addons-for-elementor'); ?></span>
                    <?php endif; ?>
