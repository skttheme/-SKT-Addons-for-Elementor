...
class Extensions_Manager {
	...
	public static function init() {
		...
		foreach ( self::get_local_features_map() as $feature_key => $data ) {
			if ( ! in_array( $feature_key, (array) $inactive_features ) ) {
	...
	public static function get_local_features_map() {
		return [
			'background-overlay' => [
				'title' => __( 'Background Overlay', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-layer',
				'is_pro' => false,
			],
			'grid-layer' => [
				'title' => __( 'Grid Layer', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-grid',
				'is_pro' => false,
			],
			'skt-particle-effects' => [
				'title' => __( 'SKT Particle Effects', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-spark',
				'is_pro' => false,
			],
			'image-masking' => [
				'title' => __( 'Image Masking', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-image-masking',
				'is_pro' => false,
			],
			'display-conditions' => [
				'title' => __( 'Display Condition', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-display-condition',
				'is_pro' => false,
			],
			'floating-effects' => [
				'title' => __( 'Floating Effects', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-weather-flood',
				'is_pro' => false,
			],
			'wrapper-link' => [
				'title' => __( 'Wrapper Link', 'skt-addons-for-elementor' ),
			...
			'shape-divider' => [
				'title' => __( 'Shape Divider', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-map',
				'is_pro' => false,
			],
			'column-extended' => [
				'title' => __( 'Column Order & Extension', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-flip-card2',
				'is_pro' => false,
			],
			'advanced-tooltip' => [
				'title' => __( 'SKT Tooltip', 'skt-addons-for-elementor' ),
				'icon' => 'skti skti-comment-square',
				'is_pro' => false,
			],
			'text-stroke' => [
				'title' => __( 'Text Stroke', 'skt-addons-for-elementor' ),
