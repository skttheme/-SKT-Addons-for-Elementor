	...
	public static function get_local_widgets_map()
	{
		...
		return [
			'infobox' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Info Box', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-info',
				'css' => ['btn', 'infobox',],
				'js' => [],
				'vendor' => [
			...
			'card' => [
				'cat' => 'creative',
				'is_active' => false,
				'title' => __('Card', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-card',
				'css' => ['btn', 'badge', 'card'],
				'js' => [],
				'vendor' => [
			...
			'cf7' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('Contact Form 7', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'icon-box' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Icon Box', 'skt-addons-for-elementor'),
			...
			'member' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Team Member', 'skt-addons-for-elementor'),
			...
			'review' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Review', 'skt-addons-for-elementor'),
			...
			'image-compare' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Image Compare', 'skt-addons-for-elementor'),
			...
			'justified-gallery' => [
				'cat' => 'creative',
				'is_active' => false,
				'title' => __('Justified Grid', 'skt-addons-for-elementor'),
			...
			'image-grid' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Image Grid', 'skt-addons-for-elementor'),
			...
			'slider' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Slider', 'skt-addons-for-elementor'),
			...
			'carousel' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Carousel', 'skt-addons-for-elementor'),
			...
			'skills' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Skill Bars', 'skt-addons-for-elementor'),
			...
			'gradient-heading' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Gradient Heading', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-drag',
			...
			'wpform' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('WPForms', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'ninjaform' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('Ninja Forms', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'calderaform' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('Caldera Forms', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'weform' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('weForms', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'logo-grid' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Logo Grid', 'skt-addons-for-elementor'),
			...
			'dual-button' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Dual Button', 'skt-addons-for-elementor'),
			...
			'testimonial' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Testimonial', 'skt-addons-for-elementor'),
			...
			'number' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Number', 'skt-addons-for-elementor'),
			...
			'calendly' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Calendly', 'skt-addons-for-elementor'),
			...
			'step-flow' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Step Flow', 'skt-addons-for-elementor'),
			...
			'gravityforms' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('Gravity Forms', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'news-ticker' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('News Ticker', 'skt-addons-for-elementor'),
			...
			'fun-factor' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Fun Factor', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-slider',
				'css' => ['fun-factor'],
				'js' => [],
				'vendor' => [
			...
			'bar-chart' => [
				...
				'is_active' => true,
				'demo' => '',
				'title' => __('Bar Chart', 'skt-addons-for-elementor'),
			...
			'social-icons' => [
				'cat' => 'social-media',
				'is_active' => true,
				'title' => __('Social Icons', 'skt-addons-for-elementor'),
			...
			'post-list' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Post List', 'skt-addons-for-elementor'),
			...
			'post-tab' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Post Tab', 'skt-addons-for-elementor'),
			...
			'taxonomy-list' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Taxonomy List', 'skt-addons-for-elementor'),
			...
			'threesixty-rotation' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('360° Rotation', 'skt-addons-for-elementor'),
			...
			'fluent-form' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('Fluent Form', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-form',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'data-table' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Data Table', 'skt-addons-for-elementor'),
			...
			'horizontal-timeline' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Horizontal Timeline', 'skt-addons-for-elementor'),
			...
			'social-share' => [
				'cat' => 'social-media',
				'is_active' => true,
				'title' => __('Social Share', 'skt-addons-for-elementor'),
			...
			'image-hover-effect' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Image Hover Effect', 'skt-addons-for-elementor'),
			...
			'event-calendar' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Event Calendar', 'skt-addons-for-elementor'),
			...
			'link-hover' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Animated Link', 'skt-addons-for-elementor'),
			...
			'mailchimp' => [
				'cat' => 'forms',
				'is_active' => true,
				'title' => __('MailChimp', 'skt-addons-for-elementor'),
			...
			'image-accordion' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Image Accordion', 'skt-addons-for-elementor'),
			...
			'content-switcher' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Content Switcher', 'skt-addons-for-elementor'),
			...
			'image-stack-group' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Image Stack Group', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-lens',
			...
			'creative-button' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Creative Button', 'skt-addons-for-elementor'),
			...
			'pdf-view' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('PDF View', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-pdf2',
				'css' => ['pdf'],
				'js' => [],
				'vendor' => [
			...
			'comparison-table' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Comparison Table', 'skt-addons-for-elementor'),
...
//////////////////////////////////////////////////////////////////////////////////////////////////
			...
			'accordion' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Advanced Accordion', 'skt-addons-for-elementor'),
			...
			'advanced-data-table' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Advanced Data Table', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-data-table',
			...
			'advanced-heading' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Advanced Heading', 'skt-addons-for-elementor'),
			...
			'advanced-tabs' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Advanced Tabs', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-tab',
				'css' => ['advanced-tabs'],
				'js' => [],
				'vendor' => [
			...
			'toggle' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Advanced Toggle', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-accordion-vertical',
				'css' => ['toggle'],
				'js' => [],
				'vendor' => [
			...
			'breadcrumbs' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Breadcrumbs', 'skt-addons-for-elementor'),
			...
			'business-hour' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Business Hour', 'skt-addons-for-elementor'),
			...
			'countdown' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Countdown', 'skt-addons-for-elementor'),
			...
			'feature-list' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Feature List', 'skt-addons-for-elementor'),
			...
			'list-group' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('List Group', 'skt-addons-for-elementor'),
			...
			'modal-popup' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Modal Popup', 'skt-addons-for-elementor'),
			...
			'source-code' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Source Code', 'skt-addons-for-elementor'),
			...
			'sticky-video' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Sticky Video', 'skt-addons-for-elementor'),
			...
			'timeline' => [
				'cat' => 'general',
				'is_active' => true,
				'title' => __('Timeline', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-timeline',
				'css' => ['timeline'],
				'js' => [],
				'vendor' => [
			...
			'flip-box' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Flip Box', 'skt-addons-for-elementor'),
			...
			'pricing-table' => [
				'cat' => 'marketing',
				'is_active' => true,
				'title' => __('Pricing Table', 'skt-addons-for-elementor'),
			...
			'price-menu' => [
				'cat' => 'marketing',
				'is_active' => true,
				'title' => __('Price Menu', 'skt-addons-for-elementor'),
			...
			'advanced-slider' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Advanced Slider', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-slider',
				'css' => ['advanced-slider'],
				'js' => [],
				'vendor' => [
			...
			'logo-carousel' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Logo Carousel', 'skt-addons-for-elementor'),
			...
			'team-carousel' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Team Carousel', 'skt-addons-for-elementor'),
			...
			'testimonial-carousel' => [
				'cat' => 'slider-&-carousel',
				'is_active' => true,
				'title' => __('Testimonial Carousel', 'skt-addons-for-elementor'),
			...
			'animated-text' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Animated Text', 'skt-addons-for-elementor'),
			...
			'hotspots' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Hotspots', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-accordion-vertical',
				'css' => ['hotspots'],
				'js' => [],
				'vendor' => [
			...
			'hover-box' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Hover Box', 'skt-addons-for-elementor'),
			...
			'promo-box' => [
				'cat' => 'marketing',
				'is_active' => true,
				'title' => __('Promo Box', 'skt-addons-for-elementor'),
			...
			'image-scroller' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Single Image Scroll', 'skt-addons-for-elementor'),
			...
			'off-canvas' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Off Canvas', 'skt-addons-for-elementor'),
			...
			'one-page-nav' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('One Page Nav', 'skt-addons-for-elementor'),
			...
			'scrolling-image' => [
				'cat' => 'creative',
				'is_active' => true,
				'title' => __('Scrolling Image', 'skt-addons-for-elementor'),
			...
			'author-list' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Author List', 'skt-addons-for-elementor'),
			...
			'post-carousel' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Post Carousel', 'skt-addons-for-elementor'),
			...
			'post-grid-new' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Post Grid', 'skt-addons-for-elementor'),
			...
			'post-tiles' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Post Tiles', 'skt-addons-for-elementor'),
			...
			'smart-post-list' => [
				'cat' => 'post',
				'is_active' => true,
				'title' => __('Smart Post List', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-post-list',
				'css' => ['smart-post-list'],
				'js' => [],
				'vendor' => [
			...
			'line-chart' => [
				'cat' => 'chart',
				'is_active' => true,
				'title' => __('Line Chart', 'skt-addons-for-elementor'),
			...
			'pie-chart' => [
				'cat' => 'chart',
				'is_active' => true,
				'title' => __('Pie & Doughnut Chart', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-graph-pie',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'polar-chart' => [
				'cat' => 'chart',
				'is_active' => true,
				'title' => __('Polar Area Chart', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-graph-pie',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'radar-chart' => [
				'cat' => 'chart',
				'is_active' => true,
				'title' => __('Radar Chart', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-graph-pie',
				'css' => [],
				'js' => [],
				'vendor' => [
			...
			'mini-cart' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Mini Cart', 'skt-addons-for-elementor'),
			...
			'product-carousel-new' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Product Carousel', 'skt-addons-for-elementor'),
			...
			'product-category-carousel-new' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Product Category Carousel', 'skt-addons-for-elementor'),
			...
			'product-category-grid-new' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Product Category Grid', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-Category-Carousel',
			...
			'product-grid-new' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Product Grid', 'skt-addons-for-elementor'),
			...
			'single-product-new' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('Single Product', 'skt-addons-for-elementor'),
			...
			'wc-cart' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('WooCommerce Cart', 'skt-addons-for-elementor'),
				'icon' => 'skti skti-cart',
				'css' => ['wc-cart'],
				'js' => [],
				'vendor' => [
			...
			'wc-checkout' => [
				'cat' => 'woocommerce',
				'is_active' => true,
				'title' => __('WooCommerce Checkout', 'skt-addons-for-elementor'),
	...
	public static function register()
	{
		...
		foreach (self::get_local_widgets_map() as $widget_key => $data) {
			if (!in_array($widget_key, (array)  $inactive_widgets)) {
