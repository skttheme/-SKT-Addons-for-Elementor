...
class Assets_Manager {
	...
	public static function frontend_register() {
		...
		wp_register_script(
			...
			['jquery'],
			SKT_ADDONS_ELEMENTOR_VERSION,true
		);
		...
		//Localize scripts
		wp_localize_script( 'skt-addons-for-elementor', 'SktProLocalize', [
	...
	public static function editor_enqueue() {
		...
		wp_enqueue_style(
			'skt-addons-for-elementor-editor',
		...
		$localize_data = [
			...
			'i18n' => [
				'promotionDialogHeader'     => esc_html('%s Widget'),
				'promotionDialogMessage'    => esc_html('Use %s widget with other exclusive pro widgets and 100% unique features to extend your toolbox and build sites faster and better.'),
				'templatesEmptyTitle'       => esc_html__('No Templates Found', 'skt-addons-for-elementor'),
				'templatesEmptyMessage'     => esc_html__('Try different category or sync for new templates.', 'skt-addons-for-elementor'),
				'templatesNoResultsTitle'   => esc_html__('No Results Found', 'skt-addons-for-elementor'),
				'templatesNoResultsMessage' => esc_html__('Please make sure your search is spelled correctly or try a different words.', 'skt-addons-for-elementor'),
			],
		];
	...
	public static function enqueue_preview_styles() {
		...
		';
		wp_add_inline_style('skt-addons-for-elementor', $data);
