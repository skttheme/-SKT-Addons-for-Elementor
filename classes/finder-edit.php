...
class Finder_Edit extends Finder_Category {
    ...
    public function get_title() {
        return __( 'Edit + SKT Clone', 'skt-addons-for-elementor' );
    }
        ...
        if ( Cloner::can_clone() ) {
            ...
            if ( $editor_document ) {
                ...
                if ( $editor_document->get_post()->post_type === Source_Local::CPT ) {
                    $description = __( 'Template', 'skt-addons-for-elementor' ) . ' / ' . $description;
                    $icon = 'post-title';
                }
                ...
                $items[] = [
                    'icon' => $icon,
                    'title' => __( 'Clone / Duplicate This', 'skt-addons-for-elementor' ),
