...
class Group_Control_Text_Stroke extends Group_Control_Base {
	...
	public function init_fields() {
		...
		$fields['color'] = [
			'label'       => _x( 'Stroke Color', 'Text Stroke', 'skt-addons-for-elementor' ),
			'type'        => Controls_Manager::COLOR,
			'render_type' => 'ui',
		];

		$fields['width'] = [
			'label'      => _x( 'Stroke Width', 'Text Stroke', 'skt-addons-for-elementor' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Text Stroke ', 'Text Stroke', 'skt-addons-for-elementor' ) . '&nbsp;<i style="color: #d5dadf;" class="skti skti-sktaddonselementor"></i>',
				'settings' => [
					'render_type' => 'ui',
				],
			],
