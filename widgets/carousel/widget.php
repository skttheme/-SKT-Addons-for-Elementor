...
class Carousel extends Base {
	...
	public function get_title() {
		return __( 'Carousel', 'skt-addons-for-elementor' );
	}
	...
	protected function slider_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => __( 'Type title here', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$repeater->add_control(
			'subtitle',
			[
				'label' => __( 'Subtitle', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'label_block' => true,
				'placeholder' => __( 'Type subtitle here', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
	...
	protected function carousel_item_style_controls() {
		...
		$this->add_responsive_control(
			'item_spacing',
			[
				'label' => __( 'Slide Spacing (px)', 'skt-addons-for-elementor' ),
	...
	protected function slide_content_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Slide Content', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
								...
								<?php
									if ( $slide['title'] ) {
										printf( '<%1$s class="skt-slick-title">%2$s</%1$s>',
											wp_kses_post(skt_addons_elementor_escape_tags( esc_attr($settings['title_tag']), 'h2' )),
											esc_attr(skt_addons_elementor_kses_basic( $slide['title']) )
										);
									}
								?>
