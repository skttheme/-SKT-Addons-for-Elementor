...
class Mailchimp extends Base {
    ...
    public function get_title() {
        return __('MailChimp', 'skt-addons-for-elementor');
    }
    ...
    protected function __mailchimp_content_controls() {
        ...
        $this->start_controls_section(
            '_section_mailchimp',
            [
                'label' => __('MailChimp', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'mailchimp_api_check',
            [
                'raw' => '<strong>' . esc_html__('Please note!', 'skt-addons-for-elementor') . '</strong> ' . esc_html__('Please set API Key in SKT Addons Dashboard - ', 'skt-addons-for-elementor') . '<a style="border-bottom-color: inherit;" href="'. esc_url(admin_url('admin.php?page=skt-addons#credentials')) . '" target="_blank" >'. esc_html__('Credentials', 'skt-addons-for-elementor') .'</a>' . esc_html__(' - MailChimp and Create Audience.', 'skt-addons-for-elementor'),
        ...
        */
        ...
        $this->add_control(
            ...
            [
                'label' => __('Choose API from', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'global',
                'options' =>  [
                    'global' => __('Global', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'mailchimp_api',
            [
                'label' => __('MailChimp API', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Enter your mailchimp api here', 'skt-addons-for-elementor'),
                'condition' => [
        ...
        $this->add_control(
			'mailchimp_lists',
			[
				'label' => __( 'Audience', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'type' => Select2::TYPE,
				'multiple' => false,
                ...
                'description' => esc_html__('Create a audience/ list in mailchimp account ', 'skt-addons-for-elementor') . '<a href="https://mailchimp.com/help/create-audience/" target="_blank"> ' . esc_html__('Create Audience', 'skt-addons-for-elementor') . '</a>',
			]
		);
        ...
        $this->add_control(
            'mailchimp_list_tags',
            [
                'label' => __('Tags', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Tag-1, Tag-2', 'skt-addons-for-elementor'),
                'description' => __('Enter tag here to separate your subscribers. Use comma separator to use multiple tags. Example: Tag-1, Tag-2, Tag-3', 'skt-addons-for-elementor'),
                'condition' => [
                    'mailchimp_lists!' => '',
                ],
                'dynamic' => [ 'active' => true]
    ...
    protected function __mailchimp_form_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Form', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_responsive_control(
            'form_alignment',
            [
                'label' => __('Form Alignment', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__('Horizontal', 'skt-addons-for-elementor'),
                    'vertical' => esc_html__('Vertical', 'skt-addons-for-elementor'),
                ],
        ...
        $this->add_control(
            'enable_name',
            [
                'label' => __('Enable Name?', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            '_fname_heading',
            [
                'label' => __('First Name:', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('First Name input label', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_name' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            'fname_placeholder',
            [
                'label' => __('Placeholder', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'default' => __('First Name', 'skt-addons-for-elementor'),
                'placeholder' => __('First Name input placeholder', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_name' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            'fname_enable_icon',
            [
                'label' => __('Enable Icon With Input?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'before',
                'options' => [
                    'before'  => __('Before Input', 'skt-addons-for-elementor'),
                    'after' => __('After Input', 'skt-addons-for-elementor'),
                ],
                'condition' => [
                    'enable_name' => 'yes',
                    'fname_enable_icon' => 'yes',
        ...
        $this->add_control(
            '_lname_heading',
            [
                'label' => __('Last Name:', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'enable_name' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Label', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Last Name input label', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_name' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Placeholder', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Last Name', 'skt-addons-for-elementor'),
                'placeholder' => __('Last Name input placeholder', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_name' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            'enable_phone',
            [
                'label' => __('Enable Phone?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            '_phone_heading',
            [
                'label' => __('Phone:', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'enable_phone' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Label', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Phone input label', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_phone' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Placeholder', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Phone', 'skt-addons-for-elementor'),
                'placeholder' => __('Phone input placeholder', 'skt-addons-for-elementor'),
                'condition' => [
                    'enable_phone' => 'yes',
                ],
                'dynamic' => ['active' => true]
        ...
        $this->add_control(
            '_email_heading',
            [
                'label' => __('Email:', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Label', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Email input label', 'skt-addons-for-elementor'),
                'dynamic' => ['active' => true]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Placeholder', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Email', 'skt-addons-for-elementor'),
                'placeholder' => __('Email input placeholder', 'skt-addons-for-elementor'),
                'dynamic' => ['active' => true]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Subscribe', 'skt-addons-for-elementor'),
                'dynamic' => ['active' => true]
            ]
        );
        ...
        $this->add_control(
            'button_enable_icon',
            [
                'label' => __('Enable Icon With Button?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
    ...
    protected function __success_error_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Success & Error', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Success Message', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Your data inserted on Mailchimp.', 'skt-addons-for-elementor'),
                'placeholder' => __('Type your success message here', 'skt-addons-for-elementor'),
                'dynamic' => ['active' => true]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Success Message Show in Editor?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Error Message Show in Editor?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
    ...
    protected function __mailchimp_label_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Label', 'skt-addons-for-elementor'),
    ...
    protected function __input_style_controls() {
        ...
        $this->start_controls_section(
            'input_style',
            [
                'label' => esc_html__('Input', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'space_between_input',
            [
                'label' => __('Space Between Input (px)', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Use Width', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'skt-addons-for-elementor'),
                'label_off' => esc_html__('Hide', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
                'default' => 'no',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Margin Bottom', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Margin Right', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px',],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '#000000',
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Font Size', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function __input_icon_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input Icon', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function __button_style_controls() {
        ...
        $this->start_controls_section(
            'button_style_holder',
            [
                'label' => esc_html__('Button', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Icon Spacing', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'button_icon_size',
            [
                'label' => esc_html__('Icon Size', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
    ...
    protected function __success_error_style_controls() {
        ...
        $this->start_controls_section(
            'success_error',
            [
                'label' => esc_html__('Success & Error Message', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'success_heading',
            [
                'label' => esc_html__('Success:', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            'error_heading',
            [
                'label' => esc_html__('Error:', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
            ]
        );
...
?>
        <div class="skt-mailchimp-wrapper" data-post-id="<?php echo esc_attr(get_the_id()); ?>" data-widget-id="<?php echo esc_attr($this->get_id()); ?>">
            <?php if (\Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['mailchimp_success_message_show_in_editor'] == 'yes') : ?>
                <div class="skt-mc-response-message success"><?php esc_html_e('This is a dummy message for success. This won\'t show in preview', 'skt-addons-for-elementor'); ?></div>
            <?php endif; ?>
            <?php if (\Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['mailchimp_error_message_show_in_editor'] == 'yes') : ?>
                <div class="skt-mc-response-message error"><?php esc_html_e('This is a dummy message for error. This won\'t show in preview', 'skt-addons-for-elementor'); ?></div>
            <?php endif; ?>
