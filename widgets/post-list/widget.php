...
class Post_List extends Base {
	...
	public function get_title () {
		return __( 'Post List', 'skt-addons-for-elementor' );
	}
	...
	protected function __post_list_content_controls () {
		...
		$this->add_control(
			'show_post_by',
			[
				'label' => __( 'Show post by:', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'recent',
				'options' => [
					'recent' => __( 'Recent Post', 'skt-addons-for-elementor' ),
					'selected' => __( 'Selected Post', 'skt-addons-for-elementor' ),
				],
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Item Limit', 'skt-addons-for-elementor' ),
		...
		foreach ( $this->get_post_types() as $key => $value ) {
			...
			$repeater[$key]->add_control(
				...
				[
					...
					'label_block' => true,
					'placeholder' => __( 'Customize Title', 'skt-addons-for-elementor' ),
					'dynamic' => [
						'active' => true,
					],
				]
			...
			$repeater[$key]->add_control(
				'post_id',
				[
					'label' => __( 'Select ', 'skt-addons-for-elementor' ) . $value,
					'label_block' => true,
					'type' => Select2::TYPE,
					'multiple' => false,
	...
	protected function __settings_content_controls () {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'list' => [
						'title' => __( 'List', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'list_icon',
			[
				'label' => __( 'List Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'content',
			[
				'label' => __( 'Show Content', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'meta',
			[
				'label' => __( 'Show Meta', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'category_icon',
			[
				'label' => __( 'Category Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->add_control(
			'meta_position',
			[
				'label' => __( 'Meta Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'bottom',
				'options' => [
	...
	protected function __post_list_style_controls () {
		...
		$this->add_responsive_control(
			'list_item_first',
			[
				'label' => __( 'First Item', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'advance_style' => 'yes',
		...
		$this->add_responsive_control(
			'list_item_last',
			[
				'label' => __( 'Last Item', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'advance_style' => 'yes',
	...
	protected function __icon_image_style_controls () {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Icon & Feature Image', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'conditions' => [
					'relation' => 'or',
					'terms' => [
		...
		$this->add_responsive_control(
			'icon_line_height',
			[
				'label' => __( 'Line Height', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_responsive_control(
			'image_width',
			[
				'label' => __( 'Image Width', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
	...
	protected function __excerpt_style_controls () {
		...
		$this->add_responsive_control(
			'excerpt_space',
			[
				'label' => __( 'Space Top', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
						...
						<li <?php $this->print_render_attribute_string( 'item' ); ?>>
							<a href="<?php echo esc_url( get_the_permalink( $post->ID ) ); ?>">
								...
								<div class="skt-post-list-content">
									...
									if ( 'top' !== $settings['meta_position'] && ! empty( $title ) ) {
										...
										printf(
											'<%1$s class="skt-post-list-title">%2$s</%1$s>',
											esc_html( $title_tag ),
											$escaped_title
										);
									}
										...
										<div class="skt-post-list-excerpt">
											<?php
												if ( 'post' !== $settings['post_type'] && has_excerpt($post->ID) ) {
													printf('<p>%1$s</p>',
														wp_kses_post(wp_trim_words(get_the_excerpt($post->ID)))
													);
												}else{
													printf('<p>%1$s</p>',
														wp_kses_post(wp_trim_words(get_the_content(null,false,$post->ID), 25, '.'))
													);
												}
											?>
										</div>
