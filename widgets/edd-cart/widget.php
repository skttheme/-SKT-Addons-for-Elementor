...
class EDD_Cart extends Base {
	...
	public function get_title() {
		return __( 'EDD Cart', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		// 		'raw'             => __( '<strong>Note:</strong> EDD Cart widget doesn\'t have any useful content control.', 'skt-addons-for-elementor' ),
	...
	protected function ___cart_table_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Cart Table', 'skt-addons-for-elementor' ),
	...
	protected function ___totals_heading_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Cart Footer: Totals', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function ___cart_totals_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Cart Totals: Table', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Border Size', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => '',
				],
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Text', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Headings', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function ___checkout_button_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Checkout Button', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		echo '<div class="skt-edd-table-wrap" ' . wp_kses_post($this->get_render_attribute_string( 'cart-settings' )) . '>';	// Resolved escaping issue
			echo wp_kses_post(skt_addons_elementor_do_shortcode( 'download_cart' )); // Resolved escaping issue
		echo '</div>';
				...
				<ul>
					...
					<li class="edd-cart-item">
						...
						<span class="product-name">
							<a href="<?php echo esc_url(get_the_permalink( $id )); ?>"><?php echo esc_attr(get_the_title( $id )); ?></a>						
						</span>
						<span class="product-price" data-title="Price">
							<?php echo esc_attr(edd_currency_filter( edd_format_amount( $price ) )); ?>					
						</span>
						<span class="product-quantity" data-title="Quantity">
							<?php echo esc_attr($quantity); ?>
						</span>
						<span class="product-remove">
							<a href="<?php echo esc_url( $remove_url ); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'edd-remove-cart-widget-item' )); // Resolved escaping isue ?>" data-cart-item="<?php echo esc_attr( $key ); ?>" data-download-id="<?php echo esc_attr( $id ); ?>" data-action="edd_remove_from_cart" class="edd-remove-from-cart">Remove</a>						
						</span>
					</li>
					<?php endforeach; ?>
					
				<?php else : ?>
					<?php echo esc_html(edd_empty_cart_message()); ?>
				<?php endif; ?>
			</ul>
		<?php
	}
