...
class Advanced_Heading extends Base {
    ...
    public function get_title() {
        return __( 'Advanced Heading', 'skt-addons-for-elementor' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            '_section_title',
            [
                'label' => __( 'Advanced Heading', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'heading_center',
            [
                'label' => __( 'Center Text', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Addon', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Center Text', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Rocks', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Text', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Background', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Background Text', 'skt-addons-for-elementor' ),
				'condition' => [
    ...
    protected function __before_text_style_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Blend Mode', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'separator' => 'none',
                'options' => [
                    '' => __( 'Normal', 'skt-addons-for-elementor' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
    ...
    protected function __border_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'groove' => __( 'Groove', 'skt-addons-for-elementor' ),
                ],
                'default' => 'solid',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'border_length',
            [
                'label' => __( 'Length', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
    ...
    protected function __background_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __( '<strong>Background Text</strong> is Hidden on Content Tab', 'skt-addons-for-elementor' ),
                'condition' => [
                    'show_background_text!' => 'yes',
                ],
            ]
