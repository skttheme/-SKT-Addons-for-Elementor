...
class Product_Category_Grid_New extends Base {
	...
	public function get_title() {
		return __( 'Product Category Grid', 'skt-addons-for-elementor' );
	}
	...
	public function render() {
        if ( ! class_exists( 'WooCommerce' ) ) {
			printf( '<div class="skt-product-cat-grid-error">%s</div>', esc_attr__( 'Please Install/Activate Woocommerce Plugin.', 'skt-addons-for-elementor' ) );
