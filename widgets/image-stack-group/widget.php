...
class Image_Stack_Group extends Base {
	...
	public function get_title() {
		return __( 'Image Stack Group', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$repeater->add_control(
			'tooltip_position',
			[
				'label' => __( 'Tooltip Position', 'skt-addons-for-elementor' ),
				...
				'options' => [
					...
					'up'  => [
						'title' => __( 'Up', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-v-align-top'
					],
					'down'  => [
						'title' => __( 'Down', 'skt-addons-for-elementor' ),
	...
	protected function register_style_controls() {
		...
		$this->add_responsive_control(
			'img_size',
			[
				'label' => __( 'Item Size', 'skt-addons-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Tooltips', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		<div class="skt-cig">
			<?php foreach ( $settings['images'] as $item ) :
				...
				echo $wrap_start, $content, $wrap_end; // phpcs:ignore  WordPress.Security.EscapeOutput.OutputNotEscaped
