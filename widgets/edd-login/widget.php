...
class EDD_Login extends Base {
	...
	public function get_title() {
		return __( 'EDD Login', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			'redirect_url',
			[
				'label'       => __( 'Redirect URL After Login', 'skt-addons-for-elementor' ),
	...
	protected function __labels_style_controls() {
		...
		// 	'labels_height',
		// 	[
		// 		'label'   => __( 'Label Height', 'skt-addons-for-elementor' ),
		// 		'type'    => Controls_Manager::SLIDER,
		// 		'default' => [
		// 			'size' => '',
		// 		],
	...
	protected function render() {
		...
		if ( skt_addons_elementor()->editor->is_edit_mode() ) {
			...
			echo skt_addons_elementor_do_shortcode( 'edd_login' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped

			remove_filter( 'edd_login_form', [$this, 'add_login_edd'] );

		} else {

			echo skt_addons_elementor_do_shortcode( 'edd_login', $atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
	...
	function add_login_edd( $template ) {
		global $edd_login_redirect;
			...
			<form id="edd_login_form" class="edd_form" action="" method="post">
				<fieldset>
					<legend><?php esc_attr_e( 'Log into Your Account', 'skt-addons-for-elementor' ); ?></legend>
					<?php do_action( 'edd_login_fields_before' ); ?>
					<p class="edd-login-username">
						<label for="edd_user_login"><?php esc_attr_e( 'Username or Email', 'skt-addons-for-elementor' ); ?></label>
						<input name="edd_user_login" id="edd_user_login" class="edd-required edd-input" type="text"/>
					</p>
					<p class="edd-login-password">
						<label for="edd_user_pass"><?php esc_attr_e( 'Password', 'skt-addons-for-elementor' ); ?></label>
						<input name="edd_user_pass" id="edd_user_pass" class="edd-password edd-required edd-input" type="password"/>
					</p>
					<p class="edd-login-remember">
						<label><input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_attr_e( 'Remember Me', 'skt-addons-for-elementor' ); ?></label>
					</p>
					<p class="edd-login-submit">
						<input type="hidden" name="edd_redirect" value="<?php echo esc_url( $edd_login_redirect ); ?>"/>
						<input type="hidden" name="edd_login_nonce" value="<?php echo wp_create_nonce( 'edd-login-nonce' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"/>
						<input type="hidden" name="edd_action" value="user_login"/>
						<input id="edd_login_submit" type="submit" class="edd-submit" value="<?php esc_attr_e( 'Log In', 'skt-addons-for-elementor' ); ?>"/>
					</p>
					<p class="edd-lost-password">
						<a href="<?php echo esc_url( edd_get_lostpassword_url() ); ?>">
							<?php esc_attr_e( 'Lost Password?', 'skt-addons-for-elementor' ); ?>
						</a>
					</p>
