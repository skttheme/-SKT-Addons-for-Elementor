...
class Mini_Cart extends Base {
	...
	public function get_title() {
		return __( 'Mini Cart', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
        ...
        $this->start_controls_section(
			...
			[
				'label' => __( 'Mini Cart', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'mini_cart_show',
            [
                'label' => __( 'Cart Popup Show', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Show Subtotal', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' =>__( 'Subtotal Position', 'skt-addons-for-elementor' ),
	...
	protected function __body_style_controls(){
		...
		$this->start_controls_section(
			'popup_body_section',
			[
				'label' => __( 'Popup:- Body', 'skt-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition'             => [
					'mini_cart_show!' => 'none',
				],
	...
	protected function __header_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Popup:- Header', 'skt-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition'             => [
					'mini_cart_show!' => 'none',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Border Space', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
	...
	protected function __item_style_controls(){
		...
		$this->start_controls_section(
			'popup_item_section',
			[
				'label' => __( 'Popup:- Item', 'skt-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition'             => [
					'mini_cart_show!' => 'none',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Quantity:', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Remove:', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function __subtotal_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Popup:- Subtotal', 'skt-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition'             => [
					'mini_cart_show!' => 'none',
				],
	...
	protected function __btn_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Popup:- Button', 'skt-addons-for-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition'             => [
					'mini_cart_show!' => 'none',
				],
    ...
    protected function view_cart_btn_style(){
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'View Cart:', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
    ...
    protected function checkout_btn_style(){
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Checkout:', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
					...
					<div class="skt-mini-cart-popup">
						<div class="skt-mini-cart-popup-header">
								<div class="skt-mini-cart-popup-count-text-area">
									...
									<span class="skt-mini-cart-popup-count-text"><?php esc_html_e( 'items', 'skt-addons-for-elementor' ); ?></span>
								</div>
						</div>
