...
class EDD_Checkout extends Base {
	...
	public function get_title() {
		return __( 'EDD Checkout', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			'cart_btn_type',
			[
				'label'              => __( 'Cart Button Type', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => [
					'text' => [
						'title' => __( 'Text', 'skt-addons-for-elementor' ),
						'icon'  => 'eicon-text',
					],
					'icon' => [
		...
		$this->add_control(
			...
			[
				...
				'default'            => __( 'Remove', 'skt-addons-for-elementor' ),
				'placeholder'        => __( 'Type your text here', 'skt-addons-for-elementor' ),
				'frontend_available' => true,
				'condition'          => [
					'cart_btn_type' => 'text',
				],
		...
		// 		'raw'             => __( '<strong>Note:</strong> EDD Checkout widget doesn\'t have any useful content control.', 'skt-addons-for-elementor' ),
	...
	protected function ___checkout_table_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Checkout Cart Table', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'_heading_cart_table',
			[
				'label' => __( 'Table', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Head', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'_heading_cart_items',
			[
				'label'     => __( 'Cart Items', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Separator Type', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Separator Size', 'skt-addons-for-elementor' ),
		...
		$this->start_controls_tab(
			'cart_items_even_row',
			[
				'label' => __( 'Even Row', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Links Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab(
			'cart_items_odd_row',
			[
				'label' => __( 'Odd Row', 'skt-addons-for-elementor' ),
			]
		);
		...
		if( function_exists( 'edd_get_option' ) && edd_get_option( 'item_quantities', false ) ){
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Quantity Input', 'skt-addons-for-elementor' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Product Remove', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		if( function_exists( 'edd_get_option' ) && edd_get_option( 'item_quantities', false ) ){
			$this->add_control(
				...
				[
					'label'     => __( 'Update Cart Button', 'skt-addons-for-elementor' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Footer', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		// 	[
		// 		'label'                 => __( 'Update Cart Row', 'skt-addons-for-elementor' ),
		// 		'type'                  => Controls_Manager::HEADING,
		// 		'separator'				=> 'before',
		// 	]
		// );
	...
	protected function purchase_total()
	{
		$this->start_controls_section(
			...
			[
				'label' => __( 'Purchase Total', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __inputs_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Inputs', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'inputs_height',
			[
				'label'     => __( 'Input Height', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'size' => '',
				],
	...
	protected function __labels_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Label Description', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function __discount_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Discount', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'		=> __('Link Typography', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Discount Area', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
				'separator'=> 'before',
	...
	protected function __headings_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Headings', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __button_style_controls() {
		...
		// 	'hover_animation',
		// 	[
		// 		'label' => esc_html__( 'Hover Animation', 'skt-addons-for-elementor' ),
	...
	protected function render() {
		...
		echo '<div class="skt-edd-table-wrap"' . $this->get_render_attribute_string( 'cart-settings' ) . '>' ; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
			echo skt_addons_elementor_do_shortcode( 'download_checkout' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		echo '</div>';
	}

	public function skt_edd_discount_field() {

		if( isset( $_GET['payment-mode'] ) && edd_is_ajax_disabled() ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended 
	...
	?>
			<fieldset id="edd_discount_code">
				<p id="edd_show_discount" style="display:block;">
					<?php esc_attr_e( 'Have a discount code?', 'skt-addons-for-elementor' ); ?> <a href="#" class="edd_discount_link"><?php echo esc_html_x( 'Click to enter it', 'Entering a discount code', 'skt-addons-for-elementor' ); ?></a>
				</p>
				<p id="edd-discount-code-wrap" class="edd-cart-adjustment">
					<label class="edd-label" for="edd-discount">
						<?php esc_attr_e( 'Discount', 'skt-addons-for-elementor' ); ?>
					</label>
					<span class="edd-description"><?php esc_attr_e( 'Enter a coupon code if you have one.', 'skt-addons-for-elementor' ); ?></span>
					<span class="edd-discount-code-field-wrap">
						<input class="edd-input" type="text" id="edd-discount" name="edd-discount" placeholder="<?php esc_attr_e( 'Enter discount', 'skt-addons-for-elementor' ); ?>"/>
						<input type="submit" class="edd-apply-discount edd-submit <?php echo $color . ' ' . $style; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?>" value="<?php echo esc_html_x( 'Apply', 'Apply discount at checkout', 'skt-addons-for-elementor' ); ?>"/>
					</span>
