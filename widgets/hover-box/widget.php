...
class Hover_Box extends Base {
	...
	public function get_title() {
		return __( 'Hover Box', 'skt-addons-for-elementor' );
	}
	...
	protected function __text_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'WordPress', 'skt-addons-for-elementor' ),
	...
	protected function __common_content_controls() {
        ...
        $this->add_control(
            'sub_title_position',
            [
                'label' => __( 'Sub Title Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
        ...
        $this->add_control(
            'display_type',
            [
                'label' => __( 'Text Display Control', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'default' => [
                    ...
                    'hover' => [
                        'title' => __( 'On Hover', 'skt-addons-for-elementor' ),
                        'icon' => 'eicon-click',
                    ],
                ],
                'toggle' => false,
            ...
            <div class="skt-hover-box-main">
                <div <?php $this->print_render_attribute_string( 'display-type' ); ?>>
                    <div class="skt-hover-box-content">
                        ...
                        <div>
                            <?php
                                // Resloved escaping issue
								if ( $settings['title'] ) {
									printf( '<%1$s %2$s>%3$s</%1$s>',
										esc_attr(skt_addons_elementor_escape_tags( $settings['title_tag'], 'h4' )),
