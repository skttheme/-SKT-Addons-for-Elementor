...
class Price_Menu extends Base {
	...
	public function get_title () {
		return __( 'Price Menu', 'skt-addons-for-elementor' );
	}
	...
	protected function __price_menu_content_controls () {
		...
		$this->start_controls_section(
			'_section_price_menu',
			[
				'label' => __( 'Price Menu', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'badge_icon',
			[
				'label' => __( 'Badge Icon', 'skt-addons-for-elementor' ),
				'label_block' => false,
		...
		$repeater->add_control(
			'badge_icon_title',
			[
				'label' => __( 'Icon Hover Title', 'skt-addons-for-elementor' ),
				'label_block' => false,
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'skt-addons-for-elementor' ),
			]
		);
		...
		$repeater->add_control(
			'old_price',
			[
				'label' => __( 'Old Price', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => __( 'Gold Coffee', 'skt-addons-for-elementor' ),
						'desc' => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'skt-addons-for-elementor' ),
						'price' => '$199',
						'old_price' => '$250',
					],
					[
						'title' => __( 'Cold Coffee', 'skt-addons-for-elementor' ),
						'desc' => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'skt-addons-for-elementor' ),
						'price' => '$150',
						'old_price' => '$200',
					],
	...
	protected function __settings_content_controls () {
		...
		$this->add_control(
			'price_position',
			[
				'label' => __( 'Price Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'beside_title' => [
						'title' => __( 'Beside Title', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-h-align-right',
					],
					'bottom' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Title Price Separator', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'item_counter',
			[
				'label' => __( 'Item Counter', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
	...
	protected function __menu_box_style_controls () {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Menu Box', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Item Spacing', 'skt-addons-for-elementor' ),
	...
	protected function __title_style_controls () {
		...
		$this->add_control(
			'counter_heading',
			[
				'label' => __( 'Counter', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'item_counter' => 'yes',
				],
