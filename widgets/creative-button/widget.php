...
class Creative_Button extends Base {
	...
	public function get_title() {
		return __( 'Creative Button', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_button',
			[
				'label' => __( 'Creative Button', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'hermosa',
				'options' => [
					'hermosa'  => __( 'Hermosa', 'skt-addons-for-elementor' ),
					'montino'  => __( 'Montino', 'skt-addons-for-elementor' ),
					'iconica'  => __( 'Iconica', 'skt-addons-for-elementor' ),
					'symbolab' => __( 'Symbolab', 'skt-addons-for-elementor' ),
					'estilo'   => __( 'Estilo', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'estilo_effect',
			[
				'label'     => __( 'Effects', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'dissolve',
				'options'   => [
					'dissolve'     => __( 'Dissolve', 'skt-addons-for-elementor' ),
					'slide-down'   => __( 'Slide In Down', 'skt-addons-for-elementor' ),
					'slide-right'  => __( 'Slide In Right', 'skt-addons-for-elementor' ),
					'slide-x'      => __( 'Slide Out X', 'skt-addons-for-elementor' ),
					'cross-slider' => __( 'Cross Slider', 'skt-addons-for-elementor' ),
					'slide-y'      => __( 'Slide Out Y', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'btn_style' => 'estilo',
				],
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'back-in-right'  => __( 'Back In Right', 'skt-addons-for-elementor' ),
					'back-in-left'   => __( 'Back In Left', 'skt-addons-for-elementor' ),
					'back-out-right' => __( 'Back Out Right', 'skt-addons-for-elementor' ),
					'back-out-left'  => __( 'Back Out Left', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'btn_style' => 'symbolab',
				],
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'slide-in-down'  => __( 'Slide In Down', 'skt-addons-for-elementor' ),
					'slide-in-top'   => __( 'Slide In Top', 'skt-addons-for-elementor' ),
					'slide-in-right' => __( 'Slide In Right', 'skt-addons-for-elementor' ),
					'slide-in-left'  => __( 'Slide In Left', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'btn_style' => 'iconica',
				],
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'winona',
				'options'   => [
					'winona'  => __( 'Winona', 'skt-addons-for-elementor' ),
					'rayen'   => __( 'Rayen', 'skt-addons-for-elementor' ),
					'aylen'   => __( 'Aylen', 'skt-addons-for-elementor' ),
					'wapasha' => __( 'Wapasha', 'skt-addons-for-elementor' ),
					'nina'    => __( 'Nina', 'skt-addons-for-elementor' ),
					'antiman' => __( 'Antiman', 'skt-addons-for-elementor' ),
					'sacnite' => __( 'Sacnite', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'btn_style' => 'montino',
				],
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'exploit',
				'options'   => [
					'exploit'    => __( 'Exploit', 'skt-addons-for-elementor' ),
					'upward'     => __( 'Upward', 'skt-addons-for-elementor' ),
					'newbie'     => __( 'Newbie', 'skt-addons-for-elementor' ),
					'render'     => __( 'Render', 'skt-addons-for-elementor' ),
					'reshape'    => __( 'Reshape', 'skt-addons-for-elementor' ),
					'expandable' => __( 'Expandable', 'skt-addons-for-elementor' ),
					'downhill'   => __( 'Downhill', 'skt-addons-for-elementor' ),
					'bloom'      => __( 'Bloom', 'skt-addons-for-elementor' ),
					'roundup'    => __( 'Roundup', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'btn_style' => 'hermosa',
				],
		...
		$this->add_control(
			...
			[
				...
				'description'            => __( 'Please set an icon for the button.', 'skt-addons-for-elementor' ),
				'label_block'            => false,
		...
		$this->add_control(
			'magnetic_enable',
			[
				'label'        => __( 'Magnetic Effect', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'threshold',
			[
				'label'     => __( 'Threshold', 'skt-addons-for-elementor' ),
	...
	protected function _color_template() {
		...
		$this->start_controls_section(
			'_button_style_color',
			[
				'label' => __( 'Color Tamplate', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'white_color',
			[
				'label'     => __( 'White', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'offwhite_color',
			[
				'label'     => __( 'Off White', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#f0f0f0',
				'selectors' => [
		...
		$this->add_control(
			'black_color',
			[
				'label'     => __( 'Black', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#222222',
				'selectors' => [
		...
		$this->add_control(
			'cranberry_color',
			[
				'label'     => __( 'Cranberry', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#e2498a',
				'selectors' => [
		...
		$this->add_control(
			'purple_color',
			[
				'label'     => __( 'Purple', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#562dd4',
				'selectors' => [
	...
	protected function __common_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Stroke Width', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range'      => [
					'px' => [
	...
	protected function __btn_tab_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'      => __( 'Circle Color', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::COLOR,
				'selectors'  => [
