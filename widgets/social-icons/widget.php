...
class Social_Icons extends Base {
	...
	public function get_title() {
		return __('Social Icons', 'skt-addons-for-elementor');
	}
	...
	protected function register_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => __('https://your-social-link.com', 'skt-addons-for-elementor'),
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'          => __('Enable Text', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			...
			[
				'label'     => __('Social Name', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label'        => __('Show Separator', 'skt-addons-for-elementor'),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'      => [
					'stroke' => __('Stroke', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'default_separator',
			[
				'label'       => __('Stroke Size', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'custom_separator',
			[
				'label'       => __('Custom Character', 'skt-addons-for-elementor'),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'sticky_options',
			[
				'label'        => __('Enable Sticky', 'skt-addons-for-elementor'),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'separator'    => 'before',
			]
	...
	protected function __common_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __('Social Spacing', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
	...
	protected function __icon_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'2d-transition'          => __('2D Animation', 'skt-addons-for-elementor'),
					'background-transition'  => __('Background Animation', 'skt-addons-for-elementor'),
					'shadow-glow-transition' => __('Shadow and Glow Animation', 'skt-addons-for-elementor'),
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'hvr-grow'                   => __('Grow', 'skt-addons-for-elementor'),
					'hvr-shrink'                 => __('Shrink', 'skt-addons-for-elementor'),
					'hvr-pulse'                  => __('Pulse', 'skt-addons-for-elementor'),
					'hvr-pulse-grow'             => __('Pulse Grow', 'skt-addons-for-elementor'),
					'hvr-pulse-shrink'           => __('Pulse Shrink', 'skt-addons-for-elementor'),
					'hvr-push'                   => __('Push', 'skt-addons-for-elementor'),
					'hvr-pop'                    => __('Pop', 'skt-addons-for-elementor'),
					'hvr-bounce-in'              => __('Bounce In', 'skt-addons-for-elementor'),
					'hvr-bounce-out'             => __('Bounce Out', 'skt-addons-for-elementor'),
					'hvr-rotate'                 => __('Rotate', 'skt-addons-for-elementor'),
					'hvr-grow-rotate'            => __('Grow Rotate', 'skt-addons-for-elementor'),
					'hvr-float'                  => __('Float', 'skt-addons-for-elementor'),
					'hvr-sink'                   => __('Sink', 'skt-addons-for-elementor'),
					'hvr-bob'                    => __('Bob', 'skt-addons-for-elementor'),
					'hvr-hang'                   => __('Hang', 'skt-addons-for-elementor'),
					'hvr-wobble-vertical'        => __('Wobble Vertical', 'skt-addons-for-elementor'),
					'hvr-wobble-horizontal'      => __('Wobble Horizontal', 'skt-addons-for-elementor'),
					'hvr-wobble-to-bottom-right' => __('Wobble To Bottom Right', 'skt-addons-for-elementor'),
					'hvr-wobble-to-top-right'    => __('Wobble To Top Right', 'skt-addons-for-elementor'),
					'hvr-buzz'                   => __('Buzz', 'skt-addons-for-elementor'),
					'hvr-buzz-out'               => __('Buzz Out', 'skt-addons-for-elementor'),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'hvr-fade'                   => __('Fade', 'skt-addons-for-elementor'),
					'hvr-back-pulse'             => __('Back Pulse', 'skt-addons-for-elementor'),
					'hvr-sweep-to-right'         => __('Sweep To Right', 'skt-addons-for-elementor'),
					'hvr-sweep-to-left'          => __('Sweep To Left', 'skt-addons-for-elementor'),
					'hvr-sweep-to-bottom'        => __('Sweep To Bottom', 'skt-addons-for-elementor'),
					'hvr-sweep-to-top'           => __('Sweep To Top', 'skt-addons-for-elementor'),
					'hvr-bounce-to-right'        => __('Bounce To Right', 'skt-addons-for-elementor'),
					'hvr-bounce-to-left'         => __('Bounce To Left', 'skt-addons-for-elementor'),
					'hvr-bounce-to-bottom'       => __('Bounce To Bottom', 'skt-addons-for-elementor'),
					'hvr-bounce-to-top'          => __('Bounce To Top', 'skt-addons-for-elementor'),
					'hvr-radial-out'             => __('Radial Out', 'skt-addons-for-elementor'),
					'hvr-radial-in'              => __('Radial In', 'skt-addons-for-elementor'),
					'hvr-rectangle-in'           => __('Rectangle In', 'skt-addons-for-elementor'),
					'hvr-rectangle-out'          => __('Rectangle Out', 'skt-addons-for-elementor'),
					'hvr-shutter-in-horizontal'  => __('Shutter In Horizontal', 'skt-addons-for-elementor'),
					'hvr-shutter-out-horizontal' => __('Shutter Out Horizontal', 'skt-addons-for-elementor'),
					'hvr-shutter-in-vertical'    => __('Shutter In Vertical', 'skt-addons-for-elementor'),
					'hvr-shutter-out-vertical'   => __('Shutter Out Vertical', 'skt-addons-for-elementor'),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'hvr-glow'              => __('Glow', 'skt-addons-for-elementor'),
					'hvr-shadow'            => __('Shadow', 'skt-addons-for-elementor'),
					'hvr-grow-shadow'       => __('Grow Shadow', 'skt-addons-for-elementor'),
					'hvr-box-shadow-outset' => __('Box Shadow Outset', 'skt-addons-for-elementor'),
					'hvr-box-shadow-inset'  => __('Box Shadow Inset', 'skt-addons-for-elementor'),
					'hvr-float-shadow'      => __('Float Shadow', 'skt-addons-for-elementor'),
					'hvr-shadow-radial'     => __('Shadow Radial', 'skt-addons-for-elementor'),
				],
				'condition' => [
	...
	protected function __separator_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Separator', 'skt-addons-for-elementor'),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
