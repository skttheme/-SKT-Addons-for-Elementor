...
class Card extends Base {
	...
	public function get_title() {
		return __( 'Card', 'skt-addons-for-elementor' );
	}
	...
	protected function __image_badge_content_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'description' => __( 'You can adjust the image width and height from <mark>Style</mark> tab to get your expected design.', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __( 'Badge Text', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type badge text', 'skt-addons-for-elementor' ),
				'separator' => 'before',
				'description' => __( 'Set badge position and control all the style settings from Style tab', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
	...
	protected function __title_desc_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'default' => __( 'SKT Card Title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type Card Title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'SKT card description goes here', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type card description', 'skt-addons-for-elementor' ),
				'rows' => 5,
				'dynamic' => [
					'active' => true,
				]
	...
	protected function __button_content_controls() {
		...
		$this->add_control(
			'button_fullwidth',
			[
				'label' => __( 'Full Width?', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'stretch' => [
						'title' => __( 'Stretch', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-text-align-justify',
					],
				],
				'toggle' => false,
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'options' => [
					'before' => __( 'Before Text', 'skt-addons-for-elementor' ),
					'after' => __( 'After Text', 'skt-addons-for-elementor' ),
				],
				'default' => 'before',
				'toggle' => false,
				'condition' => $condition,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'middle-center' => __( 'Middle Center', 'skt-addons-for-elementor' ),
	...
	protected function render() {
        ...
        wp_enqueue_style( 'main-stylesheet', get_stylesheet_uri(), array(), $theme_version );
    	$custom_css = "
    		.skt-card-body .skt-btn{padding: 20px 25px 25px 20px;}
            .skt-card-body .skt-btn svg{ width:20px !important; height:20px !important;position: relative; top: 5px;}
        ";
		...
		<div class="skt-card-body">
            ...
            if ( $settings['title'] ) :
                $title_tag = sanitize_html_class( $settings['title_tag'] );
                $title_attributes = esc_attr( $this->get_render_attribute_string( 'title' ) );
                $title_content = esc_html( $settings['title'] );
