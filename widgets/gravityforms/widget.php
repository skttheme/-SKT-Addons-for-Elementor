...
class GravityForms extends Base {
	...
	public function get_title() {
		return __( 'Gravity Forms', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => skt_addons_elementor_is_gravityforms_activated() ? __( 'Gravity Forms', 'skt-addons-for-elementor' ) : __( 'Missing Notice',
		...
		if ( ! skt_addons_elementor_is_gravityforms_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'raw' => sprintf(
						/* translators: translate raw text */ __( 'Hello %1$s, looks like Gravity Forms is missing in your site. Please install/activate Gravity Forms. Make sure to refresh this page after installation or activation.', 'skt-addons-for-elementor' ),
			...
			$this->add_control(
				'form_id',
				[
					'label' => __( 'Select Your Form', 'skt-addons-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'label_block' => true,
					'options' => ['' => '' ] + \skt_addons_elementor_get_gravity_forms(),
				]
			);
			...
			$this->add_control(
				'form_title_show',
				[
					'label' => __( 'Form Title', 'skt-addons-for-elementor' ),
			...
			$this->add_control(
				'ajax',
				[
					'label' => __( 'Enable Ajax Submit', 'skt-addons-for-elementor' ),
					'type' => Controls_Manager::SWITCHER,
	...
	protected function __form_fields_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Form Fields', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'large_field_width',
			[
				'label' => __( 'Large Field Width', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'field_margin',
			[
				'label' => __( 'Field Spacing', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'field_textcolor',
			[
				'label' => __( 'Field Text Color', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Field Placeholder Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab(
			'tab_field_focus',
			[
				'label' => __( 'Focus', 'skt-addons-for-elementor' ),
			]
		);
	...
	protected function __form_fields_label_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Form Fields Label', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'label_padding',
			[
				'label' => __( 'Label Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'sub_label_margin',
			[
				'label' => __( 'Sub Label Margin', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'separator' => 'after',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Sub Label Typography', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'label_color',
			[
				'label' => __( 'Label Text Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'sub_label_color',
			[
				'label' => __( 'Sub Label Text Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'requered_label',
			[
				'label' => __( 'Required Label Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function __form_fields_submit_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Submit Button', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'submit_btn_width',
			[
				'label' => __( 'Button Full Width?', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off' => __( 'No', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'button_width',
			[
				'label' => __( 'Button Width', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'condition' => [
		...
		$this->add_control(
			'submit_btn_position',
			[
				'label' => __( 'Button Position', 'skt-addons-for-elementor' ),
	...
	protected function __form_fields_break_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Break', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'section_break',
			[
				'label' => __( 'Section Break', 'skt-addons-for-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Description Typography', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'page_break',
			[
				'label' => __( 'Page Break', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Progress bar background Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Box Shadow', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Border Radius', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Typography', 'skt-addons-for-elementor' ),
				'selector' => '{{WRAPPER}} .gform_next_button.button, {{WRAPPER}} .gform_previous_button.button',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_ACCENT,
				],
	...
	protected function render() {
		if ( ! skt_addons_elementor_is_gravityforms_activated() ) {
			skt_addons_elementor_show_plugin_missing_alert( __( 'Gravity Forms', 'skt-addons-for-elementor' ) );
			return;
		}
