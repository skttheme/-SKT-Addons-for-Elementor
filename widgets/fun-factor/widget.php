...
class Fun_Factor extends Base {
	...
	public function get_title() {
		return __('Fun Factor', 'skt-addons-for-elementor');
	}
	...
	protected function __content_controls() {
		...
		$this->add_control(
			'icons',
			[
				'label'      => __('Icons', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'fun_factor_number',
			[
				'label'     => __('Number', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label'     => __('Number Prefix', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::TEXT,
				'placeholder'   => '1',
				'dynamic'   => [
					'active' => true,
		...
		$this->add_control(
			...
			[
				'label'     => __('Number Suffix', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::TEXT,
				'placeholder'   => '+',
				'dynamic'   => [
					'active' => true,
		...
		$this->add_control(
			...
			[
				...
				'default' => __('SKT Clients', 'skt-addons-for-elementor'),
			]
		);
		...
		$this->add_control(
			'animate_number',
			[
				'label'        => __('Animate', 'skt-addons-for-elementor'),
	...
	protected function __option_content_controls() {
		...
		$this->add_control(
			'divider_show_hide',
			[
				'label'        => __('Show Divider', 'skt-addons-for-elementor'),
				'type'         => Controls_Manager::SWITCHER,
	...
	protected function __number_title_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Number & Title', 'skt-addons-for-elementor'),
				'tab'   => Controls_Manager::TAB_STYLE
			]
		);
            ...
            <div class="skt-fun-factor__content">
				<div class="skt-fun-factor__content-number-wrap">
					<?php if ( $settings['fun_factor_number_prefix'] ) : ?>
						<span class="skt-fun-factor__content-number-prefix"><?php echo esc_html( $settings['fun_factor_number_prefix'] ); ?></span>
					<?php endif; ?>
					...
					<?php if ( $settings['fun_factor_number_suffix'] ) : ?>
						<span class="skt-fun-factor__content-number-suffix"><?php echo esc_html( $settings['fun_factor_number_suffix'] ); ?></span>
					<?php endif; ?>
				</div>
               ...
               <?php
					...
					if (!in_array($title_tag, $valid_tags)) {
						$title_tag = 'h2';
					}
					$fun_factor_title_escaped = wp_kses_post(skt_addons_elementor_kses_basic( $fun_factor_title ));
					printf(
						'<%1$s class="skt-fun-factor__content-text">%2$s</%1$s>',
						esc_html($title_tag),
						$fun_factor_title_escaped
					);
				?>
            </div>
        </div>
