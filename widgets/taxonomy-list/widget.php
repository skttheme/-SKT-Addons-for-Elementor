...
class Taxonomy_List extends Base {
	...
	public function get_title() {
		return __( 'Taxonomy List', 'skt-addons-for-elementor' );
	}
		...
		foreach ( $this->get_taxonomies() as $key => $value ) {
			...
			$repeater[$key]->add_control(
				...
				[
					...
					'description' => __( 'If you want to use individual icon disable common icon.', 'skt-addons-for-elementor' ),
					'options' => [
						'icon' => [
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'common_icon_enable',
			[
				'label' => __( 'Common icon enable?', 'skt-addons-for-elementor' ),
				'description' => __( 'Common icon will overwrite all individual icon.', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'common_icon',
			[
				'label' => __( 'Common Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'icon' => [
						'title' => __( 'Icon', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon', 'skt-addons-for-elementor' ),
				'description' => __( 'Common icon will overwrite individual icon.', 'skt-addons-for-elementor' ),
				'show_label' => false,
				'type' => Controls_Manager::ICONS,
				'default' => [
					'value' => 'far fa-check-circle',
	...
	protected function __icon_image_style_controls() {
		...
		$this->add_responsive_control(
			'icon_line_height',
			[
				'label' => __( 'Icon Line Height', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					...
					<li <?php $this->print_render_attribute_string( 'item' ); ?>>
						<a href="<?php echo esc_url( get_term_link( $terms[$index]->term_id ) ); ?>">
							...
							// Resolved escaping issue
								...
								printf(
									'<%1$s class="skt-taxonomy-list-title">%2$s</%1$s>',
									esc_html( $title_tag ), 
									esc_html( $title ) 
								);
							}
