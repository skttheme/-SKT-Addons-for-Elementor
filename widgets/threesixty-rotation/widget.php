...
class Threesixty_Rotation extends Base {
	...
	public function get_title() {
		return __('360 Rotation', 'skt-addons-for-elementor');
	}
	...
	protected function __threesixty_rotation_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Threesixty Rotation', 'skt-addons-for-elementor'),
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'none',
				'options' => [
					'autoplay'  => __( 'Autoplay', 'skt-addons-for-elementor' ),
					'button'  => __( 'Button Play', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'magnify',
			[
				'label' => __('Magnify', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'zoom',
			[
				'label' => __('Magnify Zoom', 'skt-addons-for-elementor'),
	...
	protected function __autoplay_btn_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('AutoPlay Button', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'auto_play' => 'button',
				]
