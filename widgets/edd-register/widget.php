...
class EDD_Register extends Base {
	...
	return __( 'EDD Register', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
            'redirect_url',
            [
                'label' => __( 'Redirect URL', 'skt-addons-for-elementor' ),
	...
	protected function render() {
		...
		if (  skt_addons_elementor()->editor->is_edit_mode()) {
			...
			echo skt_addons_elementor_do_shortcode('edd_register'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 

			remove_filter( 'edd_register_form', [$this, 'edd_editor_form_preview']);

		}else{

			echo skt_addons_elementor_do_shortcode('edd_register', $atts); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
	...
	function edd_editor_form_preview($template){
		...
		<form id="edd_register_form" class="edd_form" action="" method="post">
			...
			<fieldset>
				<legend><?php esc_attr_e( 'Register New Account', 'skt-addons-for-elementor' ); ?></legend>

				<?php do_action( 'edd_register_form_fields_before' ); ?>

				<p>
					<label for="edd-user-login"><?php esc_attr_e( 'Username', 'skt-addons-for-elementor' ); ?></label>
					<input id="edd-user-login" class="required edd-input" type="text" name="edd_user_login" />
				</p>

				<p>
					<label for="edd-user-email"><?php esc_attr_e( 'Email', 'skt-addons-for-elementor' ); ?></label>
					<input id="edd-user-email" class="required edd-input" type="email" name="edd_user_email" />
				</p>

				<p>
					<label for="edd-user-pass"><?php esc_attr_e( 'Password', 'skt-addons-for-elementor' ); ?></label>
					<input id="edd-user-pass" class="password required edd-input" type="password" name="edd_user_pass" />
				</p>

				<p>
					<label for="edd-user-pass2"><?php esc_attr_e( 'Confirm Password', 'skt-addons-for-elementor' ); ?></label>
				...
				<p>
					...
					<input class="edd-submit" name="edd_register_submit" type="submit" value="<?php esc_attr_e( 'Register', 'skt-addons-for-elementor' ); ?>" />
				</p>
