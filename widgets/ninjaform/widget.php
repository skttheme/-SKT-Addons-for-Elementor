...
class NinjaForm extends Base {
    ...
    public function get_title() {
        return __( 'Ninja Forms', 'skt-addons-for-elementor' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_ninjaforms',
			[
				'label' => skt_addons_elementor_is_ninjaforms_activated() ? __( 'Ninja Forms', 'skt-addons-for-elementor' ) : __( 'Missing Notice', 'skt-addons-for-elementor' ),
        ...
        if ( ! skt_addons_elementor_is_ninjaforms_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => '' ] + \skt_addons_elementor_get_ninjaform(),
				]
			);
    ...
    protected function render() {
        if ( ! skt_addons_elementor_is_ninjaforms_activated() ) {
			skt_addons_elementor_show_plugin_missing_alert(__( 'Ninja Form', 'skt-addons-for-elementor' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo skt_addons_elementor_do_shortcode( 'ninja_form', [ // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                'id' => $settings['form_id'],
            ] );
        }
    }
