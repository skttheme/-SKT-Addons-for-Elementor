...
class Justified_Gallery extends Base {
	...
	public function get_title() {
		return __( 'Justified Grid', 'skt-addons-for-elementor' );
	}
	...
	protected function __advance_content_controls() {
		...
		$this->add_control(
			'show_caption',
			[
				'label' => __( 'Show Caption', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'separator' => 'before',
				'description' => __( 'Make sure to add image caption.', 'skt-addons-for-elementor' ),
				'style_transfer' => true,
		...
		$this->add_control(
			'margins',
			[
				'label' => __( 'Margins', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default' => [
					'size' => 10,
		...
		$this->add_control(
			'last_row',
			[
				'label' => __( 'Last Row', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'justify',
				'options' => [
					'nojustify' => __( 'No Justify', 'skt-addons-for-elementor' ),
					'justify' => __( 'Justify', 'skt-addons-for-elementor' ),
					'hide' => __( 'Hide', 'skt-addons-for-elementor' ),
				],
				'frontend_available' => true,
				'render_type' => 'ui',
			]
	...
	protected function __image_style_controls() {
		...
		$this->add_control(
			'image_hover_cursor',
			[
				'label' => __( 'Hover Cursor', 'skt-addons-for-elementor' ),
	...
	protected function __caption_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Caption', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
