...
class Advanced_Tabs extends Base {
	...
	public function get_title() {
		return __( 'Advanced Tabs', 'skt-addons-for-elementor' );
	}
	...
	protected function __tabs_content_controls() {
		...
		$this->start_controls_section(
			'_section_tabs',
			[
				'label' => __( 'Tabs', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type Tab Title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
	...
	protected function __options_content_controls() {
		...
		$this->add_control(
			'_heading_tab_title',
			[
				'label' => __( 'Tab Title', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Only applicable for desktop', 'skt-addons-for-elementor' ),
				'default' => 'top',
				'toggle' => false,
				'options' => [
					'left' => [
		...
		$this->add_control(
			'_heading_tab_icon',
			[
				'label' => __( 'Tab Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function __tab_title_style_controls() {
		...
		$this->add_control(
			'nav_margin_x',
			[
				'label' => __( 'Horizontal Margin (px)', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'nav_margin_y',
			[
				'label' => __( 'Vertical Margin (px)', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::NUMBER,
				'step' => 'any',
				'selectors' => [
		...
		$this->add_control(
			'nav_border_style',
			[
				'label' => __( 'Border Style', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
	...
	protected function __tab_content_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Tab Content', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
				...
				foreach ( $tabs as $index => $item ) :
					...
					<div <?php echo wp_kses_post($this->get_render_attribute_string( $tab_content_setting_key )); ?>>
						...
						elseif ( $item['source'] === 'template' && $item['template'] ) :
							echo wp_kses(skt_addons_elementor()->frontend->get_builder_content_for_display( $item['template'] ), $allowed_html) ;  // Resolved escaping issued
						endif;
						?>
					</div>
				<?php endforeach; ?>
