...
class Image_Hover_Effect extends Base {
	...
	public function get_title() {
		return __('Image Hover Effect', 'skt-addons-for-elementor');
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Image Content', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'hover_image_alt_tag',
			[
				'label' => __('Image ALT Tag', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'default' => __('Image hover effect image', 'skt-addons-for-elementor'),
				'placeholder' => __('Type here image alt tag value', 'skt-addons-for-elementor'),
				'dynamic' => ['active' => true,],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => __('SKT <span>Addons</span>', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXTAREA,
				'rows' => 10,
				'default' => __('Best Elementor Addons', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'hover_effect',
			[
				'label' => __('Hover Effect', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SELECT2,
				'options' => [
					'skt-effect-apollo'  => __('Apollo', 'skt-addons-for-elementor'),
					'skt-effect-bubba'  => __('Bubba', 'skt-addons-for-elementor'),
					'skt-effect-chico'  => __('Chico', 'skt-addons-for-elementor'),
					'skt-effect-dexter'  => __('Dexter', 'skt-addons-for-elementor'),
					'skt-effect-duke'  => __('Duke', 'skt-addons-for-elementor'),
					'skt-effect-goliath'  => __('Goliath', 'skt-addons-for-elementor'),
					'skt-effect-honey'  => __('Honey', 'skt-addons-for-elementor'),
					'skt-effect-jazz'  => __('Jazz', 'skt-addons-for-elementor'),
					'skt-effect-layla'  => __('Layla', 'skt-addons-for-elementor'),
					'skt-effect-lexi'  => __('Lexi', 'skt-addons-for-elementor'),
					'skt-effect-lily'  => __('Lily', 'skt-addons-for-elementor'),
					'skt-effect-marley'  => __('Marley', 'skt-addons-for-elementor'),
					'skt-effect-milo'  => __('Milo', 'skt-addons-for-elementor'),
					'skt-effect-ming'  => __('Ming', 'skt-addons-for-elementor'),
					'skt-effect-moses'  => __('Moses', 'skt-addons-for-elementor'),
					'skt-effect-oscar'  => __('Oscar', 'skt-addons-for-elementor'),
					'skt-effect-romeo'  => __('Romeo', 'skt-addons-for-elementor'),
					'skt-effect-roxy'  => __('Roxy', 'skt-addons-for-elementor'),
					'skt-effect-ruby'  => __('Ruby', 'skt-addons-for-elementor'),
					'skt-effect-sadie'  => __('Sadie', 'skt-addons-for-elementor'),
					'skt-effect-sarah'  => __('Sarah', 'skt-addons-for-elementor'),
				],
	...
	protected function __common_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __('Container Max Width?', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'description_color',
			[
				'label' => __('Description Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					...
					<?php if ($settings['hover_effect'] == 'skt-effect-lily') : ?>
						...
						<?php
							...
							if ( ! empty( $settings['hover_title'] ) ) {
								...
								$hover_title_content = wp_kses_post( skt_addons_elementor_kses_intermediate( $settings['hover_title'] ) );
								printf(
									'<%1$s class="skt-ihe-title">%2$s</%1$s>',
									esc_html( $title_tag ),
									$hover_title_content
								);
							}
