...
class Image_Scroller extends Base {
	...
	public function get_title() {
		return __('Single Image Scroll', 'skt-addons-for-elementor');
	}
	...
	protected function __image_scroller_content_controls() {
		...
		$this->add_control(
            'scroller_image',
            [
                'label' => __('Scroller Image', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Container Height Note', 'skt-addons-for-elementor'),
				'show_label' => false,
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'raw' => __( "Make sure Container height/width is less than the Image's actual height/width. Otherwise scroll will not work.", 'skt-addons-for-elementor' ),
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'lightbox' => __('Lightbox', 'skt-addons-for-elementor'),
                    'custom_link' => __('Custom Link', 'skt-addons-for-elementor'),
                ],
            ]
        );
		...
		$this->add_control(
			'lightbox_note',
			[
				'label' => __( 'Lightbox Note', 'skt-addons-for-elementor'),
				'show_label' => false,
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'raw' => __( "Make sure elementor's Lightbox option is enable.", 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Badge Text', 'skt-addons-for-elementor' ),
				'default' => __( 'Badge', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				],
				'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options'       => [
                    ...
                    'scroll'  => __('Mouse Scroll', 'skt-addons-for-elementor'),
                ],
                'default'       => 'hover',
				'separator' => 'before',
            ]
		...
		$this->add_control(
			'scroll_type',
			[
				'label' => __('Scroll Type', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description'	=> __( 'Set the scroll speed in seconds. Default 3', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'indicator_icon',
            [
                'label' => __('Indicator Icon', 'skt-addons-for-elementor'),
				'type'  => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
