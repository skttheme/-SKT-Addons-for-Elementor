...
class Timeline extends Base {
	...
	public function get_title() {
		return __('Timeline', 'skt-addons-for-elementor');
	}
	...
	protected function __timeline_content_controls() {
		...
		$repeater->add_control(
			'image',
			[
				'label' => __('Image Icon', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			'time_style',
			[
				'label' => __('Time', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'calender' => __('Calender', 'skt-addons-for-elementor'),
					'text' => __('Text', 'skt-addons-for-elementor'),
				],
				'default' => 'calender',
				'style_transfer' => true,
			]
		...
		$repeater->add_control(
			'time',
			[
				'label' => __('Calender Time', 'skt-addons-for-elementor'),
				'show_label' => false,
		...
		$repeater->add_control(
			'time_text',
			[
				'label' => __('Text Time', 'skt-addons-for-elementor'),
				'show_label' => false,
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'default' => __('2016 - 2018', 'skt-addons-for-elementor'),
				'placeholder' => __('Text Time', 'skt-addons-for-elementor'),
				'condition' => [
					'time_style' => 'text'
				],
                'dynamic' => [
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('This Is SKT Title', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'before' => __('Before Title', 'skt-addons-for-elementor'),
					'after' => __('After Content', 'skt-addons-for-elementor'),
				],
				'default' => 'before',
				'style_transfer' => true,
			]
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => __('Type your content here', 'skt-addons-for-elementor'),
			]
		);
		...
		$repeater->add_control(
			'button_link',
			[
				'label' => __('Button Link', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			'single_icon_box_bg',
			[
				'label' => __('Icon box Background', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => __('Icon box border color', 'skt-addons-for-elementor'),
				'description' => __('Color will apply after set the border from style.', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => __('Icon box tree color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'timeline_item',
			[
				'label' => __('Content List', 'skt-addons-for-elementor'),
				...
				'default' => [
					[
						...
						'title' => __('This Is SKT Title', 'skt-addons-for-elementor'),
						'image_position' => 'before',
						'content' => '<p>' . __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut', 'skt-addons-for-elementor') . '</p>',
						'button_text' => __('Button Text', 'skt-addons-for-elementor'),
						'button_link' => [
							'url' => '#',
							'is_external' => true,
							'nofollow' => true,
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'show_date',
			[
				'label' => __('Show Date?', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'show_time',
			[
				'label' => __('Show Time?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'skt-addons-for-elementor'),
				'label_off' => __('Hide', 'skt-addons-for-elementor'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_content_arrow',
			[
				'label' => __('Show Content Arrow?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'skt-addons-for-elementor'),
				'label_off' => __('Hide', 'skt-addons-for-elementor'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __('Title Tag', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'h2',
				'options' => [
					'h1' => [
		...
		$this->add_control(
			'icon_box_align',
			[
				'label' => __('Icon Box Alignment', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
		...
		$this->add_control(
			'tree_align',
			[
				'label' => __('Tree Alignment', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __('Left', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'show_scroll_tree',
			[
				'label' => __('Show Scroll Tree?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'skt-addons-for-elementor'),
				'label_off' => __('Hide', 'skt-addons-for-elementor'),
				'return_value' => 'yes',
	...
	protected function __content_box_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Content Box', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => __('Arrow Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					//Align center
	...
	protected function __icon_box_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Icon Box', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'icon_box_space',
			[
				'label' => __('Box Space', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'icon_box_tree_space',
			[
				'label' => __('Tree Space', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Icon box border', 'skt-addons-for-elementor'),
		...
		$this->add_responsive_control(
			'icon_box_tree_width',
			[
				'label' => __('Tree Width', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'icon_box_tree_color',
			[
				'label' => __('Tree color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function __time_date_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Time & Date', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
				'conditions' => [
					'terms' => [
						[
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Date Typography', 'skt-addons-for-elementor'),
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
			],
		...
		$this->add_responsive_control(
			'date_color',
			[
				'label' => __('Date Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
		...
		$this->add_responsive_control(
			'date_margin',
			[
				'label' => __('Date Margin', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Time Typography', 'skt-addons-for-elementor'),
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
			],
		...
		$this->add_responsive_control(
			'time_color',
			[
				'label' => __('Time Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'devices' => ['desktop', 'tablet', 'mobile'],
				'selectors' => [
		...
		$this->add_responsive_control(
			'time_margin',
			[
				'label' => __('Time Margin', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors' => [
	...
	protected function render() {
		...
		<?php if ($settings['timeline_item']):
			foreach ($settings['timeline_item'] as $key => $item):?>
				...
				if('calender' == $item['time_style']){
					$date = gmdate("d M Y", strtotime($item['time']));
				}
				
				$time = 'calender' == $item['time_style'] ? gmdate("g:i a", strtotime($item['time'])) : '';
				//Icon Image
				...
				<div <?php $this->print_render_attribute_string('timeline-block'); ?>>
					...
					if ( ! empty( $item['title'] ) ) {
						...
						printf(
							'<%1$s %2$s>%3$s</%1$s>',
							esc_html( $title_tag ), // Escape the HTML tag for safety
							wp_kses_post( $this->get_render_attribute_string( $title_key ) ), // Escape dynamic attributes
							esc_html( $item['title'] ) // Escape the title content to prevent XSS
						);
					}

					if ($item['content']) {
						// Resolved escaping issue
						printf('<div %s>%s</div>',wp_kses_post( $this->get_render_attribute_string($content_key)), wp_kses_post($this->parse_text_editor($item['content'])));
					}
					...
					if ($item['button_text']) {
						printf('<a %s>%s</a>', wp_kses_post($this->get_render_attribute_string($button_key)), esc_html($item['button_text']));
					}
					?>
				</div>
				</div>
