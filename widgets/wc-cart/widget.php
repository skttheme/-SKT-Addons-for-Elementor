...
class WC_Cart extends Base {
	...
	public function get_title() {
		return __( 'WC Cart', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			'hide_coupon',
			[
				'label'					=> __( 'Hide Coupon Field', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'hide_cross_sells',
			[
				'label'					=> __( 'Hide Cross Sells', 'skt-addons-for-elementor' ),
				'type'					=> Controls_Manager::SWITCHER,
				'return_value'			=> 'yes',
				'frontend_available'    => true,
			]
	...
	protected function ___cart_table_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Hover Background', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::COLOR,
				'selectors'             => [
	...
	protected function ___coupon_style_controls() {
		$this->start_controls_section(
			'form_coupon_style',
			[
				'label'                 => __( 'Coupon', 'skt-addons-for-elementor' ),
				'tab'                   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function ___totals_heading_style_controls() {
		$this->start_controls_section(
			...
			[
				'label'                 => __( 'Cart Totals: Heading', 'skt-addons-for-elementor' ),
				'tab'                   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function ___cross_sells_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label'                 => __( 'Cross Sells', 'skt-addons-for-elementor' ),
                'tab'                   => Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Sale Badge', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::HEADING,
				'separator'				=> 'before',
			]
		);
	...
	protected function render() {
		...
		// Resolved escaping function
		echo wp_kses_post(skt_addons_elementor_do_shortcode( 'woocommerce_cart' ));
		self::_restore_env();
	}
}