...
class Edd_Category_Carousel extends Base {
	...
	public function get_title() {
		return __( 'EDD Category Carousel', 'skt-addons-for-elementor' );
	}
	...
	public function get_html_wrapper_class() {
		...
		$html_class .= ' skt-addons-for-elementor';
	...
	protected function query_content_tab_controls() {
		...
		$this->add_control(
			'cat_per_page',
			[
				'label' => __( 'Number of Categories', 'skt-addons-for-elementor' ),
	...
	public function render() {
		...
		if ( empty( $product_cats ) ) {
			if ( is_admin() ) {
				return printf( '<div class="skt-cat-carousel-error">%s</div>', esc_attr__( 'Nothing Found. Please Add Category.', 'skt-addons-for-elementor' ) );
			}
		}
					...
					<div class="skt-product-cat-carousel-item-inner">
						...
						<div class="skt-product-cat-carousel-content">
							<div class="skt-product-cat-carousel-content-inner">
								...
								$product_cat_name = esc_html( $product_cat->name );
								$product_cat_link = esc_url( get_term_link( $product_cat->term_id, 'download_category' ) );
								echo '<' . $title_tag . ' class="skt-product-cat-carousel-title">';
								echo '<a href="' . $product_cat_link . '">' . $product_cat_name . '</a>';
								echo '</' . $title_tag . '>';
								?>
