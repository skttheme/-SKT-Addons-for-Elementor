...
class WPForm extends Base {
    ...
    public function get_title() {
        return __( 'WPForms', 'skt-addons-for-elementor' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_wpforms',
			[
				'label' => skt_addons_elementor_is_wpforms_activated() ? __( 'WPForms', 'skt-addons-for-elementor' ) : __( 'Missing Notice',
        ...
        if ( ! skt_addons_elementor_is_wpforms_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( 'Select a WPForm', 'skt-addons-for-elementor' ) ] + \skt_addons_elementor_get_wpforms(),
				]
			);
    ...
    protected function __fields_style_controls() {
        ...
        $this->start_controls_tab(
            'tab_field_normal',
            [
                'label' => __( 'Normal State', 'skt-addons-for-elementor' ),
            ]
        );
    ...
    protected function __label_style_controls() {
        ...
        $this->add_control(
            'label_color_popover',
            [
                'label' => __( 'Colors', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
            'desc_label_color',
            [
                'label' => __( 'Description Text Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        if ( ! skt_addons_elementor_is_wpforms_activated() ) {
			skt_addons_elementor_show_plugin_missing_alert( __( 'WPForms', 'skt-addons-for-elementor' ) );
            return;
        }
