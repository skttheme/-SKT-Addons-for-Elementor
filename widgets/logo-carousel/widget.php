...
class Logo_Carousel extends Base {
	...
	public function get_title() {
		return __( 'Logo Carousel', 'skt-addons-for-elementor' );
	}
	...
	protected function __logo_content_controls() {
		...
		$repeater->add_control(
			'link',
			[
				'label' => __( 'Website Url', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'name',
            [
                'label' => __( 'Brand Name', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __( 'Company Name', 'skt-addons-for-elementor' ),
                'description' => __( 'Add relevant name of the logo, for better SEO.', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
