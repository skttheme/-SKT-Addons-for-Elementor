...
class Site_Title extends Base {
	...
	public function get_title() {
		return __( 'Site Title', 'skt-addons-for-elementor' );
	}
	...
	protected function __site_title_content_control(){
		$this->start_controls_section(
			'_section_site_title',
			[
				'label' => __( 'Site Title', 'skt-addons-for-elementor' ),
...
$archive_title_tag = sanitize_html_class($settings['site_title_tag']);
...
echo '</a>';
$escaped_js_site_name = esc_js(get_bloginfo('name'));
