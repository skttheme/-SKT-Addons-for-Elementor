...
class One_Page_Nav extends Base {
    ...
    public function get_title() {
        return __('One Page Nav', 'skt-addons-for-elementor');
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            'select_design',
            [
                'label' => __('Navigation Style', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'skt-opn-design-default',
                'options' => [
                    'skt-opn-design-default'  => __('Default', 'skt-addons-for-elementor'),
                    'skt-opn-design-berta' => __('Berta', 'skt-addons-for-elementor'),
                    'skt-opn-design-hagos' => __('Hagos', 'skt-addons-for-elementor'),
                    'skt-opn-design-magool' => __('Magool', 'skt-addons-for-elementor'),
                    'skt-opn-design-maxamed' => __('Maxamed', 'skt-addons-for-elementor'),
                    'skt-opn-design-shamso' => __('Shamso', 'skt-addons-for-elementor'),
                    'skt-opn-design-ubax' => __('Ubax', 'skt-addons-for-elementor'),
                    'skt-opn-design-xusni' => __('Xusni', 'skt-addons-for-elementor'),
                    'skt-opn-design-zahi' => __('Zahi', 'skt-addons-for-elementor'),
                ],
        ...
        $navigation->add_control(
            'section_id',
            [
                'label' => __('Section ID', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Add your section ID here', 'skt-addons-for-elementor'),
                'label_block' => true,
                'dynamic' => ['active' => true],
            ]
        );
        ...
        $navigation->add_control(
            'nav_title',
            [
                'label' => __('Navigation Title', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Add your Navigation Title here', 'skt-addons-for-elementor'),
        ...
        $navigation->add_control(
            'tooltip_title',
            [
                'label' => __('Tooltip Title', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Add your Tooltip Title here', 'skt-addons-for-elementor'),
                'classes' => 'skt-opn-design-refactor-default',
                'label_block' => true,
                'dynamic' => ['active' => true],
            ]
        ...
        $navigation->add_control(
            'custom_style_enable',
            [
                'label' => __('Enable Custom Style?', 'skt-addons-for-elementor'),
        ...
        $navigation->add_control(
            ...
            [
                'label' => __('Content Color Hover', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'custom_style_enable' => 'yes',
                ],
        ...
        $navigation->add_control(
            ...
            [
                'label' => __('Content Color Active', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'custom_style_enable' => 'yes',
                ],
        ...
        $this->add_control(
            'navigation_lists',
            [
                'label' => __('Navigation List', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $navigation->get_controls(),
                'default' => [
                    [
                        'section_id' => 'section1',
                        'tooltip_title' => __('Section 1', 'skt-addons-for-elementor'),
                    ],
                    [
                        'section_id' => 'section2',
                        'tooltip_title' => __('Section 2', 'skt-addons-for-elementor'),
                    ],
                    [
                        'section_id' => 'section3',
                        'tooltip_title' => __('Section 3', 'skt-addons-for-elementor'),
                    ],
                ],
            ]
        );
        ...
        $this->add_control(
            'tooltip',
            [
                'label' => __('Enable Tooltip?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'tooltip_arrow',
            [
                'label' => __('Enable Tooltip Arrow?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('On', 'skt-addons-for-elementor'),
                'label_off' => __('Off', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'scroll_wheel',
            [
                'label' => __('Scroll Wheel', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('On', 'skt-addons-for-elementor'),
                'label_off' => __('Off', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => esc_html__('Scroll to specific section with mouse wheel scroll.', 'skt-addons-for-elementor'),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'touch_swipe',
            [
                'label' => __('Touch Swipe', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('On', 'skt-addons-for-elementor'),
                'label_off' => __('Off', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => esc_html__('Scroll to specific section with touch swipe (Only for mobile).', 'skt-addons-for-elementor'),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'scroll_keys',
            [
                'label' => __('Scroll Keys', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('On', 'skt-addons-for-elementor'),
                'label_off' => __('Off', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => esc_html__('Scroll to specific section with keyboard up/down arrow keys.', 'skt-addons-for-elementor'),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'row_to_offset',
            [
                'label' => __('Row To Offset (px)', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'scrolling_speed',
            [
                'label' => __('Scrolling Speed (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::NUMBER,
                'min' => 100,
                'max' => 10000,
                'step' => 50,
    ...
    protected function register_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Navigation Content', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'nav_icon_size',
            [
                'label' => __('Icons Size', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Fixed Height & Width', 'skt-addons-for-elementor'),
        ...
        $this->add_responsive_control(
            'nav_space_between',
            [
                'label' => __('Space Between Icon & Title', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'nav_content_margin',
            [
                'label' => __('Space between nav', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range' => [
                    'px' => [
...
?>
            <div class="skt-editor-placeholder">
                <h4 class="skt-editor-placeholder-title">
                    <?php esc_html_e('One Page Nav', 'skt-addons-for-elementor'); ?>
                </h4>
                <div class="skt-editor-placeholder-content">
                    <?php esc_html_e('This placeholder text doesn\'t serve any purpose. It won\'t show up in the frontend either. Go to preview mode to see full functionalities.', 'skt-addons-for-elementor'); ?>
                </div>
            </div>
        <?php endif; ?>
                                ...
                                <?php if ($settings['select_design'] != 'skt-opn-design-magool') : ?>
                                    <span class="skt_addons_elementor_opn__item-title">
                                        ...
                                        if (empty($nav['nav_title']) && ($settings['select_design'] == 'skt-opn-design-berta' || $settings['select_design'] == 'skt-opn-design-xusni')) {
                                            echo esc_html__('Section ', 'skt-addons-for-elementor') . (esc_attr($i) + 1);
