...
class Post_Carousel extends Base {
    ...
    public function get_title() {
        return __( 'Post Carousel', 'skt-addons-for-elementor' );
    }
    ...
    protected function __layout_content_controls() {
		...
		$this->add_control(
			'post_category',
			[
				'label' => __( 'Show Badge', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Active Meta', 'skt-addons-for-elementor' ),
				'description' => __( 'Select to show and unselect to hide', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'multiple' => true,
				'default' => ['author', 'date'],
				'options' => [
        ...
        $this->add_control(
			'post_author_meta',
			[
				'label' => __( 'Author Avatar', 'skt-addons-for-elementor' ),
				'label_block' => false,
				...
				'options' => [
					...
					'image' => __( 'Image', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'author_name_show',
			[
				'label' => __( 'Author Name', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'author_icon',
			[
				'label' => __( 'Author Icon', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
			'date_icon',
			[
				'label' => __( 'Date Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'label_block' => false,
				'skin' => 'inline',
				'default' => [
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Layout', 'skt-addons-for-elementor' ),
				'description' => __( 'Make sure that <strong>Query > With Featured Image</strong> is enabled.', 'skt-addons-for-elementor' ),
				'label_block' => false,
				...
				'options' => [
					'under_image' => [
						'title' => __( 'Content Under Image', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-menu-bar',
					],
					'over_image' => [
						'title' => __( 'Content Over Image', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-clone',
					],
				]
			]
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Author Meta Position', 'skt-addons-for-elementor' ),
				'label_block' => false,
				'type' => Controls_Manager::SELECT,
                'default' => 'after_title',
				'options' => [
					'after_title' => __( 'After Title', 'skt-addons-for-elementor' ),
					'after_content' => __( 'After Content', 'skt-addons-for-elementor' )
                ],
        ...
        $this->add_control(
            'content_position',
            [
                'label' => __( 'Content Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'top_left',
                ...
                'options' => [
					'top_left' => __( 'Top Left', 'skt-addons-for-elementor' ),
					'top_center' => __( 'Top Center', 'skt-addons-for-elementor' ),
                    'top_right' => __( 'Top Right', 'skt-addons-for-elementor' ),
					'bottom_left' => __( 'Bottom Left', 'skt-addons-for-elementor' ),
					'bottom_center' => __( 'Bottom Center', 'skt-addons-for-elementor' ),
                    'bottom_right' => __( 'Bottom Right', 'skt-addons-for-elementor' ),
					'center_left' => __( 'Center Left', 'skt-addons-for-elementor' ),
					'center_center' => __( 'Center Center', 'skt-addons-for-elementor' ),
					'center_right' => __( 'Center Right', 'skt-addons-for-elementor' ),
                ]
            ]
		);
		...
		$this->add_control(
			'date_position',
			[
				'label' => __( 'Date Position', 'skt-addons-for-elementor' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
                'default' => 'block',
                'toggle' => false,
				'options' => [
					...
					'block' => [
						'title' => __( 'Block', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-menu-bar',
					],
                ],
                'selectors_dictionary' => [
        ...
        $this->add_control(
			'image_alignment',
			[
				'label' => __( 'Image Alignment', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'skt-addons-for-elementor' ),
    ...
    protected function __query_content_controls() {
		...
		$this->add_control(
            'post_per_page',
            [
                'label' => __( 'Post Per Page', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'step' => 1,
                'max' => 10000,
    ...
    protected function __items_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Item Padding', 'skt-addons-for-elementor' ),
    ...
    protected function __image_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __( '<strong>Image</strong> is Switched off on "Query"', 'skt-addons-for-elementor' ),
                'condition' => [
                    'posts_only_with_featured_image!' => 'yes',
                ],
            ]
		...
		$this->add_responsive_control(
            ...
            [
                'label' => __( 'Inner Spacing', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'condition' => [
                    'layout' => 'over_image'
        ...
        $this->add_control(
			'image_animation',
			[
				'label' => __( 'Hover Animation', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'image_overlay_color',
			[
				'label' => __( 'Hover Overlay Color', 'skt-addons-for-elementor' ),
    ...
    protected function __content_style_controls() {
		...
		$this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __( '<strong>Author Name</strong> is Switched off on "Layout"', 'skt-addons-for-elementor' ),
                'condition' => [
        ...
        $this->add_control(
            '_heading_date',
            [
                'label' => __( 'Date', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __( '<strong>Date</strong> is not selected in "Layout > Active Meta"', 'skt-addons-for-elementor' ),
                'condition' => [
                    'active_meta!' => 'date'
                ],
            ]
		...
		$this->add_control(
            ...
            [
                'label' => false,
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __( '<strong>Excerpt</strong> switched off on "Layout"', 'skt-addons-for-elementor' ),
                'condition' => [
                    'excerpt_show!' => 'yes',
                ],
            ]
    ...
    protected function post_carousel($settings) {
        ...
        if ( empty( $posts ) ) {
            if ( is_admin() ) {
                return printf( '<div class="skt-posts-carousel-error">%s</div>', esc_attr__( 'Nothing Found. Please Add/Select Posts.', 'skt-addons-for-elementor' ) );
            }
		}
        ?>
