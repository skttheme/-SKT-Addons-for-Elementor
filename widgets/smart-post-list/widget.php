...
class Smart_Post_List extends Base {
	...
	public function get_title () {
		return __( 'Smart Post List', 'skt-addons-for-elementor' );
	}
	...
	protected function __layout_content_controls() {
		...
		$this->add_control(
			'column',
			[
				'label' => __( 'Column', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'col-3',
				'options' => [
					'col-1' => __('Column 1', 'skt-addons-for-elementor'),
					'col-2' => __('Column 2', 'skt-addons-for-elementor'),
					'col-3' => __('Column 3', 'skt-addons-for-elementor'),
				],
			]
		);
		...
		$this->add_control(
			'top_bar_show',
			[
				'label' => __( 'Show Top Bar', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'make_featured_post',
			[
				'label' => __( 'First Post Featured', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Featured Post Column', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'featured-col-1',
				'options' => [
					'featured-col-1' => __('Column 1', 'skt-addons-for-elementor'),
					'featured-col-2' => __('Column 2', 'skt-addons-for-elementor'),
				],
				'condition' => [
					'column!' => 'col-1',
	...
	protected function __top_bar_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'h4',
				'options' => [
					'h1' => __( 'H1', 'skt-addons-for-elementor' ),
					'h2' => __( 'H2', 'skt-addons-for-elementor' ),
					'h3' => __( 'H3', 'skt-addons-for-elementor' ),
					'h4' => __( 'H4', 'skt-addons-for-elementor' ),
					'h5' => __( 'H5', 'skt-addons-for-elementor' ),
					'h6' => __( 'H6', 'skt-addons-for-elementor' ),
					'div' => __( 'DIV', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'widget_title!' => '',
				],
	...
	protected function __featured_post_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Featured Post', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'make_featured_post' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'inside-conent' => __('Content Inside', 'skt-addons-for-elementor'),
					'outside-conent' => __('Content Outside', 'skt-addons-for-elementor'),
				],
				'condition' => [
					'make_featured_post' => 'yes',
				]
		...
		$this->add_control(
			'taxonomy_badge',
			[
				'label' => __( 'Badge Taxonomy', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Author Icon', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Date Icon', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::ICONS,
                'label_block' => false,
                'skin' => 'inline',
                'default' => [
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Comment Icon', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::ICONS,
                'label_block' => false,
                'skin' => 'inline',
                'default' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'middle' => [
						'title' => __( 'Middle', 'skt-addons-for-elementor' ),
	...
	protected function __list_post_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'List Post', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
	...
	protected function __layout_style_controls(){
		...
		$this->add_responsive_control(
			'spl_grid_gap',
			[
				'label' => __( 'Column Gap', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'spl_grid_row_gap',
			[
				'label' => __( 'Row Gap', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Feature Item Height', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Post List Item Height', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	protected function __top_bar_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Topbar', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'top_bar_show' => 'yes',
				],
	...
	protected function __top_bar_title_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Topbar Title', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'top_bar_show' => 'yes',
					'widget_title!' => '',
		...
		/* $this->add_control(
			...
			[
				'label' => __( 'Widget Title', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Margin Right', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
	...
	protected function __top_bar_filter_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Topbar Filter', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'top_bar_show' => 'yes',
					'category_filter' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Inline Filter', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'category_filter' => 'yes',
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Hover/Active', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Dropdown Filter', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'category_filter' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Select Box Height', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Space Right', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Dropdown Item Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
	...
	protected function __top_bar_navigation_style_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Topbar Navigation', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'top_bar_show' => 'yes',
					'navigation_show' => 'yes',
	...
	protected function __featured_post_style_controls(){
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'This overlay color only apply when post has an image.', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Image Overlay Note', 'skt-addons-for-elementor' ),
				'show_label' => false,
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'This overlay color only apply when post has an image.', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Icon Space', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		?>
			...
			<div class="skt-spl-header">
				...
				if ( ! empty( $settings['widget_title'] ) ) {
					$widget_title_tag = isset( $settings['widget_title_tag'] ) ? sanitize_html_class( $settings['widget_title_tag'] ) : 'h2';
					$valid_tags = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'div', 'span'];
					if ( ! in_array( $widget_title_tag, $valid_tags, true ) ) {
						$widget_title_tag = 'h2';
					}
					printf(
						'<%1$s class="skt-spl-widget-title">%2$s</%1$s>',
						esc_html( $widget_title_tag ), // Escape the HTML tag to ensure it is safe
						esc_html( $settings['widget_title'] ) // Escape the widget title content to prevent XSS
					);
				}
				?>
			</div>
	...
	protected function render () {
		...
		<?php
			...
			printf( '%1$s %2$s %3$s',
				esc_attr__( 'No ', 'skt-addons-for-elementor' ),
				esc_html( $settings['posts_post_type'] ),
				esc_attr__( 'Found', 'skt-addons-for-elementor' )
			);
		endif;
	}
}