...
class Countdown extends Base {
	...
	public function get_title() {
		return __('Countdown', 'skt-addons-for-elementor');
	}
	...
	protected function __time_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__('Set the due date and time', 'skt-addons-for-elementor'),
			]
		);
	...
	protected function __settings_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Countdown Settings', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'label_position',
			[
				'label' => __('Label Position', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'label_space',
			[
				'label' => __('Label Space', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'label_space_top',
			[
				'label' => __('Label Space Top', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'label_space_left',
			[
				'label' => __('Label Space Left', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'show_label_days',
			[
				'label' => esc_html__('Show Label Days?', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'label_days',
			[
				'label' => esc_html__('Label Days', 'skt-addons-for-elementor'),
				'description' => esc_html__('Set the label for days.', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __('Days', 'skt-addons-for-elementor'),
				'default' => 'Days',
				'condition' => [
					'show_label_days' => 'yes',
				],
		...
		$this->add_control(
			'show_label_hours',
			[
				'label' => esc_html__('Show Label Hours?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
                'style_transfer' => true,
		...
		$this->add_control(
			'label_hours',
			[
				'label' => esc_html__('Label Hours', 'skt-addons-for-elementor'),
				'description' => esc_html__('Set the label for hours.', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __('Hours', 'skt-addons-for-elementor'),
				'default' => 'Hours',
				'condition' => [
		...
		$this->add_control(
			'show_label_minutes',
			[
				'label' => esc_html__('Show Label Minutes?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
                'style_transfer' => true,
		...
		$this->add_control(
			'label_minutes',
			[
				'label' => esc_html__('Label Minutes', 'skt-addons-for-elementor'),
				'description' => esc_html__('Set the label for minutes.', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __('Minutes', 'skt-addons-for-elementor'),
				'default' => 'Minutes',
				'condition' => [
		...
		$this->add_control(
			'show_label_seconds',
			[
				'label' => esc_html__('Show Label Seconds?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
                'style_transfer' => true,
		...
		$this->add_control(
			'label_seconds',
			[
				'label' => esc_html__('Label Seconds', 'skt-addons-for-elementor'),
				'description' => esc_html__('Set the label for seconds.', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __('Seconds', 'skt-addons-for-elementor'),
				'default' => 'Seconds',
				'condition' => [
		...
		$this->add_control(
			'show_separator',
			[
				'label' => esc_html__('Show Separator?', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'on',
				'default' => '',
				'separator' => 'before',
		...
		$this->add_control(
			'separator_color',
			[
				'label' => __('Separator Color', 'skt-addons-for-elementor'),
		...
		$this->add_responsive_control(
			'separator_font',
			[
				'label' => __('Separator Font Size', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
		...
		$this->add_control(
			'separator_position',
			[
				'label' => __('Separator Position', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'condition' => [
					'show_separator' => 'on',
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Position Top', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Position Right', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
	...
	protected function __end_action_content_controls() {
		...
		$this->start_controls_section(
			'_section_end_action',
			[
				'label' => __('End Action', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'end_action_type',
			[
				'label' => esc_html__('End Action Type', 'skt-addons-for-elementor'),
				'label_block' => false,
				'type' => Controls_Manager::SELECT,
				'description' => esc_html__('Choose which action you want to at the end of countdown.', 'skt-addons-for-elementor'),
				'options' => [
					'none' => esc_html__('None', 'skt-addons-for-elementor'),
					'message' => esc_html__('Message', 'skt-addons-for-elementor'),
					'url' => esc_html__('Redirection Link', 'skt-addons-for-elementor'),
					'img' => esc_html__('Image', 'skt-addons-for-elementor'),
				],
				'default' => 'none'
			]
		);
		$this->add_control(
			'end_message',
			[
				'label' => __('Countdown End Message', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::WYSIWYG,
				'default' => __('Countdown End!', 'skt-addons-for-elementor'),
				'placeholder' => __('Type your message here', 'skt-addons-for-elementor'),
				'condition' => [
		...
		$this->add_control(
			'end_redirect_link',
			[
				'label' => __('Redirection Link', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
	...
	protected function __common_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Countdown Common Style', 'skt-addons-for-elementor'),
		...
		$this->add_responsive_control(
			'box_height',
			[
				'label' => __('Box Height', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Label Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Label Typography', 'skt-addons-for-elementor'),
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_TEXT,
			],
				'default' => [
		...
		$this->add_responsive_control(
			'common_box_spacing',
			[
				'label' => __('Spacing Between Box', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'selectors' => [
	...
	protected function __days_style_controls() {
		...
		$this->start_controls_section(
			'_section_days_style',
			[
				'label' => __('Days Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
	...
	protected function __hours_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Hours Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __minutes_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Minutes Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
	...
	protected function __seconds_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Seconds Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
					...
					<?php if ('none' != $settings['end_action_type'] && !empty($settings['end_action_type'])): ?>
						<div class="skt-countdown-end-action">
							<?php if ('message' == $settings['end_action_type'] && $settings['end_message']) :
								echo '<div class="skt-countdown-end-message">' . esc_attr(wpautop(wp_kses_post($settings['end_message']))) . '</div>';
							endif; ?>
