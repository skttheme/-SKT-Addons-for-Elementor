...
class Number extends Base {
	...
	public function get_title() {
		return __( 'Number', 'skt-addons-for-elementor' );
	}
	...
	protected function __number_bg_style_controls() {
        ...
        $this->add_control(
                '_heading_bg_overlay',
                [
                    'label' => __( 'Background Overaly', 'skt-addons-for-elementor' ),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Blend Mood', 'skt-addons-for-elementor' ),
	...
	protected function __text_style_controls() {
        ...
        $this->add_control(
            'number_text_rotate',
            [
                'label' => __( 'Text Rotate', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
