...
class Feature_List extends Base {
    ...
    public function get_title() {
        return __( 'Feature List', 'skt-addons-for-elementor' );
    }
    ...
    protected function __lists_content_controls() {
        ...
        $this->start_controls_section(
            '_section_lists',
            [
                'label' => __( 'Feature List', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'text_heading',
            [
                'label' => __( 'Text & Link', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'List Item', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ...
                    [
                        'title' => __( 'SKT Elementor Addons', 'skt-addons-for-elementor' ),
						'icon' => [
							'value' => 'fas fa-check',
							'library' => 'regular',
						],
    ...
    protected function __settings_content_controls() {
        ...
        $this->add_responsive_control(
            'icon_position',
            [
                'label' => __( 'Bullet Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'row' => [
    ...
    protected function __common_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Separator Height', 'skt-addons-for-elementor' ),
