...
class Testimonial_Carousel extends Base {
    ...
    public function get_title() {
        return __( 'Testimonial Carousel', 'skt-addons-for-elementor' );
    }
	...
	protected function __testimonial_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Testimonial Carousel', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'SKT', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type Reviewer Name', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'CMO, SKT Addons', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type reviewer title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $repeater->add_control(
            'testimonial_content',
            [
                'label' => __( 'Testimonial', 'skt-addons-for-elementor' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXTAREA,
                'default' => __( 'Testimonial contents', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type testimonial', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'name' => __( 'SKT', 'skt-addons-for-elementor' ),
                        'title' => __( 'CEO SKT Addons', 'skt-addons-for-elementor' ),
                        'testimonial_content' => __( 'Testimonial Content', 'skt-addons-for-elementor' ),
                    ],
                    [
                        'image' => [
                            'url' => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            '_design',
            [
                'label' => __( 'Design', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => false,
                'separator' => 'before',
                'options' => [
                    'basic' => __( 'Default', 'skt-addons-for-elementor' ),
                    'bubble' => __( 'Bubble', 'skt-addons-for-elementor' ),
                ],
                'default' => 'bubble',
		...
		$this->add_control(
			'equal_height',
			[
				'label' => __( 'Equal Height', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'position',
            [
                'label' => __( 'Testimonial Position', 'skt-addons-for-elementor' ),
    ...
    protected function __reviewer_style_controls() {
		...
		$this->start_controls_section(
            ...
            [
                'label' => __( 'Reviewer', 'skt-addons-for-elementor' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
		);
