...
class Hotspots extends Base {
    ...
    public function get_title() {
        return __( 'Hotspots', 'skt-addons-for-elementor' );
    }
    ...
    protected function __image_content_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'thumbnail',
                'label' => __( 'Image Size', 'skt-addons-for-elementor' ),
                'default' => 'large',
            ]
        );
    ...
    protected function __spots_content_controls() {
        ...
        $this->start_controls_section(
            '_section_spots',
            [
                'label' => __( 'Spots', 'skt-addons-for-elementor' ),
        ...
        $repeater->start_controls_tab(
            '_tab_spot',
            [
                'label' => __( 'Spot', 'skt-addons-for-elementor' )
            ]
        );
        ...
        $repeater->add_responsive_control(
            'x_pos',
            [
                'label' => __( 'X Position', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_responsive_control(
            'y_pos',
            [
                'label' => __( 'Y Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%'],
                'desktop_default' => [
                    'size' => 45,
        ...
        $repeater->add_control(
            'css_id',
            [
                'label' => __( 'CSS ID', 'skt-addons-for-elementor' ),
                'title' => __( 'Add your custom id. e.g: my-custom-id', 'skt-addons-for-elementor' ),
                'separator' => 'before',
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true
        ...
        $repeater->add_control(
            'css_classes',
            [
                'label' => __( 'CSS Classes', 'skt-addons-for-elementor' ),
                'title' => __( 'Add your custom class WITHOUT the dot. e.g: my-custom-class', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'prefix_class' => '',
                'dynamic' => [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Hotspot tooltip content goes here', 'skt-addons-for-elementor' ),
            ]
        );
    ...
    protected function __options_content_controls() {
        ...
        $this->add_control(
            'tooltip_speed',
            [
                'label' => __( 'Speed', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 100,
                'step' => 10,
                'max' => 10000,
                'title' => __( 'Speed in milliseconds (default 400)', 'skt-addons-for-elementor' ),
                'frontend_available' => true,
                'placeholder' => 400,
                'render_type' => 'ui'
            ]
        ...
        $this->add_control(
            'tooltip_delay',
            [
                'label' => __( 'Delay', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 100,
                'step' => 10,
                'max' => 10000,
                'title' => __( 'Delay in milliseconds (default 200)', 'skt-addons-for-elementor' ),
                'frontend_available' => true,
                'placeholder' => 200,
                'render_type' => 'ui'
            ]
        ...
        $this->add_control(
            'tooltip_hide_delay',
            [
                'label' => __( 'Hide Delay', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'step' => 10,
                'max' => 100000,
                'title' => __( 'Hide delay in milliseconds (default 0)', 'skt-addons-for-elementor' ),
                'frontend_available' => true,
                'placeholder' => 0,
                'render_type' => 'ui'
            ]
        ...
        $this->add_control(
            'tooltip_hide_arrow',
            [
                'label' => __( 'Hide Arrow', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __( 'Make sure to enable this option when you have a link in tooltip content.', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
                'label_off' => __( 'No', 'skt-addons-for-elementor' ),
                'return_value' => 'yes',
    ...
    protected function __spots_style_controls() {
        ...
        $this->add_responsive_control(
            'spot_font_size',
            [
                'label' => __( 'Font / Icon Size', 'skt-addons-for-elementor' ),
                'description' => __( 'Applicable for icon and text spot type', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        <div class="skt-hotspots__inner">
            ...
            if ( ! empty( $settings['spots'] ) ) :
                foreach ( $settings['spots'] as $index => $spot ) :
                    ...
                    <a <?php echo esc_attr($this->print_render_attribute_string( 'spot-' . $index )); ?>>
