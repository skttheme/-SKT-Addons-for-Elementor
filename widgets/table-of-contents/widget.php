...
class Table_Of_Contents extends Base {
	...
	public function get_title() {
		return __( 'Table of Contents', 'skt-addons-for-elementor' );
	}
	...
	protected function __content_controls() {
		...
		$this->start_controls_section(
			'_section_content',
			[
				'label' => __( 'Table of Contents', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default'            => __( 'Table of Contents', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'html_tag',
			[
				'label'              => esc_html__( 'HTML Tag', 'skt-addons-for-elementor' ),
		...
		$this->start_controls_tab(
			'include',
			[
				'label' => esc_html__( 'Include', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'headings_by_tags',
			[
				'label'              => esc_html__( 'Anchors By Tags', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'container',
			[
				'label'              => esc_html__( 'Container', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::TEXT,
				'label_block'        => true,
				'description'        => __( 'With this control you can use only a specific container’s heading element with Table of Content </br> Example: .toc, .toc-extra', 'skt-addons-for-elementor' ),
				'frontend_available' => true,
			]
		);
		...
		$this->start_controls_tab(
			'exclude',
			[
				'label' => esc_html__( 'Exclude', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Anchors By Selector', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::TEXT,
				'description'        => esc_html__( 'CSS selectors, in a comma-separated list', 'skt-addons-for-elementor' ),
				'default'            => [],
				'label_block'        => true,
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'custom_style',
			[
				'label'              => esc_html__( 'Custom Style', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'custom_style_list',
			[
				'label'              => esc_html__( 'Select Style', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'skt-toc-slide-style',
				'options'            => [
					'skt-toc-slide-style'    => __( 'Slide', 'skt-addons-for-elementor' ),
					'skt-toc-timeline-style' => __( 'Timeline', 'skt-addons-for-elementor' ),
					'skt-toc-list-style'     => __( 'List', 'skt-addons-for-elementor' ),
				],
				'condition'          => [
					'custom_style' => 'yes',
				],
		...
		$this->add_control(
			'marker_view',
			[
				'label'              => esc_html__( 'Marker View', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'numbers',
				'options'            => [
					'numbers' => esc_html__( 'Numbers', 'skt-addons-for-elementor' ),
					'bullets' => esc_html__( 'Bullets', 'skt-addons-for-elementor' ),
				],
				'frontend_available' => true,
				'condition'          => [
					'custom_style' => '',
		...
		$this->add_control(
			'hierarchical_view',
			[
				'label'              => esc_html__( 'Hierarchical View', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => '',
				'condition'          => [
					'custom_style' => '',
		...
		$this->add_control(
			'collapse_subitems',
			[
				'label'              => __( 'Collapse Subitems', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SWITCHER,
				'description'        => __( 'The "Collapse" option will not work unless you make the Table of Contents sticky.', 'skt-addons-for-elementor' ),
				'condition'          => [
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'word_wrap',
			[
				'label'              => __( 'Word Wrap', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SWITCHER,
				'frontend_available' => true,
		...
		$this->add_control(
			'minimize_box',
			[
				'label'              => __( 'Minimize Box', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SWITCHER,
				'return_value'       => 'yes',
				'default'            => 'yes',
				'frontend_available' => true,
		...
		$this->add_control(
			'expand_icon',
			[
				'label'       => esc_html__( 'Expand Icon', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::ICONS,
				'default'     => [
		...
		$this->add_control(
			'collapse_icon',
			[
				'label'       => esc_html__( 'Collapse Icon', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::ICONS,
				'default'     => [
		...
		foreach ( $breakpoints as $breakpoint_key => $breakpoint ) {
			...
			$minimized_on_options[ $breakpoint_key ] = sprintf(
				...
				esc_html__( '%1$s (%2$s %3$dpx)', 'skt-addons-for-elementor' ),
		...
		$minimized_on_options['desktop'] = esc_html__( 'Desktop (or smaller)', 'skt-addons-for-elementor' );

		$this->add_control(
			'minimized_on',
			[
				'label'              => esc_html__( 'Minimized On', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'tablet',
		...
		$this->add_responsive_control(
			'scroll_offset',
			[
				'label'              => __( 'Scroll Offset', 'skt-addons-for-elementor' ),
				'description'        => __( 'Minimum Value 0 is required for it to function.', 'skt-addons-for-elementor' ),
	...
	protected function toc_sticky_controls() {
		$this->start_controls_section(
			'_section_toc_sticky',
			[
				'label' => __( 'Sticky', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Sticky On', 'skt-addons-for-elementor' ),
				'label_block'        => true,
				'type'               => Controls_Manager::SELECT2,
				'multiple'           => true,
				'options'            => [
					'desktop' => esc_html__( 'Desktop', 'skt-addons-for-elementor' ),
					'tablet'  => esc_html__( 'Table', 'skt-addons-for-elementor' ),
					'mobile'  => esc_html__( 'Mobile', 'skt-addons-for-elementor' ),
				],
		...
		$this->add_control(
			'sticky_toc_type',
			[
				'label'              => __( 'Sticky Type', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'in-place',
				'options'            => [
					'in-place'        => __( 'Sticky In Place', 'skt-addons-for-elementor' ),
					'custom-position' => __( 'Custom Position', 'skt-addons-for-elementor' ),
				],
				'prefix_class'       => 'sticky-',
				'frontend_available' => true,
				'render_type'        => 'template',
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Bottom', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Right', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	protected function toc_box_style_controls() {
		...
		$this->add_control(
			'loader_color',
			[
				'label'     => esc_html__( 'Loader Color', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'border_width',
			[
				'label'     => esc_html__( 'Border Width', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_responsive_control(
			'min_height',
			[
				'label'              => esc_html__( 'Min Height', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SLIDER,
				'size_units'         => [ 'px', 'vh' ],
				'range'              => [
					'px' => [
	...
	protected function toc_box_style_header_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Separator Width', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'header_sepa_color',
			[
				'label'     => esc_html__( 'Separator Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function toc_box_style_list_item() {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'List Item', 'skt-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'custom_style!' => 'yes',
				],
		...
		$this->add_responsive_control(
			'max_height',
			[
				'label'      => esc_html__( 'Max Height', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'vh' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'list_indent',
			[
				'label'      => esc_html__( 'Indent', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'default'    => [
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Underline', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			'heading_marker',
			[
				'label'     => esc_html__( 'Marker', 'skt-addons-for-elementor' ),
	...
	protected function toc_slide_item() {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slide', 'skt-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'custom_style'      => 'yes',
		...
		$this->add_control(
			'toc_slide_title',
			[
				'label' => __( 'Heading', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Title Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Bar Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Space Bottom', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_control(
			'toc_slide_item',
			[
				'label'     => __( 'List Item', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'List Space Bottom', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'selectors'  => [
	...
	protected function toc_timeline_item() {
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Timeline', 'skt-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'custom_style'      => 'yes',
		...
		$this->add_control(
			'tml_toc_title_color',
			[
				'label'     => __( 'Title Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'toc_tml_dots',
			[
				'label'     => __( 'Dots', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'toc_tml_tree_color',
			[
				'label'     => esc_html__( 'Tree Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		if ( skt_addons_elementor()->editor->is_edit_mode() && 'yes' === $settings['sticky_toc_toggle'] && 'custom-position' === $settings['sticky_toc_type'] ) :
			...
			<div class="skt-toc-editor-placeholder">
				<div class="skt-toc-editor-placeholder-content">
					<?php esc_html_e( 'This is a placeholder text which won\'t be displayed in the preview panel or front end.', 'skt-addons-for-elementor' ); ?>
				</div>
			</div>
			<?php
		endif;
