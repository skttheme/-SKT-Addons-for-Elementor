...
class EDD_Download extends Base {
	...
	public function get_title() {
		return __( 'EDD Download', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __( '<strong>Note:</strong> EDD Download widget doesn\'t have any useful content control.', 'skt-addons-for-elementor' ),
	...
	protected function __edd_download_table_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Download Table', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Download Items', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Update Download Row', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::HEADING,
				'separator'				=> 'before',
			]
		);
	...
	protected function render() {
		...
		if( skt_addons_elementor()->editor->is_edit_mode() ){
			...
			echo skt_addons_elementor_do_shortcode( 'download_history' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		}
	...
	<table id="edd_user_history" class="edd-table">
		<thead>
			<tr class="edd_download_history_row">
				...
				<th class="edd_download_download_name"><?php esc_attr_e( 'Download Name', 'skt-addons-for-elementor' ); ?></th>
				<?php if ( ! edd_no_redownload() ) : ?>
					<th class="edd_download_download_files"><?php esc_attr_e( 'Files', 'skt-addons-for-elementor' ); ?></th>
