...
class PDF_View extends Base {
    ...
    public function get_title() {
        return __('PDF View', 'skt-addons-for-elementor');
    }
    ...
    protected function __pdf_content_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __('PDF Source', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'file_type',
			[
				'label' => __('File Source', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' =>[
					'url' => __('URL', 'skt-addons-for-elementor'),
					'upload_file' => __('Upload File', 'skt-addons-for-elementor'),
				],
                'default' => 'url'
			]
		);
		...
		$this->add_control(
			'pdf_url',
			[
				'label' => __('PDF URL', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'http://www.example.com/sample.pdf', 'skt-addons-for-elementor'),
                'default' => [
                    'url' =>  'https://sktthemesdemo.net/documentation/skt-addons-for-elementor-documentation/sample.pdf'
                ],
				'show_external' => false,
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			'pdf_file',
			[
				'label' => __( 'Choose PDF',  'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'page_number',
			[
				'label' => __( 'Page Number', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
			'pdf_title',
			[
				'label' => __( 'PDF Title', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __( 'PDF Title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type PDF title', 'skt-addons-for-elementor' ),
				'separator' => 'before',
				'dynamic' => [
					'active' => true,
				]
	...
	protected function __pdf_settings_controls(){
		...
		$this->add_control(
			'enable_download',
			[
				'label'        => __( 'Show Download?', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
			'enable_icon',
			[
				'label'        => __( 'Show Icon?', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
    ...
    protected function __title_desc_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Title Bar', 'skt-addons-for-elementor' ),
				'separator' => 'before'
			]
		);
                ...
                <?php
                    if('yes' == $settings['enable_download']){
                        printf( '<a href="%1$s" class="skt-btn" download title="%2$s">%3$s</a>',
                            esc_url($pdf_url_i),
                            esc_html( $settings['pdf_title'] ),
                            esc_attr__('Download', 'skt-addons-for-elementor')
                        );
                    }
                ?>
                </div>
