...
class Social_Share extends Base {
	...
	public function get_title () {
		return __( 'Social Share', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls () {
		...
		$repeater->add_control(
			'share_network',
			[
				'label'   => __( 'Network', 'skt-addons-for-elementor' ),
				...
				'options' => [
					...
					'telegram'    => __( 'Telegram', 'skt-addons-for-elementor' ),
					'viber'       => __( 'Viber', 'skt-addons-for-elementor' ),
					...
					'get-pocket'  => __( 'Get Pocket', 'skt-addons-for-elementor' ),
					'digg'        => __( 'Digg', 'skt-addons-for-elementor' ),
					'stumbleupon' => __( 'StumbleUpon', 'skt-addons-for-elementor' ),
					'weibo'       => __( 'Weibo', 'skt-addons-for-elementor' ),
					'renren'      => __( 'Renren', 'skt-addons-for-elementor' ),
					'skype'       => __( 'Skype', 'skt-addons-for-elementor' ),
				],
				'default' => 'facebook',
			]
		);
		...
		$repeater->add_control(
			'custom_link',
			[
				'label'       => __( 'Custom Link', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'https://your-share-link.com', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'hashtags',
			[
				'label'       => __( 'Hashtags', 'skt-addons-for-elementor' ),
				'description' => __( 'Write hashtags without # sign and with comma separated value', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'share_title',
			[
				'label'     => __( 'Custom Title', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXTAREA,
				'rows'      => 2,
				'dynamic'   => [
					'active' => true,
		...
		$repeater->add_control(
			'email_to',
			[
				'label'     => __( 'To', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'email_subject',
			[
				'label'     => __( 'Subject', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXT,
				'label_block' => true,
				'condition' => [
					'share_network' => 'email',
		...
		$repeater->add_control(
			'twitter_handle',
			[
				'label'     => __( 'Twitter Handle', 'skt-addons-for-elementor' ),
				'description' => __( 'Write without @ sign.', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXT,
				'condition' => [
		...
		$repeater->add_control(
			...
			[
				...
				'label' => __( 'Custom Image', 'skt-addons-for-elementor' ),
				'default' => [
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'placeholder' => __( 'Share on Facebook', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			'icon_list',
			[
				'label'       => __( 'Share Icons', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'network_view',
			[
				'label'     => __( 'View', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => 'icon_and_text',
				'options'   => [
					'icon_and_text' => __( 'Icon and Text', 'skt-addons-for-elementor' ),
					'icon_only'     => __( 'Icon', 'skt-addons-for-elementor' ),
					'text_only'     => __( 'Text', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			'display',
			[
				'label'       => __( 'Display', 'skt-addons-for-elementor' ),
	...
	protected function register_style_controls () {
		...
		$this->add_responsive_control(
			'icon_spacing',
			[
				'label'          => __( 'Icon Right Spacing', 'skt-addons-for-elementor' ),
				'type'           => Controls_Manager::SLIDER,
				'selectors'      => [
		...
		$this->add_responsive_control(
			'separator_spacing',
			[
				'label'          => __( 'Separator Right Spacing', 'skt-addons-for-elementor' ),
				'type'           => Controls_Manager::SLIDER,
				'selectors'      => [
					...
					<a <?php $this->print_render_attribute_string( 'link_classes' ); ?>>
						...
						if ( 'icon_and_text' == $network_view ) {
							...
							if ( ! empty( $share_on_text ) && '' != $share_on_text ) {
								printf( "<span class='skt-share-label'>%s</span>", esc_attr($share_on_text ));
							}
						}
