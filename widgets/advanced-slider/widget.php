...
class Advanced_Slider extends Base {
    ...
    public function get_title() {
        return __('Advanced Slider', 'skt-addons-for-elementor');
    }
    ...
    protected function __slides_content_controls() {
        ...
        $this->start_controls_section(
            '_section_slides',
            [
                'label' => __('Slides', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'slider_type',
            [
                'label' => __('Slider Type', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'single',
                'options' => [
                    'single'  => __('Single', 'skt-addons-for-elementor'),
                    'multiple' => __('Multiple', 'skt-addons-for-elementor'),
                ],
        ...
        $this->add_responsive_control(
            'slides_per_view',
            [
                'label' => __('Slides Per View', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'slider_direction',
            [
                'label' => __('Slider Direction', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
                    'horizontal'  => __('Horizontal', 'skt-addons-for-elementor'),
                    'vertical' => __('Vertical', 'skt-addons-for-elementor'),
                ],
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'effect',
            [
                'label' => __('Slider Effect', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'false',
                'options' => [
                    'false'  => __('Slide', 'skt-addons-for-elementor'),
                    'fade' => __('Fade', 'skt-addons-for-elementor'),
                    'cube' => __('Cube', 'skt-addons-for-elementor'),
                    'flip' => __('Flip', 'skt-addons-for-elementor'),
                ],
                'condition' => [
                    'slider_type' => 'single'
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'false'  => __('Slide', 'skt-addons-for-elementor'),
                    'coverflow' => __('Cover Flow', 'skt-addons-for-elementor'),
                ],
                'condition' => [
                    'slider_type' => 'multiple'
                ],
        ...
        $this->add_control(
            'effect_speed',
            [
                'label' => __('Effect Speed (ms)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::NUMBER,
                'default' => 500,
                'frontend_available' => true,
                'dynamic' => [
        ...
        $slides->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'template' => __('Template', 'skt-addons-for-elementor'),
                ],
            ]
        );
        ...
        $slides->add_control(
            'slide_content_icon',
            [
                'label' => __('Icon Type', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'icon' => [
                        'title' => __('Icon', 'skt-addons-for-elementor'),
                        'icon' => 'eicon-nerd',
                    ],
                    'image' => [
                        'title' => __('Image', 'skt-addons-for-elementor'),
                        'icon' => 'eicon-image',
                    ],
                ],
                'condition' => [
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Sub Title', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __('Type your sub title here', 'skt-addons-for-elementor'),
                'condition' => [
                    'content_type' => 'default'
                ],
                'dynamic' => [
        ...
        $slides->add_control(
            ...
            [
                ...
                'placeholder' => __('Type your description here', 'skt-addons-for-elementor'),
                'condition' => [
                    'content_type' => 'default'
                ],
                'dynamic' => [
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Button 1 Text', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'condition' => [
                    'content_type' => 'default'
                ],
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Button 1 Link', 'skt-addons-for-elementor'),
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Button 2 Text', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::TEXT,
                'condition' => [
                    'content_type' => 'default'
                ],
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Button 2 Link', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::URL,
                'placeholder' => __('https://your-link.com', 'skt-addons-for-elementor'),
                'show_external' => true,
                'default' => [
        ...
        $slides->add_control(
            ...
            [
                ...
                'return_value' => 'yes',
                'description' => __('Set custom style that will only affect this specific slide.', 'skt-addons-for-elementor'),
                'default' => 'no',
            ]
        );
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Horizontal Align', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Vertical Align', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Text Align', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'skt-addons-for-elementor'),
        ...
        $slides->add_control(
            'slide_content_color',
            [
                'label' => __('Content Color', 'skt-addons-for-elementor'),
        ...
        $slides->add_control(
            ...
            [
                'label' => __('Icon Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $slides->add_responsive_control(
            ...
            [
                'label' => __('Icon/ Image Size', 'skt-addons-for-elementor'),
        ...
        $slides->add_group_control(
            ...
            [
                ...
                'label' => __('Text Shadow', 'skt-addons-for-elementor'),
        ...
        $slides->add_control(
			...
			[
				'label' => __( 'Bordar radius', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'content_type' => 'default',
                        'slide_content_title' => __('Advanced Slider 1 Title', 'skt-addons-for-elementor'),
                        'slide_content_sub_title' => __('Sub Title', 'skt-addons-for-elementor'),
                        'slide_content_description' => __('Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 'skt-addons-for-elementor'),
                        'slider_background_background' => 'classic',
                        'slider_background_color' => '#1F2363',
                        'slide_content_button_1_text' => esc_html__('Button 1', 'skt-addons-for-elementor'),
                        'slide_content_button_1_link' => ['url' => ''],
                        'slide_content_button_2_text' => esc_html__('Button 2', 'skt-addons-for-elementor'),
                        'slide_content_button_2_link' => ['url' => ''],
                    ],
                    [
                        'content_type' => 'default',
                        'slide_content_title' => __('Advanced Slider 2 Title', 'skt-addons-for-elementor'),
                        'slide_content_sub_title' => __('Sub Title', 'skt-addons-for-elementor'),
                        'slide_content_description' => __('Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 'skt-addons-for-elementor'),
                        'slider_background_background' => 'classic',
                    ...
                    [
                        'content_type' => 'default',
                        'slide_content_title' => __('Advanced Slider 3 Title', 'skt-addons-for-elementor'),
                        'slide_content_sub_title' => __('Sub Title', 'skt-addons-for-elementor'),
                        'slide_content_description' => __('Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 'skt-addons-for-elementor'),
                        'slider_background_background' => 'classic',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Space Between Slides', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 500,
                'step' => 1,
                'default' => 0,
                'frontend_available' => true,
                'description' => esc_html__('Slides space in pixel(px)', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
    ...
    protected function __settings_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Slider Settings', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Content Animation', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'skt_addons_elementor_fadeInUp',
                'options' => [
                    'none'  => __('None', 'skt-addons-for-elementor'),
                    'skt_addons_elementor_fadeInUp'  => __('FadeInUp', 'skt-addons-for-elementor'),
                    'skt_addons_elementor_fadeInDown' => __('FadeInDown', 'skt-addons-for-elementor'),
                    'skt_addons_elementor_fadeInLeft' => __('FadeInLeft', 'skt-addons-for-elementor'),
                    'skt_addons_elementor_fadeInRight' => __('FadeInRight', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Animation Speed (ms)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['ms'],
                'range' => [
                    'ms' => [
                ...
                'description' => __('Slide speed in miliseconds', 'skt-addons-for-elementor'),
                'condition' => [
                    'slider_type!' => 'multiple',
        ...
        $this->add_control(
            'arrow_navigation',
            [
                'label' => __('Arrow Navigation?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Previous Icon', 'skt-addons-for-elementor'),
                'label_block' => false,
                'type' => Controls_Manager::ICONS,
                'skin' => 'inline',
                'default' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Next Icon', 'skt-addons-for-elementor'),
                'label_block' => false,
                'type' => Controls_Manager::ICONS,
                'skin' => 'inline',
                'default' => [
        ...
        $this->add_control(
            'pagination_type',
            [
                'label' => __('Pagination Type', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none'  => __('None', 'skt-addons-for-elementor'),
                    'dots'  => __('Dots', 'skt-addons-for-elementor'),
                    'numbers' => __('Numbers', 'skt-addons-for-elementor'),
                    'progressbar' => __('Progressbar', 'skt-addons-for-elementor'),
                ],
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Number Type', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'bullets',
                'options' => [
                    'bullets'  => __('Bullets', 'skt-addons-for-elementor'),
                    'fraction' => __('Fraction', 'skt-addons-for-elementor'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'scroll_bar',
            [
                'label' => __('Scroll Bar?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'false',
                'options' => [
                    'false'  => __('Always show', 'skt-addons-for-elementor'),
                    'true' => __('Automatic hide', 'skt-addons-for-elementor'),
                ],
                'condition' => [
                    'scroll_bar' => 'yes',
                ],
        ...
        $this->add_control(
            'thumbs_navigation',
            [
                'label' => __('Thumbnail Navigation?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Space Between Thumbs', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 500,
                'step' => 1,
                ...
                'frontend_available' => true,
                'description' => esc_html__('Thumbs space in pixel(px)', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            'infinity_loop',
            [
                'label' => __('Infinity Loop?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => true,
        ...
        $this->add_control(
            'autoplay',
            [
                'label' => __('Autoplay?', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'skt-addons-for-elementor'),
                'label_off' => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => __('Autoplay Speed', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::NUMBER,
                'min' => 5,
                'max' => 10000,
                'step' => 5,
                'default' => 5000,
                'description' => __('Autoplay speed in milliseconds', 'skt-addons-for-elementor'),
                'condition' => [
                    'autoplay' => 'yes',
                ],
                'frontend_available' => true,
    ...
    protected function __slider_content_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Slider Content', 'skt-addons-for-elementor'),
    ...
    protected function __icon_image_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Icon/ Image', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_size',
            [
                'label' => __('Size (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'icon_padding',
            [
                'label' => __('Padding (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label' => __('Bottom Spacing (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function __button_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Button Between Space (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Button 1', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Button 2', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after',
            ]
        );
    ...
    protected function __arrow_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Navigation - Arrow', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'arrow_navigation' => 'yes',
                ]
        ...
        $this->add_control(
            'arrow_sync_position',
            [
                'label' => __('Sync Position', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'yes' => [
                        'title' => __('Yes', 'skt-addons-for-elementor'),
                        'icon' => 'eicon-sync',
                    ],
                    'no' => [
                        'title' => __('No', 'skt-addons-for-elementor'),
        ...
        $this->add_responsive_control(
            'arrow_position_y',
            [
                'label' => __('Vertical (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'condition' => [
                    'arrow_position_toggle' => 'yes'
        ...
        $this->add_responsive_control(
            'arrow_position_x',
            [
                'label' => __('Horizontal (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'condition' => [
                    'arrow_position_toggle' => 'yes'
        ...
        $this->add_responsive_control(
            'arrow_spacing',
            [
                'label' => __('Space Between Arrows (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'condition' => [
                    'arrow_position_toggle' => 'yes',
        ...
        $this->add_responsive_control(
            'arrow_icon_size',
            [
                'label' => __('Icon Size (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function __dots_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Pagination - Dots', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'dots_nav_position_y',
            [
                'label' => __('Vertical Position (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'dots_nav_spacing',
            [
                'label' => __('Spacing (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        $this->start_controls_tab(
            '_tab_dots_active',
            [
                'label' => __('Active', 'skt-addons-for-elementor'),
            ]
        );
    ...
    protected function __pagination_number_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Pagination - Number', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'pagination_type' => 'numbers',
                ],
    ...
    protected function __pagination_progressbar_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Pagination - Progressbar', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'progressbar_height',
            [
                'label' => __('Height (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'progressbar_width',
            [
                'label' => __('Width (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function __nav_thumbnails_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Navigation - Thumbnails', 'skt-addons-for-elementor'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'thumbs_navigation' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'thumbs_top_spacing',
            [
                'label' => __('Top Spacing (px)', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Active Border Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    ...
                    ?>
                            <div class="swiper-slide skt-slider-slide elementor-repeater-item-<?php echo esc_attr($slide['_id']); ?>">
                                <?php if ($slide['content_type'] == 'template') :
                                    echo skt_addons_elementor()->frontend->get_builder_content_for_display($slide['slide_content_template']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
