...
class Edd_Product_Grid extends Base {
	...
	public function get_title() {
		return __( 'EDD Product Grid', 'skt-addons-for-elementor' );
	}
	...
	protected function register_layout_controls_section() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'label'       => __( 'Badge label', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Sale!', 'skt-addons-for-elementor' ),
				'default'     => 'Sale!',
				'condition'   => [
					'show_badge' => 'yes',
				],
		...
		//         'placeholder' => __( 'Add to Cart', 'skt-addons-for-elementor' ),
		//         'default'     => 'Add to Cart',
		//         'condition'   => [
		...
		$this->add_control(
			...
			[
				'type'           => Controls_Manager::SWITCHER,
				'label'          => __( 'Show Sale Count', 'skt-addons-for-elementor' ),
				'default'        => '',
				'return_value'   => 'yes',
				'style_transfer' => true,
			]
	...
	protected function register_advance_controls_section() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Advanced', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'label'       => __( 'Quick View Text', 'skt-addons-for-elementor' ),
				'default'     => __( 'Quick View', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Your quick view text', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
				'condition'   => [
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'More products', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
				'condition'   => [
	...
	protected function register_layout_style_controls_section() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Grid', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Product', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function register_content_style_controls_section() {
		...
		$this->add_control(
			'title_color_hover',
			[
				'label'     => __( 'Text Color Hover', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function register_cart_button_style_controls_section() {
		...
		$this->add_responsive_control(
			'btn_offset_x',
			[
				'label'      => __( 'Position X', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'condition'  => [
		...
		$this->add_responsive_control(
			'btn_offset_y',
			[
				'label'      => __( 'Position Y', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'condition'  => [
					'btn_offset_toggle' => 'yes',
	...
	protected function print_quick_view_button( $product_id ) {
		...
		printf(
			...
			$quick_view_text_icons // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		);
	}
			...
			?>
				...
				<?php if ( $settings[ 'show_cat' ] === 'yes' ) : ?>
					<div class="skt-edd-product-grid__category">
						<?php echo skt_addons_elementor_pro_the_first_taxonomy( $post->ID, 'download_category', ['class'=>'skt-edd-product-grid__category_inner'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?>
					</div>
				<?php endif; ?>
						...
						<div class="skt-edd-product-grid__btns">
							...
							if ( $settings['show_cart_button'] === 'yes' ) :
								if ( edd_has_variable_prices( $post->ID ) ) {
									...
									echo edd_get_purchase_link( [ 'download_id' => $post->ID, 'text' => $settings['cart_btn_label'] ] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
