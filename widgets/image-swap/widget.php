...
class Image_Swap extends Base {
	...
	public function get_title() {
		return __('Image Swap', 'skt-addons-for-elementor');
	}
	...
	protected function content_controls() {
		...
		$this->add_control(
			'select_effect_type',
			[
				'label'   => __('Select Effect type', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __('First Image', 'skt-addons-for-elementor'),
				'default' => [
		...
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::MEDIA,
				'label'   => __('Second Image', 'skt-addons-for-elementor'),
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'hover' => [
						'title' => __('Hover', 'skt-addons-for-elementor'),
						'icon'  => 'skti skti-cursor-hover-click',
					],
					'click' => [
						'title' => __('Click', 'skt-addons-for-elementor'),
						'icon'  => 'eicon-click',
					],
				],
				'default' => 'hover',
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::SELECT,
				'label'     => __('Effect', 'skt-addons-for-elementor'),
				'options'   => [
					'fade'        => __('Fade', 'skt-addons-for-elementor'),
					'move_left'   => __('Move Left', 'skt-addons-for-elementor'),
					'move_top'    => __('Move Top', 'skt-addons-for-elementor'),
					'move_right'  => __('Move Right', 'skt-addons-for-elementor'),
					'move_bottom' => __('Move Bottom', 'skt-addons-for-elementor'),
					'zoom_in'     => __('Zoom In', 'skt-addons-for-elementor'),
					'zoom_out'    => __('Zoom Out', 'skt-addons-for-elementor'),
					'card_left'   => __('Card Left', 'skt-addons-for-elementor'),
					'card_top'    => __('Card Top', 'skt-addons-for-elementor'),
					'card_right'  => __('Card Right', 'skt-addons-for-elementor'),
					'card_bottom' => __('Card Bottom', 'skt-addons-for-elementor'),
				],
				'default'   => 'fade',
				'condition' => [
					'select_effect_type' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'label'     => __('Effect', 'skt-addons-for-elementor'),
				'options'   => [
					'top'  => __('Slide Top', 'skt-addons-for-elementor'),
					'bottom'  => __('Slide Bottom', 'skt-addons-for-elementor'),
					'right' => __('Slide Right', 'skt-addons-for-elementor'),
					'left'  => __('Slide Left', 'skt-addons-for-elementor'),
				],
				'default'   => 'right',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'label'       => __('Transition Speed', 'skt-addons-for-elementor'),
				'description' => __('Note: Here animation speed is in seconds. Default is 0.5s', 'skt-addons-for-elementor'),
				'min'         => 0,
				'max'         => 10,
				'step'        => 0.1,
				'default'     => 0.5,
	...
	protected function style_controls() {
		...
		// 	'container_height',
		// 	[
		// 		'label'          => __('Container Height', 'skt-addons-for-elementor'),
		...
		// 	'space',
		// 	[
		// 		'label'          => __('Max Width', 'skt-addons-for-elementor'),
		// 		'type'           => Controls_Manager::SLIDER,
		// 		'default'        => [
		// 			'unit' => '%',
		// 		],
		...
		// 	'object-fit',
		// 	[
		// 		'label'     => __('Object Fit', 'skt-addons-for-elementor'),
		// 		'type'      => Controls_Manager::SELECT,
		// 		'condition' => [
		// 			'height[size]!' => '',
		// 		],
		...
		// 			'fill'    => __('Fill', 'skt-addons-for-elementor'),
		...
		// 	[
		// 		'label'        => __('Slide Position', 'skt-addons-for-elementor'),
