...
class News_Ticker extends Base {
	...
	public function get_title () {
		return __( 'News Ticker', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls () {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'News Ticker', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'sticky_title',
			[
				'label' => __( 'Sticky Title', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Breaking News', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sticky Title Position', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'selected_posts',
			[
				'label' => __( 'Select Posts', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'type' => Select2::TYPE,
				'multiple' => true,
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __( 'Post Title Tag', 'skt-addons-for-elementor' ),
	...
	protected function wrapper_style_controls () {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sticky Title Position Left', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sticky Title Position Right', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HIDDEN,
				'default' => 'right',
				'selectors' => [
	...
	protected function title_style_controls () {
		...
		$this->add_group_control(
			...
			[
				'name' => 'title_shadow',
				'label' => __( 'Title Shadow', 'skt-addons-for-elementor' ),
