...
class Off_Canvas extends Base {
	...
	public function get_title() {
		return __( 'Off Canvas', 'skt-addons-for-elementor' );
	}
	...
	protected function register_skt_addons_elementor_content_offcanvas_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label'                 => __( 'Offcanvas Content', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'content_type',
			[
				'label'                 => __( 'Content Type', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT2,
				'multiple'              => false,
				'options'               => [
					'sidebar'   => __( 'Sidebar', 'skt-addons-for-elementor' ),
					'custom'    => __( 'Custom Content', 'skt-addons-for-elementor' ),
					'section'   => __( 'Saved Section', 'skt-addons-for-elementor' ),
					'widget'    => __( 'Saved Widget', 'skt-addons-for-elementor' ),
					'template'  => __( 'Saved Page Template', 'skt-addons-for-elementor' ),
				],
				'default'               => 'custom',
			]
		);
		...
		$this->add_control(
			'sidebar',
			[
				'label'                 => __( 'Choose Sidebar', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT2,
				'label_block'           => false,
				'multiple'              => false,
		...
		$this->add_control(
			'saved_widget',
			[
                'label' 				=> __('Choose Widget', 'skt-addons-for-elementor'),
                'type' 					=> Controls_Manager::SELECT2,
				'label_block'           => false,
				'multiple'              => false,
		...
		$this->add_control(
			'saved_section',
			[
				'label'                 => __( 'Choose Section', 'skt-addons-for-elementor' ),
				'type' 					=> Controls_Manager::SELECT2,
				'label_block'           => false,
				'multiple'              => false,
		...
		$this->add_control(
			'templates',
			[
				'label'                 => __( 'Choose Template', 'skt-addons-for-elementor' ),
				'type' 					=> Controls_Manager::SELECT2,
				'label_block'           => false,
				'multiple'              => false,
		...
		$this->add_control(
			...
			[
				...
				'default'               => [
					[
						'title'       => __( 'Box 1', 'skt-addons-for-elementor' ),
						'description' => __( 'Text box description goes here', 'skt-addons-for-elementor' ),
					],
					[
						'title'       => __( 'Box 2', 'skt-addons-for-elementor' ),
						'description' => __( 'Text box description goes here', 'skt-addons-for-elementor' ),
					],
				],
				'fields'                => [
					[
						...
						'default'           => __( 'Title', 'skt-addons-for-elementor' ),
					],
					[
						'name'              => 'description',
	...
	protected function register_skt_addons_elementor_content_toggle_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label'                 => __( 'Toggle', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'toggle_source',
			[
				'label'                 => __( 'Toggle Source', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'burger',
				'options'               => [
					'button'        => __( 'Button', 'skt-addons-for-elementor' ),
					'burger'        => __( 'Burger Icon', 'skt-addons-for-elementor' ),
					'element-class' => __( 'Element Class', 'skt-addons-for-elementor' ),
					'element-id'    => __( 'Element ID', 'skt-addons-for-elementor' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default'               => 'inline',
				'options'               => [
					'inline'        => __( 'Inline', 'skt-addons-for-elementor' ),
					'floating'      => __( 'Floating', 'skt-addons-for-elementor' ),
				],
				'separator'             => 'before',
				'condition'             => [
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Placement', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'middle-right',
				'options'               => [
					'top-left'      => __( 'Top Left', 'skt-addons-for-elementor' ),
					'top-center'    => __( 'Top Center', 'skt-addons-for-elementor' ),
					'top-right'     => __( 'Top Right', 'skt-addons-for-elementor' ),
					'middle-left'   => __( 'Middle Left', 'skt-addons-for-elementor' ),
					'middle-right'  => __( 'Middle Right', 'skt-addons-for-elementor' ),
					'bottom-right'  => __( 'Bottom Right', 'skt-addons-for-elementor' ),
					'bottom-center' => __( 'Bottom Center', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'toggle_zindex',
			[
				'label'                 => __( 'Z-Index', 'skt-addons-for-elementor' ),
				'description'           => __( 'Adjust the z-index of the floating toggle. Defaults to 999', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'toggle_class',
			[
				'label'                 => __( 'Toggle CSS Class', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'dynamic'               => [
					'active'   => true,
				],
		...
		$this->add_control(
			'toggle_id',
			[
				'label'                 => __( 'Toggle CSS ID', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'dynamic'               => [
					'active'   => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'default'               => __( 'Click Here', 'skt-addons-for-elementor' ),
				'separator'             => 'before',
				'condition'             => [
		...
		$this->add_control(
			'select_button_icon',
			[
				'label'                 => __( 'Button Icon', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Icon Position', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'before',
				'options'               => [
					'before'    => __( 'Before', 'skt-addons-for-elementor' ),
					'after'     => __( 'After', 'skt-addons-for-elementor' ),
				],
		...
		$this->add_responsive_control(
			'button_icon_spacing',
			[
				'label'                 => __( 'Icon Spacing', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options'               => [
					...
					'arrow'         => __( 'Arrow Left', 'skt-addons-for-elementor' ),
					'arrow-r'       => __( 'Arrow Right', 'skt-addons-for-elementor' ),
					'arrowalt'      => __( 'Arrow Alt Left', 'skt-addons-for-elementor' ),
					'arrowalt-r'    => __( 'Arrow Alt Right', 'skt-addons-for-elementor' ),
					'arrowturn'     => __( 'Arrow Turn Left', 'skt-addons-for-elementor' ),
					'arrowturn-r'   => __( 'Arrow Turn Right', 'skt-addons-for-elementor' ),
					'boring'        => __( 'Boring', 'skt-addons-for-elementor' ),
					'collapse'      => __( 'Collapse Left', 'skt-addons-for-elementor' ),
					'collapse-r'    => __( 'Collapse Right', 'skt-addons-for-elementor' ),
					'elastic'       => __( 'Elastic Left', 'skt-addons-for-elementor' ),
					'elastic-r'     => __( 'Elastic Right', 'skt-addons-for-elementor' ),
					'emphatic'      => __( 'Emphatic Left', 'skt-addons-for-elementor' ),
					'emphatic-r'    => __( 'Emphatic Right', 'skt-addons-for-elementor' ),
					'minus'         => __( 'Minus', 'skt-addons-for-elementor' ),
					'slider'        => __( 'Slider Left', 'skt-addons-for-elementor' ),
					'slider-r'      => __( 'Slider Right', 'skt-addons-for-elementor' ),
					'spin'          => __( 'Spin Left', 'skt-addons-for-elementor' ),
					'spin-r'        => __( 'Spin Right', 'skt-addons-for-elementor' ),
					'spring'        => __( 'Spring Left', 'skt-addons-for-elementor' ),
					'spring-r'      => __( 'Spring Right', 'skt-addons-for-elementor' ),
					'squeeze'       => __( 'Squeeze', 'skt-addons-for-elementor' ),
					'stand'         => __( 'Stand Left', 'skt-addons-for-elementor' ),
					'stand-r'       => __( 'Stand Right', 'skt-addons-for-elementor' ),
					'vortex'        => __( 'Vortex Left', 'skt-addons-for-elementor' ),
					'vortex-r'      => __( 'Vortex Right', 'skt-addons-for-elementor' ),
					'3dx'           => __( '3DX', 'skt-addons-for-elementor' ),
					'3dy'           => __( '3DY', 'skt-addons-for-elementor' ),
					'3dxy'          => __( '3DXY', 'skt-addons-for-elementor' ),
				],
				'separator'             => 'before',
				'condition'             => [
		...
		$this->add_control(
			...
			[
				...
				'default'               => __( 'Menu', 'skt-addons-for-elementor' ),
				'condition'             => [
					'toggle_source'     => 'burger',
				],
			]
	...
	protected function register_skt_addons_elementor_content_close_bar_controls(){
		...
		$this->start_controls_section(
			'section_close_bar',
			[
				'label'                 => __( 'Close Bar', 'skt-addons-for-elementor' ),
				'condition'             => [
					'close_button' => 'yes',
				],
			]
		...
		$this->add_control(
			'close_bar_absolute',
			[
				'label'             => __( 'Overlapping Close Bar', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'close_button_align',
			[
				'label'  => __( 'Close Button Alignment', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Close Icon', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::ICONS,
				'label_block'           => false,
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Close Icon Title', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'default'               => '',
				'frontend_available'    => true,
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Close Title Position', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'before',
				'options' => [
					'after'  => __( 'Before', 'skt-addons-for-elementor' ),
					'before' => __( 'After', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Additional Content', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
					'none' => __( 'None', 'skt-addons-for-elementor' ),
					'logo'  => __( 'Logo', 'skt-addons-for-elementor' ),
					'button'  => __( 'Action Button', 'skt-addons-for-elementor' ),
					'link'  => __( 'Text Link', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'close_bar_logo',
			[
				'label' 	=> __( 'Choose Logo Image', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Default title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type your title here', 'skt-addons-for-elementor' ),
				'condition' => [
		...
		$this->add_control(
			'close_bar_text',
			[
				'label' => __( 'Link Text', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Default title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type your title here', 'skt-addons-for-elementor' ),
				'condition' => [
		...
		$this->add_control(
			'close_bar_link',
			[
				'label' => __( 'Link for Logo/Button/Text', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Additional Content Alignment', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::CHOOSE,
				'options'               => [
					1      => [
						'title' => __( 'Left', 'skt-addons-for-elementor' ),
	...
	protected function register_skt_addons_elementor_content_settings_controls(){
		...
		$this->add_control(
			'direction',
			[
				'label'                 => __( 'Direction', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::CHOOSE,
				'label_block'           => false,
				'toggle'                => false,
				'default'               => 'left',
		...
		$this->add_control(
			'content_transition',
			[
				'label'                 => __( 'Content Transition', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'slide',
				'options'               => [
					'slide'                 => __( 'Slide', 'skt-addons-for-elementor' ),
					'reveal'                => __( 'Reveal', 'skt-addons-for-elementor' ),
					'push'                  => __( 'Push', 'skt-addons-for-elementor' ),
					'slide-along'           => __( 'Slide Along', 'skt-addons-for-elementor' ),
				],
				'frontend_available'    => true,
				'separator'             => 'before',
			]
		...
		$this->add_control(
			'close_button',
			[
				'label'             => __( 'Show Close Bar', 'skt-addons-for-elementor' ),
				'type'              => Controls_Manager::SWITCHER,
				'default'           => 'yes',
				'label_on'          => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off'         => __( 'No', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'esc_close',
			[
				'label'             => __( 'Esc to Close', 'skt-addons-for-elementor' ),
				'type'              => Controls_Manager::SWITCHER,
				'default'           => 'yes',
				'label_on'          => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off'         => __( 'No', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'body_click_close',
			[
				'label'             => __( 'Click anywhere to Close', 'skt-addons-for-elementor' ),
				'type'              => Controls_Manager::SWITCHER,
				'default'           => 'yes',
				'label_on'          => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off'         => __( 'No', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'links_click_close',
			[
				'label'             => __( 'Click links to Close', 'skt-addons-for-elementor' ),
				'description'       => __( 'Click on links inside offcanvas body to close the offcanvas bar', 'skt-addons-for-elementor' ),
				'type'              => Controls_Manager::SWITCHER,
				'default'           => '',
				'label_on'          => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off'         => __( 'No', 'skt-addons-for-elementor' ),
	...
	protected function register_skt_addons_elementor_style_content_controls(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'               => [
					...
					'justify'   => [
						'title' => __( 'Justified', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'widget_heading',
			[
				'label'                 => __( 'Box', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'links_heading',
			[
				'label'                 => __( 'Links', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::HEADING,
				'separator'             => 'before',
				'condition'             => [
					'content_type'      => [ 'sidebar', 'custom' ],
	...
	protected function register_skt_addons_elementor_style_toggle_controls(){
		...
		$this->add_control(
			'button_size',
			[
				'label'                 => __( 'Button Size', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'md',
				'options'               => [
					'xs' => __( 'Extra Small', 'skt-addons-for-elementor' ),
					'sm' => __( 'Small', 'skt-addons-for-elementor' ),
					'md' => __( 'Medium', 'skt-addons-for-elementor' ),
					'lg' => __( 'Large', 'skt-addons-for-elementor' ),
					'xl' => __( 'Extra Large', 'skt-addons-for-elementor' ),
				],
				'condition'             => [
					'toggle_source'     => 'button',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => __( 'Spacing', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'default'               => [
					'size'      => '',
				],
	...
	protected function register_skt_addons_elementor_style_close_button_controls(){
		...
		$this->add_control(
			'close_bar__styles',
			[
				'label' => __( 'Close Bar Styles', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Close Icon Styles', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Icon & Text Color', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::COLOR,
				'default'               => '',
				'selectors'             => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Text Typography', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => __( 'Close Icon Title Spacing', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'default'               => [
					'size'      => '5',
					'unit'      => 'px',
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => __( 'Close Icon Title Spacing 12345', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'default'               => [
					'size'      => '5',
					'unit'      => 'px',
		...
		$this->add_control(
			'additional_styles',
			[
				'label' => __( 'Additional Content Styles', 'skt-addons-for-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
				'condition'             => [
					'close_bar_additional!' => 'none',
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => __( 'Logo Height', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'default'               => [
					'size'      => '30',
					'unit'      => 'px',
	...
	protected function register_skt_addons_elementor_style_overlay_controls(){
		...
		$this->start_controls_section(
			...
			[
				'label'                 => __( 'Overlay', 'skt-addons-for-elementor' ),
				'tab'                   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		<div <?php echo wp_kses_post($this->get_render_attribute_string( 'content-wrap' )); ?>>
			...
			if ( 'button' === $settings['toggle_source'] || 'burger' === $settings['toggle_source'] ) {
				if ( 'floating' === $settings['toggle_position'] ) {
					$has_placeholder = true;
					$placeholder .= __( 'You set Offcanvas toggle to float.', 'skt-addons-for-elementor' );
				} else {
				...
				$has_placeholder = true;
				$placeholder .= __( 'You have selected to open offcanvas bar using another element.', 'skt-addons-for-elementor' );
			}

			if ( $has_placeholder ) {
				$placeholder .= ' ' . __( 'This is just a placeholder & will not be shown on the live page.', 'skt-addons-for-elementor' );
			...
			<div <?php echo wp_kses_post($this->get_render_attribute_string( 'content' )); ?>>
				<?php esc_html( $this->render_close_button()); ?>
				...
				elseif ( 'section' === $settings['content_type'] && ! empty( $settings['saved_section'] ) ) {
					...
					esc_html(  \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_section'] ));

				} elseif ( 'template' === $settings['content_type'] && ! empty( $settings['templates'] ) ) {

					esc_html( \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['templates'] ));

				} elseif ( 'widget' === $settings['content_type'] && ! empty( $settings['saved_widget'] ) ) {

					esc_html( \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_widget'] ));
	...
	protected function render_close_button() {
		...
		<div class="skt-offcanvas-header<?php echo esc_attr($wrap_class); ?>">
			...
			<div class="skt-flex-inline skt-flex-y-center skt-offcanvas-close-bar-additional">
				...
				if($content_type == 'logo'){
					echo  '<a href="',esc_attr($link),'" class="skt-offcanvas-close-bar-additional-logo" ' . esc_attr($target) . esc_attr($nofollow) . '><img src="',esc_attr($logo),'"></a>';
				}elseif($content_type == 'button'){
					echo esc_attr('<a href="',esc_attr($link),'" class="elementor-button-link elementor-button skt-offcanvas-close-bar-additional-button" role="button" ' . esc_attr($target) . esc_attr($nofollow) . '>',esc_attr($settings['close_bar_button']),'</a>');
				}elseif($content_type == 'link'){
					echo esc_attr('<a href="',esc_attr($link),'" class="skt-offcanvas-close-bar-additional-link" ' . esc_attr($target) . esc_attr($nofollow) . '>',esc_attr($settings['close_bar_text']),'</a>');
				}
				?>
			</div>
			<?php endif; ?>
			<div <?php echo wp_kses_post($this->get_render_attribute_string( 'close-button' )); ?>>
				...
				if($settings['select_close_button_icon_position'] == 'after' && $settings['select_close_button_title']){
					echo '<span class="skt-offcanvas-close-bar-close-title skt-offcanvas-close-bar-close-title-after">',esc_attr($settings['select_close_button_title']).'</span>';
				}
				echo '<span class="skt-offcanvas-close-bar-close-icon">';
				if ( $is_new || $migrated ) {
				...
				if($settings['select_close_button_icon_position'] == 'before' && $settings['select_close_button_title']){
					echo '<span class="skt-offcanvas-close-bar-close-title skt-offcanvas-close-bar-close-title-before">',esc_attr($settings['select_close_button_title']).'</span>';
				}
				?>
			</div>
		</div>
	...
	protected function render_saved_template() {
		...
		if ( 'section' === $settings['content_type'] && ! empty( $settings['saved_section'] ) ) {
			...
			echo esc_attr(\Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_section'] ) );

		} elseif ( 'template' === $settings['content_type'] && ! empty( $settings['templates'] ) ) {

			echo esc_attr(\Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['templates'] ));

		} elseif ( 'widget' === $settings['content_type'] && ! empty( $settings['saved_widget'] ) ) {

			echo esc_attr(\Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_widget'] ));
		}
	}
}