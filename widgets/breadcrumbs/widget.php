...
class Breadcrumbs extends Base {
	...
	public function get_title() {
		return __('Breadcrumbs', 'skt-addons-for-elementor');
	}
	...
	protected function __breadcrumbs_display_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Display Text', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'home',
			[
				'label'                 => __( 'Homepage', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'default'               => __( 'Home', 'skt-addons-for-elementor' ),
				'dynamic'               => [
					'active'        => true,
		...
		$this->add_control(
			...
			[
				...
				'type'                  => Controls_Manager::TEXT,
				'default'               => __( 'Pages', 'skt-addons-for-elementor' ),
				'dynamic'               => [
					'active'        => true,
					'categories'    => [ TagsModule::POST_META_CATEGORY ]
				],
		...
		$this->add_control(
			'search',
			[
				'label'                 => __( 'Search', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'default'               => __( 'Search results for:', 'skt-addons-for-elementor' ),
				'dynamic'               => [
					'active'        => true,
					'categories'    => [ TagsModule::POST_META_CATEGORY ]
				],
		...
		$this->add_control(
			'error_404',
			[
				'label'                 => __( 'Error 404', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::TEXT,
				'default'               => __( '404 Not Found', 'skt-addons-for-elementor' ),
				'dynamic'               => [
					'active'        => true,
					'categories'    => [ TagsModule::POST_META_CATEGORY ]
				],
	...
	protected function __breadcrumbs_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Breadcrumbs', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'home_icon',
			[
				'label'					=> __( 'Home Icon', 'skt-addons-for-elementor' ),
				'label_block'			=> false,
		...
		$this->add_control(
			...
			[
				...
				'type'                  => Controls_Manager::TEXT,
				'default'               => __( '>', 'skt-addons-for-elementor' ),
				'condition'             => [
					'separator_type'    => 'text'
				],
			]
		...
		$this->add_control(
			'show_on_front',
			[
				'label' => __( 'Show on front page', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'show_title',
			[
				'label' => __( 'Show last item', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
	...
	protected function __home_style_controls() {
		...
		$this->start_controls_section(
			'_section_home_style',
			[
				'label' => __('Home', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'home_icon_color',
			[
				'label'                 => __( 'Home Icon Color', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::COLOR,
				'selectors'             => [
		...
		$this->add_control(
			'home_spacing',
			[
				'label'                 => __( 'Home Icon Spacing', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'range'                 => [
					'px' 	=> [
						'max' => 50,
	...
	protected function __current_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Current', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
