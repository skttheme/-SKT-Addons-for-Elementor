...
class Pie_Chart extends Base {
	...
	public function get_title() {
		return __( 'Pie & Doughnut Chart', 'skt-addons-for-elementor' );
	}
...
//	}
	...
	protected function __chart_content_controls() {
		...
		$this->start_controls_section(
			'_section_chart',
			[
				'label' => __( 'Pie Chart', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'pie_doughnut',
			[
				'label'   => __( 'Chart Type', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'pie',
				'options' => [
					'pie' => __( 'Pie Chart', 'skt-addons-for-elementor' ),
					'doughnut' => __( 'Doughnut Chart', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Write data value. Example: 40', 'skt-addons-for-elementor' ),
			]
		);
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'animate_scale',
			[
				'label'        => __( 'Animate Scale', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
			]
