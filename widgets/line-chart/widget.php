...
class Line_Chart extends Base {
	...
	public function get_title() {
		return __( 'Line Chart', 'skt-addons-for-elementor' );
	}
...
//	}
	...
	protected function __chart_content_controls() {
		...
		$this->start_controls_section(
			'_section_chart',
			[
				'label' => __( 'Line Chart', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => __( 'January, February, March, April, May, June', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Write data values with comma ( , ) separator. Example: 4, 2, 6', 'skt-addons-for-elementor' ),
			]
		);
		...
		$repeater->add_responsive_control(
			'dash_border',
			[
				'label'       => __( 'Dash Border', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'For Dash Border add two number with comma separator. Example: 5, 4', 'skt-addons-for-elementor' ),
			]
		);
		...
		$repeater->add_control(
			'background_fill',
			[
				'label'        => __( 'Background Fill', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'point_color',
			[
				'label' => __( 'Point Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'label'              => __( 'Other Addons', 'skt-addons-for-elementor' ),
						'data'               => __( '0, 22, 4, 25, 8, 5', 'skt-addons-for-elementor' ),
						'border_color'       => '#2E93DC',
						'point_color'       => '#2E93DC',
						'background_color'  => 'rgba(46, 147, 220, 0.12)'
					],
					[
						'label'              => __( 'SKT Addons', 'skt-addons-for-elementor' ),
						'data'               => __( '17, 7, 58, 4, 24, 5', 'skt-addons-for-elementor' ),
						'border_color'       => '#5A37CF',
						'point_color'       => '#5A37CF',
						'dash_border'		=> __( '5, 4', 'skt-addons-for-elementor' ),
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'xaxes_grid_display',
			[
				'label'        => __( 'X Axes Grid Lines', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			'yaxes_grid_display',
			[
				'label'        => __( 'Y Axes Grid Lines', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Show X Axes Labels', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Show Y Axes Labels', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			'axis_range',
			[
				'label'       => __( 'Scale Axis Range', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 60,
				'description' => __( 'Maximum number for the scale.', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'step_size',
			[
				'label'       => __( 'Step Size', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 20,
				'step'        => 1,
				'description' => __( 'Step size for the scale.', 'skt-addons-for-elementor' ),
			]
		);
	...
	protected function __common_style_controls() {
		...
		$this->add_control(
			'point_border_width',
			[
				'label' => __( 'Point Border Width', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'point_style',
			[
				'label'   => __( 'Point Style', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'circle',
				'options' => [
					'circle' => __( 'Circle', 'skt-addons-for-elementor' ),
					'react' => __( 'React', 'skt-addons-for-elementor' ),
					'rectRot' => __( 'Rect Rot', 'skt-addons-for-elementor' ),
					'triangle' => __( 'Triangle', 'skt-addons-for-elementor' ),
					'cross' => __( 'Cross', 'skt-addons-for-elementor' ),
					'dash' => __( 'Dash', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			'grid_color',
			[
				'label' => __( 'Grid Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#eee',
				'condition' => [
					'grid_display' => 'yes',
	...
	protected function __labels_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => false,
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'X Axes Label is Switched off from Content > Settings.', 'skt-addons-for-elementor' ),
				'condition' => [
		...
		$this->add_control(
            ...
            [
                'label' => __( 'X Axes Typography', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::POPOVER_TOGGLE,
                'label_off' => __( 'None', 'skt-addons-for-elementor' ),
                'label_on' => __( 'Custom', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => false,
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'Y Axes Label is Switched off from Content > Settings.', 'skt-addons-for-elementor' ),
				'condition' => [
		...
		$this->add_control(
            ...
            [
                'label' => __( 'Y Axes Typography', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::POPOVER_TOGGLE,
                'label_off' => __( 'None', 'skt-addons-for-elementor' ),
                'label_on' => __( 'Custom', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
