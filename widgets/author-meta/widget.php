...
class Author_Meta extends Base {
	...
	public function get_title() {
		return __( 'Author Meta', 'skt-addons-for-elementor' );
	}
	...
	protected function __author_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Author Meta', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'show_author',
			[
				'label'        => __( 'Show Author Name', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'author_meta_tag',
			[
				'label' => __( 'Author Name Tag', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label'        => __( 'Show Avatar', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			'show_bio',
			[
				'label'        => __( 'Show Short Bio', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			'show_archive_btn',
			[
				'label'        => __( 'Show Archive Button', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'admin_archive' => __( 'Admin Posts', 'skt-addons-for-elementor' ),
				],
				'description'       => __( 'Link for the Author Name and Image', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Avatar Image Position', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
	...
	protected function __author_button_style_controls() {
		...
		$this->add_group_control(
            ...
            [
                ...
                'label' => __('Background 123', 'skt-addons-for-elementor'),
                'types' => ['classic', 'gradient'],
		...
		<div <?php $this->print_render_attribute_string('author'); ?>>
			...
			<div class="skt-desc">
				...
				if('yes' === $settings['show_author']){
					...
					esc_attr($settings['author_meta_tag']),
					wp_kses_post($this->get_render_attribute_string('author-title')),
