...
class Product_Carousel_New extends Base {
    ...
    public function get_title() {
        return __('Product Carousel', 'skt-addons-for-elementor');
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Ratings', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'skt-addons-for-elementor'),
                'label_off' => __('Hide', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
    ...
    public function render() {
        ...
        if (!class_exists('WooCommerce')) {
            printf('<div class="skt-product-carousel-error">%s</div>', esc_attr__('Please Install/Activate Woocommerce Plugin.', 'skt-addons-for-elementor'));
