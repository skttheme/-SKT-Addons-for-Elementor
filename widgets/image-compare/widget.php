...
class Image_Compare extends Base {
    ...
    protected function __image_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Before', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type before image label', 'skt-addons-for-elementor' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Label', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'After', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type after image label', 'skt-addons-for-elementor' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
    ...
    protected function __settings_content_controls() {
        ...
        $this->add_control(
            'offset',
            [
                'label' => __( 'Visibility Ratio', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'orientation',
            [
                'label' => __( 'Orientation', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'hide_overlay',
            [
                'label' => __( 'Hide Overlay', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
                'label_off' => __( 'No', 'skt-addons-for-elementor' ),
                'return_value' => 'yes',
                'description' => __( 'Hide overlay with before and after label', 'skt-addons-for-elementor' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'move_handle',
            [
                'label' => __( 'Move Handle', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'on_swipe',
                'options' => [
                    'on_hover' => __( 'On Hover', 'skt-addons-for-elementor' ),
                    'on_click' => __( 'On Click', 'skt-addons-for-elementor' ),
                    'on_swipe' => __( 'On Swipe', 'skt-addons-for-elementor' ),
                ],
                'description' => __( 'Select handle movement type. Note: overlay does not work with On Hover.', 'skt-addons-for-elementor' ),
                'style_transfer' => true,
            ]
        );
    ...
    protected function __handle_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Handle', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            '_heading_bar',
            [
                'label' => __( 'Handle Bar', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            '_heading_arrow',
            [
                'label' => __( 'Handle Arrow', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
