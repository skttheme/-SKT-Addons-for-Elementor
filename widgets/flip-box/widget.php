...
class Flip_Box extends Base {
    ...
    public function get_title() {
        return __( 'Flip Box', 'skt-addons-for-elementor' );
    }
    ...
    protected function __font_side_content_controls() {
        ...
        $this->start_controls_section(
            '_section_front',
            [
                'label' => __( 'Front Side', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Type Flip Box Title', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
    ...
    protected function __back_side_content_controls() {
        ...
        $this->start_controls_section(
            '_section_back',
            [
                'label' => __( 'Back Side', 'skt-addons-for-elementor' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Start Marketing', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type Flip Box Title', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Type Button Text', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				],
				'condition' => [
    ...
    protected function __settings_content_controls() {
		...
		$this->add_control(
			'animation_type',
			[
				'label' => __( 'Animation Type', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'classic',
				'label_block' => false,
				'options' => [
					'classic' => [
						'title' => __( 'Classic', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-square',
					],
					'3d' => [
						'title' => __( '3D', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'flip_position',
            [
                'label' => __( 'Flip Direction', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'default' => 'left-right',
                'label_block' => false,
                'options' => [
					'top-bottom' => [
						'title' => __( 'Top To Bottom ', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-v-align-bottom',
					],
					'right-left' => [
						'title' => __( 'Right to Left', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-h-align-left',
					],
                    'bottom-top' => [
                        'title' => __( 'Bottom To Top', 'skt-addons-for-elementor' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'left-right' => [
                        'title' => __( 'Left To Right', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Front Transform', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'front_transform_x',
			[
				'label' => __( 'Transform Origin X', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'default' => [
					'unit' => 'px',
		...
		$this->add_control(
			'front_transform_y',
			[
				'label' => __( 'Transform Origin Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'default' => [
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Back Transform', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'label_off' => __( 'None', 'skt-addons-for-elementor' ),
				'label_on' => __( 'Custom', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
    ...
    protected function __font_side_style_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background Overlay', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'front_icon_heading',
            [
                'label' => __( 'Media Type - Icon', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Media Type - Image', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'condition' => [
                    'front_icon_type' => 'image'
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Resize Image', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'condition' => [
                    'front_icon_type' => 'image'
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Image Fit', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'contain'  => __( 'Contain', 'skt-addons-for-elementor' ),
                    'cover' => __( 'Cover', 'skt-addons-for-elementor' ),
                ],
                'condition' => [
                    'front_icon_type' => 'image'
                ],
        ...
        $this->add_control(
            'front_text',
            [
                'label' => __( 'Title & Description', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    protected function __back_side_button_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back Side - Button', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( '<strong>Button</strong> is Hidden from "Back Side" content section', 'skt-addons-for-elementor' ),
				'condition' => [
					'show_button!' => 'yes',
				],
			]
                                ...
                                <?php
									if ( $settings['front_title'] ) {
										printf( '<%1$s %2$s>%3$s</%1$s>',
											esc_attr(skt_addons_elementor_escape_tags( $settings['front_title_tag']), 'h2' ),
											esc_attr($this->get_render_attribute_string( 'front_title' )),
											esc_attr(skt_addons_elementor_kses_basic( $settings['front_title']) )
										);
									}
								?>
                            ...
                            <div class="skt-text">
                                <?php
									if ( $settings['back_title'] ) {
										printf( '<%1$s %2$s>%3$s</%1$s>',
											esc_attr(skt_addons_elementor_escape_tags( $settings['back_title_tag']), 'h2' ),
											esc_attr($this->get_render_attribute_string( 'back_title' )),
											esc_attr(skt_addons_elementor_kses_basic( $settings['back_title'] ))
										);
									}
								?>
