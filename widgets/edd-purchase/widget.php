...
class EDD_Purchase extends Base {
	...
	public function get_title() {
		return __( 'EDD Purchase', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __( '<strong>Note:</strong> EDD Purchase widget doesn\'t have any useful content control.', 'skt-addons-for-elementor' ),
	...
	protected function __edd_download_table_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Purchase Table', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Purchase Items', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		if( skt_addons_elementor()->editor->is_edit_mode() ){
			...
			echo skt_addons_elementor_do_shortcode( 'purchase_history' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		}
	...
	protected function editor_mode_preview_history(){
		...
		<table id="edd_user_history" class="edd-table">
			<thead>
				<tr class="edd_purchase_row">
					...
					<th class="edd_purchase_id"><?php esc_attr_e('ID','skt-addons-for-elementor' ); ?></th>
					<th class="edd_purchase_date"><?php esc_attr_e('Date','skt-addons-for-elementor' ); ?></th>
					<th class="edd_purchase_amount"><?php esc_attr_e('Amount','skt-addons-for-elementor' ); ?></th>
					<th class="edd_purchase_details"><?php esc_attr_e('Details','skt-addons-for-elementor' ); ?></th>
		...
		<?php
			echo edd_pagination(  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
				array(
		...
		<!-- <p class="edd-no-purchases"><?php esc_attr_e('You have not made any purchases','skt-addons-for-elementor' ); ?></p> -->
	<?php 
	// endif;
	}
}
