...
class Data_Table extends Base {
	...
	public function get_title() {
		return __( 'Data Table', 'skt-addons-for-elementor' );
	}
	...
	protected function __table_head_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Column One', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$repeater->add_control(
			'column_span',
			[
				'label' => __( 'Col Span', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'column_name' => __( 'WordPress', 'skt-addons-for-elementor' )
					],
					[
						'column_name' => __( 'Elementor', 'skt-addons-for-elementor' )
					],
					[
						'column_name' => __( 'SKT Addons', 'skt-addons-for-elementor' )
					],
				]
			]
		);
	...
	protected function __table_row_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'Cell Name', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				],
				'condition' => [
		...
		$repeater->add_control(
			'row_span',
			[
				'label' => __( 'Row Span', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 50,
				'step' => 1,
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Row Starts', 'skt-addons-for-elementor' ),
				'condition' => [
					'row_column_type' => 'row'
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'row_column_type' => 'row',
						'row_starts' => __( 'Row Starts', 'skt-addons-for-elementor' ),
					],
					[
						'row_column_type' => 'column',
						'cell_name' => __( 'Stay Happy', 'skt-addons-for-elementor' )
					],
					[
						'row_column_type' => 'column',
						'cell_name' => __( 'Stay Safe', 'skt-addons-for-elementor' )
					],
					[
						'row_column_type' => 'column',
						'cell_name' => __( 'Spread Happiness', 'skt-addons-for-elementor' )
					],
				]
			]
		);
	...
	protected function __table_head_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Image Border Radius', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
