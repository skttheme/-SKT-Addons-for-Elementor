...
class Product_Category_Carousel_New extends Base {
    ...
    public function get_title() {
        return __( 'Product Category Carousel', 'skt-addons-for-elementor' );
    }
	...
	protected function get_parent_cats() {
		...
		// Resolved deprecated parameters Get_terms
		$args = array(
    ...
    public function get_query() {
		...
		$product_cats = get_terms( 'product_cat', $args ); // phpcs:ignore WordPress.WP.DeprecatedParameters.Get_termsParam2Found 
	...
	public function render() {
		...
		if ( ! class_exists( 'WooCommerce' ) ) {
			printf( '<div class="skt-cat-carousel-error">%s</div>', esc_attr__( 'Please Install/Activate Woocommerce Plugin.', 'skt-addons-for-elementor' ) );
