...
class Edd_Product_Carousel extends Base {
	...
	public function get_title() {
		return __( 'EDD Product Carousel', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'modern'  => __( 'Modern', 'skt-addons-for-elementor' ),
					'remote_carousel'  => __( 'Remote Carousel', 'skt-addons-for-elementor' ),
				],
				'default'     => 'classic',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Unique ID', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => __( 'Enter remote carousel unique id', 'skt-addons-for-elementor' ),
                'description' => __('Input carousel ID that you want to remotely connect', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Show Quick View', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Show Add To cart', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off'    => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => false,
				'default'     => __( 'Add To Cart', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Show On Sale Badge', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off'    => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'product_sale_badge',
			[
				'label'       => __( 'Badge Title', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => false,
				'default'     => __( 'Sale!', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
				'condition'   => [
		...
		$this->add_control(
			...
			[
				'type'           => Controls_Manager::SWITCHER,
				'label'          => __( 'Show Excerpt', 'skt-addons-for-elementor' ),
				'default'        => 'yes',
				'return_value'   => 'yes',
				'style_transfer' => true,
			]
		...
		$this->update_control(
			...
			[
				'options' => [
					...
					'featured' => __( 'Featured Products', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->update_control(
			...
			[
				'options' => [
					'current_post'     => __( 'Current Product', 'skt-addons-for-elementor' ),
					'manual_selection' => __( 'Manual Selection', 'skt-addons-for-elementor' ),
					'terms'            => __( 'Terms', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->update_control(
			...
			[
				'description' => __( 'Select product categories and tags', 'skt-addons-for-elementor' ),
			]
		);
		$this->update_control(
		...
		$this->update_control(
			...
			[
				'options' => [
					'comment_count' => __( 'Review Count', 'skt-addons-for-elementor' ),
					'date'          => __( 'Date', 'skt-addons-for-elementor' ),
					'ID'            => __( 'ID', 'skt-addons-for-elementor' ),
					'menu_order'    => __( 'Menu Order', 'skt-addons-for-elementor' ),
					'rand'          => __( 'Random', 'skt-addons-for-elementor' ),
					'title'         => __( 'Title', 'skt-addons-for-elementor' ),
				],
				'default' => 'title',
			]
		);
		...
		$this->add_control(
			'posts_per_page',
			[
				'label'       => __( 'Number Of Products', 'skt-addons-for-elementor' ),
				'description' => __( 'Only visible products will be shown in the products grid. Hence number of products in the grid may differ from number of products setting.', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 9,
			]
		);
		...
		$this->start_controls_section(
			'_section_settings',
			[
				'label' => __( 'Carousel Settings', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'animation_speed',
			[
				'label'              => __( 'Animation Speed', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::NUMBER,
				'min'                => 100,
				'step'               => 10,
				'max'                => 10000,
				'default'            => 800,
				'description'        => __( 'Slide speed in milliseconds', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'loop',
			[
				'label'              => __( 'Infinite Loop?', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_on'           => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off'          => __( 'No', 'skt-addons-for-elementor' ),
				'return_value'       => 'yes',
		...
		$this->add_control(
			'navigation',
			[
				'label'              => __( 'Navigation', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'options'            => [
					'none'  => __( 'None', 'skt-addons-for-elementor' ),
					'arrow' => __( 'Arrow', 'skt-addons-for-elementor' ),
					'dots'  => __( 'Dots', 'skt-addons-for-elementor' ),
					'both'  => __( 'Arrow & Dots', 'skt-addons-for-elementor' ),
				],
				'default'            => 'arrow',
				'frontend_available' => true,
				'style_transfer'     => true,
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label'              => __( 'Slides To Show', 'skt-addons-for-elementor' ),
				'type'               => Controls_Manager::SELECT,
				'options'            => [
					1 => __( '1 Slide', 'skt-addons-for-elementor' ),
					2 => __( '2 Slides', 'skt-addons-for-elementor' ),
					3 => __( '3 Slides', 'skt-addons-for-elementor' ),
					4 => __( '4 Slides', 'skt-addons-for-elementor' ),
					5 => __( '5 Slides', 'skt-addons-for-elementor' ),
					6 => __( '6 Slides', 'skt-addons-for-elementor' ),
				],
				'desktop_default'    => 3,
				'tablet_default'     => 2,
				'mobile_default'     => 1,
	...
	protected function register_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Carousel Item', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Space between Items', 'skt-addons-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Image & Badge', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw'       => __( '<strong>Badge</strong> is Switched off on "Layout"', 'skt-addons-for-elementor' ),
				'condition' => [
					'product_on_sale_show!' => 'yes',
				],
			]
		...
		$this->add_responsive_control(
			'badge_position_y',
			[
				'label'      => __( 'Vertical', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'condition'  => [
		...
		$this->add_responsive_control(
			'badge_position_x',
			[
				'label'      => __( 'Horizontal', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'condition'  => [
					'badge_position_toggle' => 'yes',
		...
		// 	'_heading_rating',
		// 	[
		// 		'label'     => __( 'Ratings', 'skt-addons-for-elementor' ),
		// 		'type'      => Controls_Manager::HEADING,
		// 		'separator' => 'before',
		// 	]
		// );
		...
		// 		'label'     => false,
		// 		'type'      => Controls_Manager::RAW_HTML,
		// 		'raw'       => __( '<strong>Ratings</strong> is not selected on "Layout"', 'skt-addons-for-elementor' ),
		// 		'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Add to Cart Button', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => false,
				'type'      => Controls_Manager::RAW_HTML,
				'raw'       => __( '<strong>Add To Cart</strong> is not selected on "Layout"', 'skt-addons-for-elementor' ),
				'condition' => [
		...
		$this->add_responsive_control(
			'arrow_spacing',
			[
				'label'      => __( 'Space between Arrows', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'condition'  => [
					'arrow_position_toggle' => 'yes',
		...
		$this->add_responsive_control(
			'arrow_size',
			[
				'label'      => __( 'Box Size', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			'_section_style_dots',
			[
				'label' => __( 'Navigation - Dots', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'dots_nav_position_y',
			[
				'label'      => __( 'Vertical Position', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range'      => [
					'px' => [
	...
	public function print_quick_view_button( $product_id ) {
		...
		$quick_view_text = ( 'classic' == $this->get_settings_for_display( 'skin' ) ) ? '<span>' . esc_html__( 'Quick View', 'skt-addons-for-elementor' ) . '</span>' : '<span class="skt-screen-reader-text">' . esc_html__( 'Quick View', 'skt-addons-for-elementor' ) . '</span></a>';
		...
		printf(
			...
			$quick_view_text // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		);
	}
	...
	public function render() {
		...
		<div data-skt_rcc_uid="<?php echo esc_attr( $sktrcc_uid ); ?>" <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			if ( $loop->have_posts() ) :
						...
						<div class="skt-product-carousel-item-inner">
							<div class="skt-product-carousel-image">
								...
								<?php if ( has_post_thumbnail() ) : ?>
									<img src="<?php echo Group_Control_Image_Size::get_attachment_image_src( get_post_thumbnail_id( $loop->ID ), 'post_image', $settings ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?>" />
								<?php else : ?>
							...
							<?php if ( $settings[ 'show_cat' ] === 'yes' ) : ?>
								<div class="skt-product-carousel-category">
									<?php echo skt_addons_elementor_pro_the_first_taxonomy( $loop->ID, 'download_category', ['class'=>'skt-product-carousel-category-inner'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
								</div>
							<?php endif; ?>
							...
							<?php if ( $settings[ 'show_excerpt' ] == 'yes' && !empty( $settings[ 'excerpt_length' ] ) ) : ?>
								<p class="skt-product-carousel-desc">
									<?php echo skt_addons_elementor_pro_get_excerpt( $loop->ID, $settings[ 'excerpt_length' ] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?>
								</p>
							<?php endif; ?>
							...
							<?php if ( $settings['skin'] == 'classic' && $settings['product_add_to_cart_show'] == 'yes' ) : ?>
								<div class="skt-product-carousel-add-to-cart">
									...
									if ( edd_has_variable_prices( get_the_ID() ) ) {
										...
										echo edd_get_purchase_link( [ 'download_id' => get_the_ID(), 'text' => $settings['add_to_cart_text'] ] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
				...
				if ( is_admin() ) {
					return printf( '<div class="skt-product-carousel-error">%s</div>', esc_attr__( 'Nothing Found. Please Add Products.', 'skt-addons-for-elementor' ) ); 
				}
			endif;
			?>
		</div>
