...
class Bar_Chart extends Base {
	...
	public function get_title() {
		return __( 'Bar Chart', 'skt-addons-for-elementor' );
	}
	...
	protected function __barchart_content_controls() {
		...
		$this->start_controls_section(
			'_section_chart',
			[
				'label' => __( 'Bar Chart', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'bar',
				'options' => [
					'bar' => __( 'Vertical Bar', 'skt-addons-for-elementor' ),
					'horizontalBar' => __( 'Horizontal Bar', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => __( 'January, February, March', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Background Hover Color', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::COLOR,
			]
		);
		...
		$repeater->add_control(
			'border_hover_color',
			[
				'label' => __( 'Border Hover Color', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::COLOR,
			]
		);
			...
			[
				...
				'default'     => [
					[
						...
						'data'               => __( '2, 4, 5', 'skt-addons-for-elementor' ),
					...
					[
						...
						'data'               => __( '1, 6, 8', 'skt-addons-for-elementor' ),
	...
	protected function __barchart_common_style_controls() {
		...
		$this->add_control(
			'bar_width',
			[
				'label' => __( 'Bar Width', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'category_width',
			[
				'label' => __( 'Category Width', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'bar_border_width',
			[
				'label' => __( 'Bar Border Width', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
