...
class List_Group extends Base {
    ...
    public function get_title() {
        return __( 'List Group', 'skt-addons-for-elementor' );
    }
    ...
    protected function __list_items_content_controls() {
        ...
        $this->start_controls_section(
            '_section_list_group',
            [
                'label' => __( 'List Items', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'number',
            [
                'label' => __( 'Item Number', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __( 'List Item Number', 'skt-addons-for-elementor' ),
                'default' => __( '1', 'skt-addons-for-elementor' ),
                'condition' => [
                    'icon_type' => 'number'
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'separator' => 'before',
                'placeholder' => __( 'List Item', 'skt-addons-for-elementor' ),
                'default' => __( 'Build beautiful websites', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $repeater->add_control(
			...
			[
				...
				'description' => __( 'Set badge style settings from Style tab', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'List Item Description', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
            ]
        ...
        $repeater->add_control(
            'custom_look',
            [
                'label' => __( 'Custom Look', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'title_heading',
            [
                'label' => __( 'Direction Arrow Style', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => __( 'Build beautiful websites', 'skt-addons-for-elementor' ),
						'icon' => [
							'value' => 'fas fa-check',
							'library' => 'regular',
						],
                    ...
                    [
                        'title' => __( 'Floating Effect', 'skt-addons-for-elementor' ),
						'icon' => [
							'value' => 'fas fa-check',
							'library' => 'regular',
						],
                    ...
                    [
                        'title' => __( 'CSS Transform', 'skt-addons-for-elementor' ),
						'icon' => [
							'value' => 'fas fa-check',
							'library' => 'regular',
						],
                    ...
                    [
                        'title' => __( 'Fast and Lightweight', 'skt-addons-for-elementor' ),
						'icon' => [
							'value' => 'fas fa-check',
							'library' => 'regular',
						],
    ...
    protected function __settings_content_controls() {
        ...
        $this->add_control(
            'mode',
            [
                'label' => __( 'List Mode', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'compact' => [
                        'title' => __( 'Compact', 'skt-addons-for-elementor' ),
                        'icon' => 'eicon-square',
                    ],
                    'comfy' => [
                        'title' => __( 'Comfy', 'skt-addons-for-elementor' ),
                        'icon' => 'eicon-menu-bar',
                    ],
                ],
                'toggle' => false,
        ...
        $this->add_control(
            'direction_position',
            [
                'label' => __( 'Direction Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
    ...
    protected function __title_desc_style_controls() {
        ...
        $this->add_control(
            'title_link_color',
            [
                'label' => __( 'Link Text Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function __direction_style_controls() {
        ...
        $this->add_control(
			'direction_animation',
			[
				'label' => __( 'Direction Animation', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
