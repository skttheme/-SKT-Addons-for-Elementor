...
class Team_Carousel extends Base {
    ...
    public function get_title() {
        return __( 'Team Carousel', 'skt-addons-for-elementor' );
    }
	...
	protected function __information_content_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'SKT Member Name', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'show_options',
			[
				'label' => __( 'Show Links', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'website', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Website Address', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            'facebook', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Facebook', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Add your Facebook address', 'skt-addons-for-elementor' ),
                'input_type' => 'url',
				'condition' => [
					'show_options' => 'yes'
				],
        ...
        $repeater->add_control(
            'twitter', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Twitter', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Add your Twitter address', 'skt-addons-for-elementor' ),
                'input_type' => 'url',
				'condition' => [
					'show_options' => 'yes'
				],
        ...
        $repeater->add_control(
            'instagram', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Instagram', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Add your Instagram address', 'skt-addons-for-elementor' ),
                'input_type' => 'url',
				'condition' => [
					'show_options' => 'yes'
				],
        ...
        $repeater->add_control(
            'github', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Github', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Add your Github address', 'skt-addons-for-elementor' ),
                'input_type' => 'url',
				'condition' => [
					'show_options' => 'yes'
				],
        ...
        $repeater->add_control(
            'linkedin', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'LinkedIn', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Add your LinkedIn address', 'skt-addons-for-elementor' ),
                'input_type' => 'url',
				'condition' => [
					'show_options' => 'yes'
				],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => __( 'SKT Member Name', 'skt-addons-for-elementor' ),
                        'job_title' => __( 'SKT Officer', 'skt-addons-for-elementor' ),
	...
	protected function __settings_content_controls() {
        ...
        $this->add_control(
            'center',
            [
                'label' => __( 'Center Mode?', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
                'label_off' => __( 'No', 'skt-addons-for-elementor' ),
                'return_value' => 'yes',
                'description' => __( 'Best works with odd number of slides (Slides To Show) and loop (Infinite Loop)', 'skt-addons-for-elementor' ),
                'frontend_available' => true,
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'vertical',
            [
                'label' => __( 'Vertical Mode?', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
                'label_off' => __( 'No', 'skt-addons-for-elementor' ),
                'return_value' => 'yes',
	...
	protected function __item_style_controls() {
        ...
        $background_types = [ 'classic' => 'image' ];
        if ( isset( $background_types['classic'] ) && $background_types['classic'] === 'image' ) {
	...
	protected function __nav_arrow_style_controls() {
		...
		$this->add_responsive_control(
			'arrow_size',
			[
				'label' => __( 'Background Size', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
                        ...
                        <div class="skt-member-body">
                            <?php if ( $member['title'] ) :
                                printf( '<%1$s %2$s>%3$s</%1$s>',
                                    esc_attr(skt_addons_elementor_escape_tags( $settings['title_tag'] )),
								...
								<div class="skt-member-links">
									...
									if ( !empty( $member['website'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-globe"></i></a>',
											esc_attr($website_address),
											wp_kses_post($this->get_render_attribute_string( $website ))
										);
									endif;
									...
									if ( !empty( $member['email'] ) ) :
										...
										printf( '<a href="mailto: %1$s" %2$s><i class="fa fa-envelope"></i></a>',
											...
											wp_kses_post($this->get_render_attribute_string( $email ))
 										);
									endif;
									...
									if ( !empty( $member['facebook'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-facebook"></i></a>',
											esc_attr($facebook_address),
											wp_kses_post($this->get_render_attribute_string( $facebook ) )
                                        );
									endif;
									...
									if ( !empty( $member['twitter'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-twitter"></i></a>',
											esc_attr($twitter_address),
											wp_kses_post($this->get_render_attribute_string( $twitter ))
										);
									endif;
									...
									if ( !empty( $member['instagram'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-instagram"></i></a>',
											esc_attr($instagram_address),
											wp_kses_post($this->get_render_attribute_string( $instagram ))
										);
									endif;
									...
									if ( !empty( $member['github'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-github"></i></a>',
											esc_attr($github_address),
											wp_kses_post($this->get_render_attribute_string( $github ))
										);
									endif;
									...
									if ( !empty( $member['linkedin'] ) ) :
										...
										printf('<a href="%1$s" %2$s><i class="fa fa-linkedin"></i></a>',
											esc_attr($linkedin_address),
											wp_kses_post($this->get_render_attribute_string( $linkedin ))
										);
									endif;
									?>
								</div>
