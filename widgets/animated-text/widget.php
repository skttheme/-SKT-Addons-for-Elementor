...
class Animated_Text extends Base {
	...
	public function get_title() {
		return __('Animated Text', 'skt-addons-for-elementor');
	}
	...
	protected function __animated_text_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'rotate-1',
				'options' => [
					'rotate-1' => __('Rotate 1', 'skt-addons-for-elementor'),
					'letters type' => __('Type', 'skt-addons-for-elementor'),
					'letters rotate-2' => __('Rotate 2', 'skt-addons-for-elementor'),
					'loading-bar' => __('Loading Bar', 'skt-addons-for-elementor'),
					'slide' => __('Slide', 'skt-addons-for-elementor'),
					'clip' => __('Clip', 'skt-addons-for-elementor'),
					'zoom' => __('Zoom', 'skt-addons-for-elementor'),
					'letters rotate-3' => __('Rotate 3', 'skt-addons-for-elementor'),
					'letters scale' => __('Scale', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'before_text',
			[
				'label' => __('Before Text', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'default' => __('SKT Addons is', 'skt-addons-for-elementor'),
				'placeholder' => __('Before Text', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ]
			]
		...
		$this->add_control(
			'after_text',
			[
				'label' => __('After Text', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => __('After Text', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ]
			]
		...
		$repeater->add_control(
			'text', [
				...
				'type' => Controls_Manager::TEXT,
				'default' => __('Awesome', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ]
			]
		...
		$repeater->add_control(
			'text_customize',
			[
				'label' => __('Want To Customize Text?', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'animated_text',
			[
				'label' => __('Animated Text', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text' => __('Awesome', 'skt-addons-for-elementor'),
					],
					[
						'text' => __('Cool', 'skt-addons-for-elementor'),
					],
					[
						'text' => __('Nice', 'skt-addons-for-elementor'),
					],
				],
				'title_field' => '{{{ text }}}',
			]
		...
		$this->add_control(
			'html_tag',
			[
				'label' => __('HTML Tag', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					...
					'p' => __('P', 'skt-addons-for-elementor'),
				],
				'default' => 'h2',
			]
		);
	...
	protected function __settings_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Animation Settings', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT,
				'conditions' => [
					'relation' => 'and',
					'terms' => [
		...
		$this->add_control(
			'animation_delay',
			[
				'label' => __('Animation Delay', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::NUMBER,
				'min' => 1000,
				'step' => 100,
				'max' => 30000,
				'default' => 2500,
				'description' => __('Animation Delay in milliseconds. Min 1000 and Max 30000.', 'skt-addons-for-elementor'),
	...
	protected function __common_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Common Style', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'loading_bar_color',
			[
				'label' => __('Loading Bar Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'cursor_color',
			[
				'label' => __('Cursor Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'select_text_color',
			[
				'label' => __('Select Text Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function __before_text_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Before Text Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __after_text_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('After Text Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __animated_text_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Animated Text Style', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		printf(
            '<%1$s %2$s>%3$s</%1$s>',
            esc_attr(skt_addons_elementor_escape_tags( $settings['html_tag'] )),
            wp_kses_post($this->get_render_attribute_string( 'skt-animated' )),
            wp_kses_post($animated_text)
            );
	}
}