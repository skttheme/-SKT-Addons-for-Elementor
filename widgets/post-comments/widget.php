...
class Post_Comments extends Base {
	...
	public function get_title() {
		return __('Post Comments', 'skt-addons-for-elementor');
	}
	...
	protected function __post_comments_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __('Post Comments', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'source_type',
			[
				'label' => esc_html__('Source', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'current_post' => esc_html__('Current Post', 'skt-addons-for-elementor'),
					'custom' => esc_html__('Custom', 'skt-addons-for-elementor'),
				],
		...
		$this->add_control(
			'source_custom',
			[
				'label' => esc_html__('Search & Select', 'skt-addons-for-elementor'),
				'type' => Select2::TYPE,
				'multiple' => false,
	...
	protected function __post_comments_style_controls() {
		...
		$this->start_controls_section(
			'label_style',
			[
				'label' => esc_html__('Comments', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'skt_pc_desc_link',
			[
				'label' => __('Description Link', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::HEADING,
			]
		);
	...
	protected function __post_comments_textarea_style_controls() {
		$this->start_controls_section(
			'textarea_style',
			[
				'label' => esc_html__('Textarea', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Label Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Textarea Input', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::HEADING,
			]
		);
	...
	protected function __post_comments_button_style_controls() {
		...
		$this->start_controls_section(
			'pc_button_style',
			[
				'label' => esc_html__('Submit Button', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
