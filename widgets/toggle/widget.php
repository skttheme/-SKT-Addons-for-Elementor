...
class Toggle extends Base {
	...
	public function get_title() {
		return __( 'Advanced Toggle', 'skt-addons-for-elementor' );
	}
	...
	protected function __toggle_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => __( 'Toggle Title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type Toggle Title', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
			]
		...
		$repeater->add_control(
			...
			[
				...
				'description' => sprintf(
					...
					__( 'Wondering what is section template or need to create one? Please click %1$shere%2$s ', 'skt-addons-for-elementor' ),
