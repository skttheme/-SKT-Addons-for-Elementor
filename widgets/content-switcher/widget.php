...
class Content_Switcher extends Base {
	...
	public function get_title() {
		return __('Content Switcher', 'skt-addons-for-elementor');
	}
	...
	protected function __switcher_content_controls() {
		...
		$this->start_controls_section(
			'_section_content',
			[
				'label' => __('Content Switcher', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'select_design',
			[
				'label'   => __('Choose Design', 'skt-addons-for-elementor'),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'round' => __('Round', 'skt-addons-for-elementor'),
					'round-2'   => __('Round 2', 'skt-addons-for-elementor'),
					'square' => __('Square', 'skt-addons-for-elementor'),
					'square-2' => __('Square 2', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				'raw' => '<strong>' . esc_html__('Please note!', 'skt-addons-for-elementor') . '</strong> ' . esc_html__('This design requires only two items. Only the first two items will be used.', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __('Content', 'skt-addons-for-elementor'),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$repeater->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'plain_content' => __('Plain/ HTML Text', 'skt-addons-for-elementor'),
					'saved_section' => __('Saved Section', 'skt-addons-for-elementor'),
					'saved_page'    => __('Saved Page', 'skt-addons-for-elementor'),
				],
		...
		$repeater->add_control(
			'plain_content',
			[
				'label'     => __('Plain/ HTML Text', 'skt-addons-for-elementor'),
				...
				'default'   => __('Add some content here.', 'skt-addons-for-elementor'),
			]
		);

		$saved_sections = ['0' => __('--- Select Section ---', 'skt-addons-for-elementor')];
		$saved_sections = $saved_sections + $this->select_elementor_page('section');

		$repeater->add_control(
			'saved_section',
			[
				'label'     => __('Sections', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::SELECT,
		...
		$saved_page = ['0' => __('--- Select Page ---', 'skt-addons-for-elementor')];
		$saved_page = $saved_page + $this->select_elementor_page('page');

		$repeater->add_control(
			'saved_pages',
			[
				'label'     => __('Pages', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::SELECT,
				'options'   => $saved_page,
				'default'   => '0',
				'condition' => [
		...
		$repeater->add_control(
			...
			[
				...
				'description'  => __('Active on Load', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'content_list',
			[
				'label'         => __('Contents', 'skt-addons-for-elementor'),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $repeater->get_controls(),
				'prevent_empty' => true,
				'default'       => [
					[
						'title'         => __('Primary', 'skt-addons-for-elementor'),
						'content_type'  => 'plain_content',
					...
					[
						'title'         => __('Secondary', 'skt-addons-for-elementor'),
						'content_type'  => 'plain_content',
						'plain_content' => __('It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).', 'skt-addons-for-elementor'),
					],
					[
						'title'         => __('Others', 'skt-addons-for-elementor'),
						'content_type'  => 'plain_content',
	...
	protected function __settings_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Display Settings', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'switch_align',
			[
				'label'     => __('Switch Alignment', 'skt-addons-for-elementor'),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label'       => __('Space', 'skt-addons-for-elementor'),
				'description' => __('Set Space between switcher and content section', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Set Animation Duration in Millisecond', 'skt-addons-for-elementor'),
				'min'         => 100,
				'max'         => 3000,
				'step'        => 100,
				'default'     => 400,
	...
	protected function __switch_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Switch', 'skt-addons-for-elementor'),
		...
		$this->add_responsive_control(
			'label_spacing',
			[
				'label'      => __('Title Spacing', 'skt-addons-for-elementor'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'box_style',
			[
				'label'     => __('Box Style', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'title_box_bg_color',
			[
				'label'     => __('Box Color', 'skt-addons-for-elementor'),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '#FFF',
				'selectors' => [
		...
		$this->add_responsive_control(
			'box_padding',
			[
				'label'      => __('Box Padding', 'skt-addons-for-elementor'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'default' 	 => [
					'top' => '5',
	...
	protected function __switcher_control_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Switcher Control', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'select_design' => ['round', 'round-2', 'square', 'square-2'],
				],
		...
		$this->add_control(
			'switch_style_size',
			[
				'label' => __('Switch Size (px)', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
	...
	protected function __switch_bar_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Switch Bar', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __('Section Padding', 'skt-addons-for-elementor'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
						...
						<?php foreach ($settings['content_list'] as $i => $item) : ?>
							<div id="<?php echo esc_attr($item['_id']); ?>" class="skt-cs-content-section <?php echo esc_attr(($item['active'] == 'yes') ? 'active' : ''); ?>">
								...
								if ($item['content_type'] == 'plain_content') {
									echo wp_kses_post(skt_addons_elementor_kses_intermediate( $item['plain_content'] ));	
								} else if ($item['content_type'] == 'saved_section') {
									echo skt_addons_elementor()->frontend->get_builder_content_for_display($item['saved_section']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
								} else if ($item['content_type'] == 'saved_page') {
									echo skt_addons_elementor()->frontend->get_builder_content_for_display($item['saved_pages']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
								}
								?>
							</div>
						<?php endforeach; ?>
					...
					?>
						<div id="<?php echo esc_attr($primary['_id']); ?>" class="skt-cs-content-section primary <?php echo esc_attr(($primary['active'] == 'yes') ? 'active' : ''); ?>">
							...
							if ($primary['content_type'] == 'plain_content') {
								echo skt_addons_elementor_kses_intermediate( $primary['plain_content'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							} else if ($primary['content_type'] == 'saved_section') {
								echo skt_addons_elementor()->frontend->get_builder_content_for_display($primary['saved_section']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							} else if ($primary['content_type'] == 'saved_page') {
								echo skt_addons_elementor()->frontend->get_builder_content_for_display($primary['saved_pages']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							}
							?>
						</div>
						...
						<div id="<?php echo esc_attr($secondary['_id']); ?>" class="skt-cs-content-section secondary <?php echo esc_attr(($secondary['active'] == 'yes') ? 'active' : ''); ?>">
							...
							if ($secondary['content_type'] == 'plain_content') {
								echo skt_addons_elementor_kses_intermediate( $secondary['plain_content'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							} else if ($secondary['content_type'] == 'saved_section') {
								echo skt_addons_elementor()->frontend->get_builder_content_for_display($secondary['saved_section']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							} else if ($secondary['content_type'] == 'saved_page') {
								echo skt_addons_elementor()->frontend->get_builder_content_for_display($secondary['saved_pages']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
							}
							?>
						</div>
