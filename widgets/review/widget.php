...
class Review extends Base {
	...
	public function get_title() {
		return __( 'Review', 'skt-addons-for-elementor' );
	}
	...
	protected function __review_content_controls() {
		...
		$this->start_controls_section(
			'_section_review',
			[
				'label' => __( 'Review', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'ratting_style',
			[
				'label' => __( 'Rating Style', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'star' => __( 'Star', 'skt-addons-for-elementor' ),
					'num' => __( 'Number', 'skt-addons-for-elementor' ),
				],
				'default' => 'star',
				'style_transfer' => true,
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'SKT reviewer is super excited being part of skt addons family', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type amazing review from skt reviewer', 'skt-addons-for-elementor' ),
				'separator' => 'before',
				'dynamic' => [
					'active' => true,
				]
		...
		$this->add_control(
			'review_position',
			[
				'label' => __( 'Review Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'before' => __( 'Before Rating', 'skt-addons-for-elementor' ),
					'after' => __( 'After Rating', 'skt-addons-for-elementor' ),
				],
				'default' => 'before',
				'style_transfer' => true,
			]
	...
	protected function __reviewer_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Type Reviewer Job Title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __( 'Name HTML Tag', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'h1'  => [
	...
	protected function __review_reviewer_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Review & Reviewer', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'body_padding',
			[
				'label' => __( 'Text Box Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
			...
			<div class="skt-review-header">
				...
				if ( ! empty( $settings['title'] ) ) :
					...
					printf(
						'<%1$s %2$s>%3$s</%1$s>',
						esc_html( $title_tag ),
						wp_kses_post( $this->get_render_attribute_string( 'title' ) ), // Ensure the attributes are properly escaped
						esc_html( $settings['title'] ) // Escape the title text to prevent XSS
					);
