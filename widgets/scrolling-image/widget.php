...
class Scrolling_Image extends Base {
	...
	public function get_title() {
		return __('Scrolling Image', 'skt-addons-for-elementor');
	}
	...
	protected function __image_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Scrolling Image', 'skt-addons-for-elementor'),
		...
		$repeater->add_control(
			'image_style',
			[
				'label' => __( 'Image Style', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'foreground',
				'options' => [
					'foreground' => [
						'title' => __( 'Foreground', 'skt-addons-for-elementor' ),
						'icon' => 'skti skti-forward',
					],
					'background' => [
						'title' => __( 'Background', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __('SKT Master', 'skt-addons-for-elementor'),
				'placeholder' => __('Brand Name', 'skt-addons-for-elementor'),
				'dynamic' => [
					'active' => true,
				],
				'separator' => 'before'
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => __('WordPress', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
					[
						'title' => __('Elementor', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
					[
						'title' => __('SKT Addons', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
					[
						'title' => __('PHP', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
					[
						'title' => __('HTML', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
					[
						'title' => __('CSS', 'skt-addons-for-elementor'),
						'image' => [
							'url' => Utils::get_placeholder_image_src(),
						],
					],
		...
		$this->add_group_control(
			...
			[
				'label' => __('Foreground Image Size', 'skt-addons-for-elementor'),
				'name' => 'thumbnail',
				'default' => 'thumbnail',
				'separator' => 'before',
			]
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'slide_style',
			[
				'label' => __('Slide Style', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'skt-vertical' => [
						'title' => __('Vertical', 'skt-addons-for-elementor'),
						'icon' => 'eicon-navigation-vertical',
					],
					'skt-horizontal' => [
						'title' => __('Horizontal', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			'h_slide_direction',
			[
				'label' => __('Slide direction', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
		...
		$this->add_control(
			'speed',
			[
				'label' => __('Slide Speed', 'skt-addons-for-elementor'),
				'description' => __('Autoplay speed in seconds. Default 30', 'skt-addons-for-elementor'),
	...
	protected function __wrapper_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Wrapper', 'skt-addons-for-elementor'),
	...
	protected function __image_box_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Image Box', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' );?>>
			...
			for ( $i = 1; $i <= 10; $i++ ) :
				foreach ($settings['scroll_items'] as $index => $value) :
					...
					?>
                    <<?php echo wp_kses_post(skt_addons_elementor_escape_tags($item_tag, 'span',['a']) . ' ' . $this->get_render_attribute_string($repeater_key)); ?>>
						<?php
						if ( ! empty( $image ) ) {
						...
						?>
					</<?php echo wp_kses_post(skt_addons_elementor_escape_tags($item_tag, 'span',['a'])); ?>>
				<?php endforeach;
			endfor;
			?>
			</div>
