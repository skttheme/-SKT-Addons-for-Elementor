...
class Step_Flow extends Base {
	...
	public function get_title() {
		return __( 'Step Flow', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_step',
			[
				'label' => __( 'Step Flow', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Badge', 'skt-addons-for-elementor' ),
				'description' => __( 'Keep it blank, if you want to remove the Badge', 'skt-addons-for-elementor' ),
				'default' => __( 'Step 1', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			'show_indicator',
			[
				'label' => __( 'Show Direction', 'skt-addons-for-elementor' ),
	...
	protected function __direction_style_controls() {
		...
		$this->add_responsive_control(
			'direction_angle',
			[
				'label' => __( 'Angle', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['deg'],
				'default' => [
					'unit' => 'deg',
