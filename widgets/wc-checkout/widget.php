...
class WC_Checkout extends Base {
	...
	public function get_title() {
		return __( 'WC Checkout', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'1'   => [
						'title' => __( 'One Column', 'skt-addons-for-elementor' ),
						'icon'  => 'eicon-section',
					],
					'2' => [
						'title' => __( 'Two Columns', 'skt-addons-for-elementor' ),
						'icon'  => 'eicon-column',
					],
				],
		...
		$this->add_control(
			'columns_stack',
			[
				'label'   => __( 'Stack On', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'tablet',
				'options' => [
					'tablet'   => [
						'title' => __( 'Stack on tablet', 'skt-addons-for-elementor' ),
						'icon'  => 'eicon-device-tablet',
					],
					'mobile' => [
						'title' => __( 'Stack on mobile', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'first_column_width',
			[
				'label'      => __( 'First Column Width', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'devices'    => [ 'desktop', 'tablet' ],
				'default'    => [
	...
	protected function __inputs_style_controls() {
		...
		$this->add_responsive_control(
			'textarea_height',
			[
				'label'   => __( 'Textarea Height', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SLIDER,
				'selectors' => [
	...
	protected function __coupon_bar_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Coupon Bar', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Links Hover Color', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function __coupon_apply_box_style_controls() {
		...
		$this->start_controls_section(
			'form_coupon_style',
			[
				'label'                 => __( 'Coupon Box', 'skt-addons-for-elementor' ),
				'tab'                   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Input', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => __( 'Input Width', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::SLIDER,
				'default'               => [
					'size' => '',
				],
		...
		$this->add_control(
			...
			[
				'label'                 => __( 'Coupon Button', 'skt-addons-for-elementor' ),
				'type'                  => Controls_Manager::HEADING,
				'separator'				=> 'before',
			]
		);
	...
	protected function __billing_details_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Billing Details', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Section', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Input Label', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Additional Information', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Textarea', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Textarea Label', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Review Order', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Body', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Table Border', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Payment Method', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Message', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Privacy Policy', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'full'   => __( 'Full Width', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'button_custom_width',
			[
				'label'      => __( 'Custom Width', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
	...
	public static function show_wc_missing_alert() {
		if ( current_user_can( 'activate_plugins' ) ) {
			printf(
				...
				esc_attr__( 'WooCommerce is missing! Please install and activate WooCommerce.', 'skt-addons-for-elementor' )
				);
		}
	}
	...
	protected function render() {
		...
		echo skt_addons_elementor_do_shortcode( 'woocommerce_checkout' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
	}
}