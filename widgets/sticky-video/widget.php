...
class Sticky_Video extends Base {
    ...
    public function get_title() {
        return __( 'Sticky Video', 'skt-addons-for-elementor' );
    }
    ...
    protected function __video_content_controls() {
		...
		$this->start_controls_section(
			'_section_video',
			[
				'label' => __( 'Video', 'skt-addons-for-elementor' ),
            ]
		);
        ...
        $this->add_control(
            'video_type',
            [
                'label'   => __( 'Video Type', 'skt-addons-for-elementor' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'youtube',
                'options' => [
                    'youtube' => __( 'YouTube', 'skt-addons-for-elementor' ),
                    'vimeo'   => __( 'Vimeo', 'skt-addons-for-elementor' ),
                    'self_hosted'  => __( 'Self Hosted', 'skt-addons-for-elementor' ),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'raw'             => sprintf( __( '<p style="word-break: break-word;"><b>Note:</b> Make sure you add the actual URL of the video and not the share URL.</br></br><b>Valid:</b>&nbsp;https://www.youtube.com/watch?v=XHOmBV4js_E</br><b>Invalid:</b>&nbsp;https://youtu.be/XHOmBV4js_E</p>', 'skt-addons-for-elementor' ) ),
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '<b>Note:</b> Make sure you add the actual URL of the video and not the categorized URL.</br></br><b>Valid:</b>&nbsp;https://vimeo.com/235215203</br><b>Invalid:</b>&nbsp;https://vimeo.com/channels/skt/235215203', 'skt-addons-for-elementor' ) ),
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                'condition'       => [
                    'video_type' => 'vimeo',
                ],
        ...
        $this->add_control(
            'allow_remote_url',
            [
                'label' => __('Remote URL', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __('Enter your URL', 'skt-addons-for-elementor'),
                'label_block' => true,
                'show_label' => false,
                'condition' => [
                    'video_type' => 'self_hosted',
        ...
        $this->add_control(
            ...
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '<b>Note:</b> Make sure that, the remote URL contain video extension at the end. e.g. .mp4, .mkv, .webm etc.', 'skt-addons-for-elementor' ) ),
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
                'condition' => [
                    'video_type' => 'self_hosted',
                    'allow_remote_url' => 'yes',
        ...
        $this->add_control(
            'hosted_url',
            [
                'label' => __('Choose File', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'heading_video_opt',
            [
                'label'     => __( 'Video Options', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'mute',
            [
                'label'     => __( 'Mute', 'skt-addons-for-elementor' ),
                'type'      => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'loop',
            [
                'label'     => __( 'Loop', 'skt-addons-for-elementor' ),
                'type'      => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'start',
            [
                'label'       => __( 'Start Time', 'skt-addons-for-elementor' ),
                'type'        => Controls_Manager::NUMBER,
                'description' => __( 'Specify a start time (in seconds)', 'skt-addons-for-elementor' ),
                'condition'   => [
        ...
        $this->add_control(
            'end',
            [
                'label'       => __( 'End Time', 'skt-addons-for-elementor' ),
                'type'        => Controls_Manager::NUMBER,
                'description' => __( 'Specify an end time (in seconds)', 'skt-addons-for-elementor' ),
                'condition'   => [
                    'video_type' => [ 'youtube', 'self_hosted' ],
                ],
            ]
        ...
        $this->add_control(
            'aspect_ratio',
            [
                'label'        => __( 'Aspect Ratio', 'skt-addons-for-elementor' ),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    '' => 'Null',
                    '16:9' => '16:9',
        ...
        $this->add_control(
            'control_bar',
            [
                'label' => __('Control Bar', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_block' => false,
				'default' => 'yes',
    ...
    protected function __overlay_content_controls() {
        ...
        $this->add_control(
            'overlay_play_icon',
            [
                'label' => __('Play Icon', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_block' => false,
                'return_value' => 'yes',
                'default' => 'yes',
        ...
        $this->add_control(
            'play_icon',
            [
                'label' => esc_html__('Choose Icon', 'skt-addons-for-elementor'),
    ...
    protected function __settings_content_controls() {
        ...
        $this->start_controls_section(
            'section_sticky',
            [
                'label' => __('Sticky Settings', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
    ...
    protected function __sticky_box_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Sticky Box', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Close Button Color', 'skt-addons-for-elementor'),
    ...
    protected function __player_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Player', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Play Button', 'skt-addons-for-elementor' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Interface Color', 'skt-addons-for-elementor' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Color One', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Color Two', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Bar', 'skt-addons-for-elementor' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'control_bar' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Bar Padding', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Bar Margin', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px'],
                'condition' => [
                    'control_bar' => 'yes',
    ...
    protected function __overlay_style_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Play Button Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Play Button Size', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
    ...
    protected function render() {
        ...
        $player_settings = wp_json_encode($player_settings);
