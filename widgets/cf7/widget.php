...
class CF7 extends Base {
    ...
    public function get_title() {
        return __( 'Contact Form 7', 'skt-addons-for-elementor' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_cf7',
			[
				'label' => skt_addons_elementor_is_cf7_activated() ? __( 'Contact Form 7', 'skt-addons-for-elementor' ) : __( 'Missing Notice', 'skt-addons-for-elementor' ),
        ...
        if ( ! skt_addons_elementor_is_cf7_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => '' ] + \skt_addons_elementor_get_cf7_forms(),
				]
			);
			...
			$this->add_control(
				'html_class',
				[
					'label' => __( 'HTML Class', 'skt-addons-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'label_block' => true,
					'description' => __( 'Add CSS custom class to the form.', 'skt-addons-for-elementor' ),
				]
			);
    ...
    protected function render() {
        if ( ! skt_addons_elementor_is_cf7_activated() ) {
			skt_addons_elementor_show_plugin_missing_alert(__( 'Contact Forms 7', 'skt-addons-for-elementor' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo skt_addons_elementor_do_shortcode( 'contact-form-7', [ // phpcs:ignore  WordPress.Security.EscapeOutput.OutputNotEscaped
                'id' => $settings['form_id'],
