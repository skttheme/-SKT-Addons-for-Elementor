...
class Dual_Button extends Base {
    ...
    public function get_title() {
        return __( 'Dual Button', 'skt-addons-for-elementor' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            '_section_button',
            [
                'label' => __( 'Dual Buttons', 'skt-addons-for-elementor' ),
        ...
        $this->start_controls_tab(
            '_tab_button_primary',
            [
                'label' => __( 'Primary', 'skt-addons-for-elementor' ),
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __( 'Connector', 'skt-addons-for-elementor' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hide Connector?', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Hide', 'skt-addons-for-elementor' ),
                'label_off' => __( 'Show', 'skt-addons-for-elementor' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Connector Type', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'text' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Text', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Or', 'skt-addons-for-elementor' ),
                'condition' => [
                    'button_connector_hide!' => 'yes',
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => __( 'Secondary', 'skt-addons-for-elementor' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    'queue' => [
                        'title' => __( 'Queue', 'skt-addons-for-elementor' ),
                        'icon' => 'eicon-navigation-horizontal',
                    ],
                    'stack' => [
                        'title' => __( 'Stack', 'skt-addons-for-elementor' ),
    ...
    protected function __common_style_controls() {
		...
		$this->add_responsive_control(
            'button_gap',
            [
                'label' => __( 'Space Between Buttons', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
    ...
    protected function __primary_btn_style_controls() {
		...
		$this->start_controls_section(
            ...
            [
                'label' => __( 'Primary Button', 'skt-addons-for-elementor' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
		);
    ...
    protected function __connector_style_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __( 'Connector is hidden now, please enable connector from Content > Connector tab.', 'skt-addons-for-elementor' ),
    ...
    protected function __secondary_btn_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Secondary Button', 'skt-addons-for-elementor' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
