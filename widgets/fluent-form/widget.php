...
class Fluent_Form extends Base {
    ...
    public function get_title() {
        return __( 'Fluent Form', 'skt-addons-for-elementor' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => skt_addons_elementor_is_fluent_form_activated() ? __( 'Fluent Form', 'skt-addons-for-elementor' ) : __( 'Missing Notice', 'skt-addons-for-elementor' ),
        ...
        if ( ! skt_addons_elementor_is_fluent_form_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( 'Select a Form', 'skt-addons-for-elementor' ) ] + \skt_addons_elementor_get_fluent_forms(),
				]
			);
    ...
    protected function __fields_style_controls() {
        ...
        $this->add_responsive_control(
            'field_margin',
            [
                'label' => __( 'Spacing Bottom', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Placeholder Text Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function __fields_label_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Check Box Label Color', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'help_text_heading',
			[
				'label' => __( 'Help Text', 'skt-addons-for-elementor' ),
    ...
    protected function render() {
        if ( ! skt_addons_elementor_is_fluent_form_activated() ) {
			skt_addons_elementor_show_plugin_missing_alert(__( 'Fluent Form', 'skt-addons-for-elementor' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo skt_addons_elementor_do_shortcode( 'fluentform', [ // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                'id' => $settings['form_id'],
			] );
        }
    }
