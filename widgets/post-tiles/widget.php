...
class Post_Tiles extends Base {
	...
	public function get_title() {
		return __( 'Post Tiles', 'skt-addons-for-elementor' );
	}
	...
	protected static function get_tiles_layout_options() {
		...
		for ( $i = 1; $i <= 12; ++$i ) {
			$options[$i] = [
				/* translators: translate layout title */
				'title' => sprintf( esc_attr__( 'Layout %s', 'skt-addons-for-elementor' ), $i ),
				'url' => $dir . "tiles{$i}.svg",
			];
		}
	...
	protected function __layout_content_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Excerpt & Badge', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function __tiles_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Tiles', 'skt-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'tiles_gap',
			[
				'label' => __( 'Tiles Gap', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Overlay (On hover)', 'skt-addons-for-elementor' ),
				'separator' => 'before',
			]
		);
	...
	protected function __title_excerpt_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Title & Excerpt', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
