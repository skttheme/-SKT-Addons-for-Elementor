...
class Author_List extends Base {
    ...
    public function get_title() {
        return __( 'Author List', 'skt-addons-for-elementor' );
    }
    ...
    protected function register_content_controls() {
		...
		$this->start_controls_section(
            '_author_list',
            [
                'label' => __( 'Author List', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
                    'display_name' => __( 'Display Name', 'skt-addons-for-elementor' ),
                    'first_name' => __( 'First Name', 'skt-addons-for-elementor' ),
                    'last_name' => __( 'Last Name', 'skt-addons-for-elementor' ),
                    'nickname' => __( 'Nick Name', 'skt-addons-for-elementor' ),
                    'user_nicename' => __( 'User Nice Name', 'skt-addons-for-elementor' )
                ],
        ...
        $this->add_control(
			'author_avatar_size',
			[
				'label' => __( 'Avatar Size', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'condition' => [
                    'author_avatar' => 'yes'
                ],
				'options' => [
                    '25' => __( '25 x 25', 'skt-addons-for-elementor' ),
                    '35' => __( '35 x 35', 'skt-addons-for-elementor' ),
                    '45' => __( '45 x 45', 'skt-addons-for-elementor' ),
                    '60' => __( '60 x 60', 'skt-addons-for-elementor' ),
                    '80' => __( '80 x 80', 'skt-addons-for-elementor' ),
                    '150' => __( '150 x 150', 'skt-addons-for-elementor' )
                ],
				'default' => '45',
			]
        );
        ...
        $this->add_control(
			'author_post_count',
			[
				'label' => __( 'Post Count', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Post Count Text', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'default' => __( 'Post Count ', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Post Count Text', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
        ...
        $this->add_control(
			'author_description',
			[
				'label' => __( 'Author Bio', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Archive Link in Name', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => __( 'Website Link in Image/Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            'list_position',
            [
                'label' => __( 'List Position', 'skt-addons-for-elementor' ),
        ...
        $this->add_control(
            'avatar_position',
            [
                'label' => __( 'Avatar Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'inline' => [
        ...
        $this->add_control(
            'post_count_position',
            [
                'label' => __( 'Post Count Position', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'inline' => [
    ...
    protected function __author_style_controls() {
        ...
        $this->start_controls_section(
            'author_style',
            [
                'label' => __( 'Author', 'skt-addons-for-elementor' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Border Radius 123456', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'condition' => [
                    'author_avatar' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Icon Hover Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'author_avatar!' => 'yes',
        ...
        $this->add_control(
			...
			[
				...
				'raw' => __( '<strong>Post Count</strong> is Switched off from "Author List" content section', 'skt-addons-for-elementor' ),
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'raw' => __( '<strong>Email</strong> is Switched off from "Author List" content section', 'skt-addons-for-elementor' ),
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'raw' => __( '<strong>Author Bio</strong> is Switched off from "Author List" content section', 'skt-addons-for-elementor' ),
			]
		);
    ...
    protected function render() {
        ...
        if ( empty( $author_ids ) ) {
            ...
            printf( '<div class="skt-author-list-error"><strong>%s</strong> %s</div>', esc_attr($settings['post_type']), esc_html( ' post type don\'t have any post.', 'skt-addons-for-elementor' ) );
            return;
        }
                               ...
                               <div class="skt-author-list-name-text">
                                ...
                                <?php if ( $settings['author_post_count'] == 'yes' ) : ?>
                                    <div class="skt-author-list-post-count">
                                        ...
                                        echo esc_html( $author_id['post_count'], 'skt-addons-for-elementor' );
                                        ?>
                                    </div>
                                <?php endif; ?>
                            </div>
