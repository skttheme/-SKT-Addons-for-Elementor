...
class Photo_Stack extends Base {
    ...
    public function get_title() {
        return __('Photo Stack', 'skt-addons-for-elementor');
    }
    ...
    protected function __photo_stack_content_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __('Photo Stack', 'skt-addons-for-elementor'),
        ...
        $repeater->add_responsive_control(
            'image_z_index',
            [
                'label'     => esc_html__('Z-Index', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Infinite Animation', 'skt-addons-for-elementor'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    ''                    => __('None', 'skt-addons-for-elementor'),
                    'skt-bounce-sm'        => __('Bounce Small', 'skt-addons-for-elementor'),
                    'skt-bounce-md'        => __('Bounce Medium', 'skt-addons-for-elementor'),
                    'skt-bounce-lg'        => __('Bounce Large', 'skt-addons-for-elementor'),
                    'skt-fade'             => __('Fade', 'skt-addons-for-elementor'),
                    'skt-rotating'         => __('Rotating', 'skt-addons-for-elementor'),
                    'skt-rotating-inverse' => __('Rotating inverse', 'skt-addons-for-elementor'),
                    'skt-scale-sm'         => __('Scale Small', 'skt-addons-for-elementor'),
                    'skt-scale-md'         => __('Scale Medium', 'skt-addons-for-elementor'),
                    'skt-scale-lg'         => __('Scale Large', 'skt-addons-for-elementor'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'fly-sm'           => __('Fly Small', 'skt-addons-for-elementor'),
                    'fly'              => __('Fly Medium', 'skt-addons-for-elementor'),
                    'fly-lg'           => __('Fly Large', 'skt-addons-for-elementor'),
                    'scale-sm'         => __('Scale Small', 'skt-addons-for-elementor'),
                    'scale'            => __('Scale Medium', 'skt-addons-for-elementor'),
                    'scale-lg'         => __('Scale Large', 'skt-addons-for-elementor'),
                    'scale-inverse-sm' => __('Scale Inverse Small', 'skt-addons-for-elementor'),
                    'scale-inverse'    => __('Scale Inverse Medium', 'skt-addons-for-elementor'),
                    'scale-inverse-lg' => __('Scale Inverse Large', 'skt-addons-for-elementor'),
                ],
                'default'   => 'scale-sm',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Please set your animation speed in seconds. Default value is 6s.', 'skt-addons-for-elementor'),
                'type'        => Controls_Manager::NUMBER,
                'min'         => 0,
                'max'         => 100,
                'step'        => 1,
    ...
    protected function __photo_stack_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Minimum Height', 'skt-addons-for-elementor'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'vh', 'em'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::SELECT,
                'options'   => array(
                    'visible' => __('Visible', 'skt-addons-for-elementor'),
                    'hidden'  => __('Hidden', 'skt-addons-for-elementor'),
                    'scroll'  => __('Scroll', 'skt-addons-for-elementor'),
                ),
                'default'   => 'visible',
                'selectors' => array(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __('Box Shadow Hover', 'skt-addons-for-elementor'),
