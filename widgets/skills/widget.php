...
class Skills extends Base {
    ...
    public function get_title() {
        return __( 'Skill Bars', 'skt-addons-for-elementor' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
            '_section_skills',
            [
                'label' => __( 'Skills', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Design', 'skt-addons-for-elementor' ),
                'placeholder' => __( 'Type a skill name', 'skt-addons-for-elementor' ),
            ]
        );
        ...
        $repeater->add_control(
            'level',
            [
                'label' => __( 'Level (Out Of 100)', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'return_value' => 'yes',
                'description' => __( 'You can customize this skill bar color from here or customize from Style tab', 'skt-addons-for-elementor' ),
                'style_transfer' => true,
            ]
        );
        ...
        $repeater->add_control(
            'level_color',
            [
                'label' => __( 'Level Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $repeater->add_control(
            'base_color',
            [
                'label' => __( 'Base Color', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => __( 'Text Position', 'skt-addons-for-elementor' ),
                'separator' => 'before',
                'default' => 'inside',
                'options' => [
                    'inside' => __( 'Text Inside', 'skt-addons-for-elementor' ),
                    'outside' => __( 'Text Outside', 'skt-addons-for-elementor' ),
                ],
                'style_transfer' => true,
            ]
        );
    ...
    protected function __bars_style_controls() {
		...
		$this->start_controls_section(
            '_section_style_bars',
            [
                'label' => __( 'Skill Bars', 'skt-addons-for-elementor' ),
