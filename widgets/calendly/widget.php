...
class Calendly extends Base {
	...
	public function get_title() {
		return __( 'Calendly', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_calendly',
			[
				'label' => __( 'Calendly', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'calendly_username',
			[
				'label'       => __( 'Username', 'skt-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => 'sittestaccount',
				'placeholder' => __( 'Type calendly username here', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'calendly_time',
			[
				'label'   => __( 'Time Slot', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'15min' => __( '15 Minutes', 'skt-addons-for-elementor' ),
					'30min' => __( '30 Minutes', 'skt-addons-for-elementor' ),
					'60min' => __( '60 Minutes', 'skt-addons-for-elementor' ),
					'' => __( 'All', 'skt-addons-for-elementor' ),
				],
				'default' => '30min'
			]
		);
		...
		$this->add_control(
			'event_type_details',
			[
				'label'        => __( 'Hide Event Type Details', 'skt-addons-for-elementor' ),
	...
	protected function register_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf(
					/* translators: translate raw text */ __( 'The following color customization controls only work with %1$s. Basic and Premium plan users cannot customize colors as per Calendy pricing plan. For more information please %2$s.', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'button_link_color',
			[
				'label' => __( 'Button & Link Color', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::COLOR,
			]
		);
	...
	protected function render() {
		...
		<?php if ( $settings['calendly_username'] ): ?>
            <div class="calendly-inline-widget"
                ...
                <?php echo'<script type="text/javascript" src="https://assets.calendly.com/assets/external/widget.js"></script>'; // phpcs:ignore WordPress.WP.EnqueuedResources.NonEnqueuedScript ?>
