...
class Logo_Grid extends Base {
    ...
    public function get_title() {
        return __('Logo Grid', 'skt-addons-for-elementor');
    }
    ...
    protected function __logo_content_controls() {
        ...
        $this->start_controls_section(
            '_section_logo',
            [
                'label' => __( 'Logo Grid', 'skt-addons-for-elementor' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Brand Name', 'skt-addons-for-elementor' ),
            ]
        );
    ...
    protected function __settings_content_controls() {
        ...
        $this->add_control(
            'layout',
            [
                'label' => __( 'Grid Layout', 'skt-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => __( 'Box', 'skt-addons-for-elementor' ),
                    'border' => __( 'Border', 'skt-addons-for-elementor' ),
                    'tictactoe' => __( 'Tic Tac Toe', 'skt-addons-for-elementor' ),
                ],
                'default' => 'box',
                ...
                <<?php echo wp_kses_post($tag); ?> <?php $this->print_render_attribute_string( $repeater_key ); ?>>
                    ...
                    <?php if ( $image ) :
                            ...
                            printf( '<img class="skt-logo-grid-img elementor-animation-%s" src="%s" alt="%s">',
                                ...
                                wp_kses_post(Utils::get_placeholder_image_src()), 
                                esc_attr( $item['name'] )
                                );
                        endif; ?>
                    </figure>
