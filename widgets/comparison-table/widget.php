...
class Comparison_Table extends Base {
	...
	public function get_title() {
		return __( 'Comparison Table', 'skt-addons-for-elementor' );
	}
	...
	protected function __table_head_content_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'placeholder' => __( 'Column Name', 'skt-addons-for-elementor' ),
				'default'     => __( 'Column', 'skt-addons-for-elementor' ),
				'dynamic'     => [
					'active' => true,
				],
			]
		...
		$repeater->add_responsive_control(
			'column_width',
			[
				'label'      => __( 'Column Width', 'skt-addons-for-elementor' ),
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'options'     => [
					'none' => [
						'title' => __( 'None', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default'       => [
					[
						'column_name' => __( 'Features', 'skt-addons-for-elementor' ),
						'column_media' => 'icon',
						'column_icons' => [
							'value'   => 'fa fa-rocket',
							'library' => 'fa-solid',
					...
					[
						'column_name' => __( 'Free', 'skt-addons-for-elementor' ),
						'column_media' => 'icon',
						'column_icons' => [
					...
					[
						'column_name' => __( 'Pro', 'skt-addons-for-elementor' ),
						'column_media' => 'icon',
						'column_icons' => [
		...
		$this->add_control(
			'sticky_table_header',
			[
				'label'        => __( 'Sticky Header?', 'skt-addons-for-elementor' ),
	...
	protected function __table_row_content_controls() {
		...
		$this->start_controls_section(
			'_section_table_row',
			[
				'label' => __( 'Table Row', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->add_control(
			'row_column_type',
			[
				'label'   => __( 'Row/Column', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'row',
				'options' => [
					'row'    => __( 'Row', 'skt-addons-for-elementor' ),
					'column' => __( 'Column', 'skt-addons-for-elementor' ),
				],
			]
		);
		...
		// 	'column_content_type',
		// 	[
		// 		'label'     => __( 'Column Content Type', 'skt-addons-for-elementor' ),
		// 		'type'      => Controls_Manager::SELECT,
		// 		'default'   => 'text',
		// 		'options'   => [
		// 			'text' => __( 'Text', 'skt-addons-for-elementor' ),
		// 			'icon' => __( 'Icon', 'skt-addons-for-elementor' ),
		// 			'blank' => __( 'Blank', 'skt-addons-for-elementor' ),
		// 		],
		// 		'condition' => [
		// 			'row_column_type!' => 'row',
		// 		],
		...
		$repeater->add_control(
			...
			[
				...
				'options'     => [
					'blank' => [
						'title' => __( 'Blank', 'skt-addons-for-elementor' ),
						'icon'  => 'eicon-editor-close',
					],
					'text' => [
			...
			[
				...
				'default'      => [
					...
					[
						'row_column_type'     => 'column',
						'column_content_type' => 'text',
						'column_text'         => __( 'Ready Blocks', 'skt-addons-for-elementor' ),
					],
					[
						'row_column_type'     => 'column',
						'column_content_type' => 'icon',
					...
					[
						'row_column_type'     => 'column',
						'column_content_type' => 'text',
						'column_text'         => __( 'Ready Pages', 'skt-addons-for-elementor' ),
					],
					[
						'row_column_type'     => 'column',
						'column_content_type' => 'text',
						'column_text'         => __( '150', 'skt-addons-for-elementor' ),
					],
					[
						'row_column_type'     => 'column',
						'column_content_type' => 'text',
						'column_text'         => __( '250', 'skt-addons-for-elementor' ),
					],
				],
	...
	protected function __table_btn_content_controls() {
		...
		$this->start_controls_section(
			'_section_table_btn',
			[
				'label' => __( 'Table Button', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Title', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Buy Now', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'table_btns',
			[
				'label' => __( 'Buttons', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'btn_title'     => __( 'Download', 'skt-addons-for-elementor' ),
						'link' => [
							'url' => '#',
							'is_external' => true,
							'nofollow' => true,
					...
					[
						'btn_title'     => __( 'Buy Now', 'skt-addons-for-elementor' ),
						'link' => [
							'url' => '#',
							'is_external' => true,
							'nofollow' => true,
		...
		$this->add_control(
			'more_options',
			[
				'label' => __( 'Button Settings', 'skt-addons-for-elementor' ),
	...
	protected function __settings_content_controls() {
		$this->start_controls_section(
			'__settings_content',
			[
				'label' => __( 'Table Settings', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'table_width',
			[
				'label' => __( 'Table Width', 'skt-addons-for-elementor' ),
				'type'  => Controls_Manager::SLIDER,
				'size_units' => ['%', 'px'],
				'range'      => [
					'%'  => [
	...
	protected function __table_head_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'  => __( 'If you\'ve added <strong>Custom Style</strong> then Icon Color will be over written for that cell.', 'skt-addons-for-elementor' ),
	...
	protected function __table_row_style_controls() {
		...
		$this->add_responsive_control(
			'table_row_padding',
			[
				'label'      => __( 'Row Padding', 'skt-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Background Color (Even)', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Background Color (Odd)', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'row_color_even',
			[
				'label'     => __( 'Color (Even)', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'row_color_odd',
			[
				'label'     => __( 'Color (Odd)', 'skt-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::RAW_HTML,
				'separator' => 'before',
				'raw'       => __( 'If you\'ve added <strong>Custom Style</strong> then Background Color, Color, Icon Size, Icon Color will be over written for that cell.', 'skt-addons-for-elementor' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
				'render_type' => 'ui',
			]
		);
