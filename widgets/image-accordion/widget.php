...
class Image_Accordion extends Base {
    ...
    public function get_title() {
        return __('Image Accordion', 'skt-addons-for-elementor');
    }
    ...
    protected function content_common() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => __('Accordion Label', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'rows' => 5,
                'label_block' => true,
                'default' => __('Image Accordion', 'skt-addons-for-elementor'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $repeater->add_control(
            'icon',
            [
                'label' => __('Title Icon', 'skt-addons-for-elementor'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __('Image accordion content.', 'skt-addons-for-elementor'),
        ...
        $repeater->add_control(
            'enable_button',
            [
                'label'        => __('Enable Button', 'skt-addons-for-elementor'),
        ...
        $repeater->add_control(
            'button_label',
            [
                'label'   => __('Button Label', 'skt-addons-for-elementor'),
                'type'    => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'enable_popup',
            [
                'label'        => __('Enable Popup', 'skt-addons-for-elementor'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Yes', 'skt-addons-for-elementor'),
                'label_off'    => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'popup_icon',
            [
                'label' => __('Popup Icon', 'skt-addons-for-elementor'),
                'type'  => Controls_Manager::ICONS,
                'label_block' => false,
                'default' => [
        ...
        $repeater->add_control(
            'enable_link',
            [
                'label'        => __('Enable Link', 'skt-addons-for-elementor'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Yes', 'skt-addons-for-elementor'),
                'label_off'    => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
        ...
        $repeater->add_control(
            'link_url',
            [
                'label'   => __('Link URL', 'skt-addons-for-elementor'),
                'type'    => Controls_Manager::URL,
                'condition' => [
                    'enable_link' => 'yes',
                ],
        ...
        $repeater->add_control(
            'link_icon',
            [
                'label' => __('Link Icon', 'skt-addons-for-elementor'),
                'type'  => Controls_Manager::ICONS,
                'label_block' => false,
                'default' => [
        ...
        $this->add_control(
            'accordion_items',
            [
                'label'         => __('Items', 'skt-addons-for-elementor'),
                'type'          => Controls_Manager::REPEATER,
                'fields'        => $repeater->get_controls(),
                'prevent_empty' => true,
                'default'       => [
                    [
                        'label'         => __('Accordion Label', 'skt-addons-for-elementor'),
                        'title'         => __('Image Accordion 1', 'skt-addons-for-elementor'),
                        'description'         => __('Image accordion content.', 'skt-addons-for-elementor'),
                        'enable_button'  => 'yes',
                        'active'        => 'yes',
                    ],
                    [
                        'label'         => __('Accordion Label', 'skt-addons-for-elementor'),
                        'title'         => __('Image Accordion 2', 'skt-addons-for-elementor'),
                        'description'         => __('Image accordion content.', 'skt-addons-for-elementor'),
                        'enable_button'  => 'yes',
                    ],
                    [
                        'label'         => __('Accordion Label', 'skt-addons-for-elementor'),
                        'title'         => __('Image Accordion 3', 'skt-addons-for-elementor'),
                        'description'         => __('Image accordion content.', 'skt-addons-for-elementor'),
                        'enable_button'  => 'yes',
                    ],
                    [
                        'label'         => __('Accordion Label', 'skt-addons-for-elementor'),
                        'title'         => __('Image Accordion 4', 'skt-addons-for-elementor'),
                        'description'         => __('Image accordion content.', 'skt-addons-for-elementor'),
                        'enable_button'  => 'yes',
                    ],
                ],
        ...
        $this->add_responsive_control(
            'items_style',
            [
                'label'         => esc_html__('Style', 'skt-addons-for-elementor'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
        ...
        $this->add_control(
            'active_behavior',
            [
                'label'         => esc_html__('Active Behavior', 'skt-addons-for-elementor'),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    'click' => esc_html__('Click', 'skt-addons-for-elementor'),
                    'hover' => esc_html__('Hover', 'skt-addons-for-elementor'),
                ],
                'default'       => 'click',
        ...
        $this->add_control(
            ...
            [
                'raw' => '<strong>' . esc_html__('Please note!', 'skt-addons-for-elementor') . '</strong> ' . esc_html__('Active on load won\'t be working with this active behavior.', 'skt-addons-for-elementor'),
        ...
        $this->add_control(
            'content_animation',
            [
                'label'        => __('Enable Content Animation?', 'skt-addons-for-elementor'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => __('Yes', 'skt-addons-for-elementor'),
                'label_off'    => __('No', 'skt-addons-for-elementor'),
                'return_value' => 'yes',
    ...
    protected function style_common() {
        ...
        $this->add_responsive_control(
            'image_gutter',
            [
                'label' => __('Gutter', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'image_radius',
            [
                'label' => __('Radius', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
    ...
    protected function style_title() {
        ...
        $this->add_responsive_control(
            'title_margin',
            [
                'label' => esc_attr__('Margin', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Space Between Title Icon', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
    ...
    protected function style_actions() {
        $this->start_controls_section(
            ...
            [
                'label' => __('Actions', 'skt-addons-for-elementor'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Popup Icon Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Popup Background Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Popup Border Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Link Icon Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'before',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Link Background Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Link Border Color', 'skt-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'action_icon_border_border!' => ''
                ],
