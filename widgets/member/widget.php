...
class Member extends Base {
	...
	public function get_title() {
		return __( 'Team Member', 'skt-addons-for-elementor' );
	}
	...
	protected static function get_profile_names() {
		return [
			'500px'          => __( '500px', 'skt-addons-for-elementor' ),
			'apple'          => __( 'Apple', 'skt-addons-for-elementor' ),
			'behance'        => __( 'Behance', 'skt-addons-for-elementor' ),
			'bitbucket'      => __( 'BitBucket', 'skt-addons-for-elementor' ),
			'codepen'        => __( 'CodePen', 'skt-addons-for-elementor' ),
			'delicious'      => __( 'Delicious', 'skt-addons-for-elementor' ),
			'deviantart'     => __( 'DeviantArt', 'skt-addons-for-elementor' ),
			'digg'           => __( 'Digg', 'skt-addons-for-elementor' ),
			'dribbble'       => __( 'Dribbble', 'skt-addons-for-elementor' ),
			'email'          => __( 'Email', 'skt-addons-for-elementor' ),
			'facebook'       => __( 'Facebook', 'skt-addons-for-elementor' ),
			'flickr'         => __( 'Flicker', 'skt-addons-for-elementor' ),
			'foursquare'     => __( 'FourSquare', 'skt-addons-for-elementor' ),
			'github'         => __( 'Github', 'skt-addons-for-elementor' ),
			'houzz'          => __( 'Houzz', 'skt-addons-for-elementor' ),
			'instagram'      => __( 'Instagram', 'skt-addons-for-elementor' ),
			'jsfiddle'       => __( 'JS Fiddle', 'skt-addons-for-elementor' ),
			'linkedin'       => __( 'LinkedIn', 'skt-addons-for-elementor' ),
			'medium'         => __( 'Medium', 'skt-addons-for-elementor' ),
			'pinterest'      => __( 'Pinterest', 'skt-addons-for-elementor' ),
			'product-hunt'   => __( 'Product Hunt', 'skt-addons-for-elementor' ),
			'reddit'         => __( 'Reddit', 'skt-addons-for-elementor' ),
			'slideshare'     => __( 'Slide Share', 'skt-addons-for-elementor' ),
			'snapchat'       => __( 'Snapchat', 'skt-addons-for-elementor' ),
			'soundcloud'     => __( 'SoundCloud', 'skt-addons-for-elementor' ),
			'spotify'        => __( 'Spotify', 'skt-addons-for-elementor' ),
			'stack-overflow' => __( 'StackOverflow', 'skt-addons-for-elementor' ),
			'tripadvisor'    => __( 'TripAdvisor', 'skt-addons-for-elementor' ),
			'tumblr'         => __( 'Tumblr', 'skt-addons-for-elementor' ),
			'twitch'         => __( 'Twitch', 'skt-addons-for-elementor' ),
			'twitter'        => __( 'Twitter', 'skt-addons-for-elementor' ),
			'vimeo'          => __( 'Vimeo', 'skt-addons-for-elementor' ),
			'vk'             => __( 'VK', 'skt-addons-for-elementor' ),
			'website'        => __( 'Website', 'skt-addons-for-elementor' ),
			'whatsapp'       => __( 'WhatsApp', 'skt-addons-for-elementor' ),
			'wordpress'      => __( 'WordPress', 'skt-addons-for-elementor' ),
			'xing'           => __( 'Xing', 'skt-addons-for-elementor' ),
			'yelp'           => __( 'Yelp', 'skt-addons-for-elementor' ),
			'youtube'        => __( 'YouTube', 'skt-addons-for-elementor' ),
		];
	}
	...
	protected function __info_content_controls() {
		...
		$this->start_controls_section(
			'_section_info',
			[
				'label' => __( 'Information', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Photo', 'skt-addons-for-elementor' ),
				'show_label' => false,
		...
		$this->add_control(
			'image2',
			[
				'label' => __( 'Photo 2', 'skt-addons-for-elementor' ),
				'show_label' => false,
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Name', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'default' => 'SKT Member Name',
				'placeholder' => __( 'Type Member Name', 'skt-addons-for-elementor' ),
				'separator' => 'before',
				'dynamic' => [
					'active' => true,
				]
		...
		$this->add_control(
			'job_title',
			[
				'label' => __( 'Job Title', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'default' => __( 'SKT Officer', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type Member Job Title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			'bio',
			[
				'label' => __( 'Short Bio', 'skt-addons-for-elementor' ),
				'description' => skt_addons_elementor_get_allowed_html_desc( 'intermediate' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Write something amazing about the skt member', 'skt-addons-for-elementor' ),
				'rows' => 5,
				'dynamic' => [
					'active' => true,
				]
	...
	protected function __social_content_controls() {
		...
		$this->start_controls_section(
			'_section_social',
			[
				'label' => __( 'Social Profiles', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater->add_control(
			'name',
			[
				'label' => __( 'Profile Name', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'link', [
				'label' => __( 'Profile Link', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Add your profile link', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'email', [
				'label' => __( 'Email Address', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Add your email address', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'input_type' => 'email',
				'condition' => [
		...
		$repeater->add_control(
			'customize',
			[
				'label' => __( 'Want To Customize?', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'show_profiles',
			[
				'label' => __( 'Show Profiles', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
	...
	protected function __details_content_controls() {
		...
		$this->start_controls_section(
			'_section_button',
			[
				'label' => __( 'Details Button', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'show_details_button',
			[
				'label' => __( 'Show Button', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_lightbox',
			[
				'label' => __( 'Show Lightbox', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'style_transfer' => true,
				'options' => [
					'before' => __( 'Before Social Icons', 'skt-addons-for-elementor' ),
					'after' => __( 'After Social Icons', 'skt-addons-for-elementor' ),
				],
				'condition' => [
					'show_details_button' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Show Details', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type button text here', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'before' => [
						'title' => __( 'Before', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-h-align-left',
					],
					'after' => [
						'title' => __( 'After', 'skt-addons-for-elementor' ),
	...
	protected function __lightbox_content_controls() {
		...
		$this->start_controls_section(
			'_section_lightbox',
			[
				'label' => __( 'Lightbox', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'show_details_button' => 'yes',
					'show_lightbox' => 'yes'
		...
		$this->add_control(
			'saved_template_list',
			[
				'label' => __( 'Content Source', 'skt-addons-for-elementor' ),
				'description' => __( 'Select a saveed section to show in popup window.', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Lightbox Preview', 'skt-addons-for-elementor' ),
				'description' => __( 'This option only works on edit mode.', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'skt-addons-for-elementor' ),
				'label_off' => __( 'Hide', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'close_position',
			[
				'label' => __( 'Close Icon Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
	...
	protected function __body_content_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Name, Job Title & Bio', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'content_padding',
			[
				'label' => __( 'Content Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	...
	protected function __social_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Social Icons', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'links_spacing',
			[
				'label' => __( 'Right Spacing', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
	...
	protected function get_saved_content( $term = 'section' ) {
		...
		if ( count( $saved_contents ) > 0 ) {
			$options['0'] = __( 'None', 'skt-addons-for-elementor' );
			foreach ( $saved_contents as $saved_content ) {
				$content_id             = $saved_content['id'];
				$options[ $content_id ] = $saved_content['name'];
			}
		} else {
			$options['no_template'] = __( 'Nothing Found', 'skt-addons-for-elementor' );
		}
		return $options;
	}
		...
		<div class="skt-member-body">
			<?php if ( $settings['title'] ) :
				printf( '<%1$s %2$s>%3$s</%1$s>',
					esc_attr(skt_addons_elementor_escape_tags( $settings['title_tag'], 'h2' )), 
					wp_kses_post($this->get_render_attribute_string( 'title' )),
					esc_attr(skt_addons_elementor_kses_basic( $settings['title'] ))
				);
			endif; ?>
			...
			if ( $settings['show_lightbox_preview'] == 'yes' && skt_addons_elementor()->editor->is_edit_mode() ) {
				...
				<div <?php $this->print_render_attribute_string( 'lightbox' ); ?>>
					...
					<div class="skt-member-lightbox-inner">
						...
						<?php echo \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_template_list'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped   ?>
					</div>
				</div>
			<?php
		endif;
