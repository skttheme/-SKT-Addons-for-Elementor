...
class LordIcon extends Base {
	...
	public function get_title() {
		return __( 'LordIcon', 'skt-addons-for-elementor' );
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label'       => __( 'Icon Method', 'skt-addons-for-elementor' ),
				'options'     => [
					'cdn'  => esc_html__( 'Paste Lordicon URL', 'skt-addons-for-elementor' ),
					'file' => esc_html__( 'Upload Lordicon file', 'skt-addons-for-elementor' ),
				],
				'default'     => 'cdn',
				'label_block' => true,
			]
		...
		$this->add_control(
			...
			[
				...
				'label'       => __( 'Paste CDN', 'skt-addons-for-elementor' ),
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				...
				'label'       => __( 'JSON File', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::SELECT,
				'label'   => __( 'Animation Trigger', 'skt-addons-for-elementor' ),
				'options' => [
					'loop'          => esc_html__( 'Loop (infinite)', 'skt-addons-for-elementor' ),
					'click'         => esc_html__( 'Click', 'skt-addons-for-elementor' ),
					'hover'         => esc_html__( 'Hover', 'skt-addons-for-elementor' ),
					'loop-on-hover' => esc_html__( 'Loop on Hover', 'skt-addons-for-elementor' ),
					'morph'         => esc_html__( 'Morph', 'skt-addons-for-elementor' ),
					'morph-two-way' => esc_html__( 'Morph two way', 'skt-addons-for-elementor' ),
				],
				'default' => 'loop',
			]
		);
		$this->add_control(
			...
			[
				'type'    => Controls_Manager::SELECT,
				'label'   => __( 'Target', 'skt-addons-for-elementor' ),
				'options' => [
					'widget'  => __( 'On Widget', 'skt-addons-for-elementor' ),
					// 'icon' => __('On Icon', 'skt-addons-for-elementor' ),
					'column'  => __( 'On Column', 'skt-addons-for-elementor' ),
					'section' => __( 'On Section', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'type'        => Controls_Manager::TEXT,
				'label'       => __( 'Custom Target', 'skt-addons-for-elementor' ),
				'placeholder' => __( '.example', 'skt-addons-for-elementor' ),
				'default'     => __( '.example', 'skt-addons-for-elementor' ),
				'condition'   => [
					'target' => 'custom',
				],
			]
		...
		$this->add_control(
			'pulse_effect',
			[
				'label'        => esc_html__( 'Pulse Effect', 'skt-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => __( 'This will override your box shadow', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
				'default'      => '',
			]
		);
		$this->add_control(
			'pulse_color',
			[
				'label'     => __( 'Pulse Color', 'skt-addons-for-elementor' ),
	...
	protected function __icon_style_controls() {
		...
		$this->add_control(
			'primary_color',
			[
				'label'   => __( 'Primary Color', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#121331',
			]
		);
		...
		$this->add_control(
			'secondary_color',
			[
				'label'   => __( 'Secondary Color', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#08a88a',
			]
		);
		$this->add_control(
			'tertiary_color',
			[
				'label'   => __( 'Tertiary Color', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#0816A8',
			]
		);
		...
		$this->add_control(
			'quaternary_color',
			[
				'label'   => __( 'Quaternary Color', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#2CA808',
			]
		);
		...
		$this->add_control(
			'icon_stroke',
			[
				'label'   => __( 'Stroke', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::SLIDER,
				'range'   => [
					'min' => 1,
					'max' => 500,
