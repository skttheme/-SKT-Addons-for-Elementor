...
class Promo_Box extends Base {
	...
	public function get_title() {
		return __( 'Promo Box', 'skt-addons-for-elementor' );
	}
	...
	protected function __img_title_desc_content_controls() {
		...
		$this->start_controls_section(
			'_section_title',
			[
				'label' => __( 'Image, Title & Description', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'before_title',
			[
				'label' => __( 'Before Title', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __( 'Summer Deal', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
		...
		$this->add_control(
			'promo_link',
			[
				'label' => __( 'Promo Link', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'after_title',
			[
				'label' => __( 'After Title', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic' => [
					'active' => true
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __( 'Limited Stock. Grab your copy now', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
	...
	protected function __btn_badge_content_controls() {
		...
		$this->start_controls_section(
			'_section_button',
			[
				'label' => __( 'Button & Badge', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'badge_text_offer',
			[
				'label' => __( 'Offer', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '50%', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
			]
		...
		$this->add_control(
			'badge_text_detail',
			[
				'label' => __( 'Detail', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'OFF', 'skt-addons-for-elementor' ),
                'dynamic' => [
                    'active' => true,
                ]
			]
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'badge_position',
			[
				'label' => __( 'Badge Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'toggle' => false,
				'options' => [
					'top-left' => [
						'title' => __( 'Top Left', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-arrow-left',
					],
					'top-right' => [
						'title' => __( 'top Right', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-arrow-right',
					],
					'bottom-left' => [
						'title' => __( 'Bottom Left', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-arrow-left',
					],
					'bottom-right' => [
						'title' => __( 'Bottom Right', 'skt-addons-for-elementor' ),
						'icon' => 'eicon-arrow-right',
					],
				],
		...
		$this->add_control(
			'badge_animation',
			[
				'label' => __( 'Badge Animation', 'skt-addons-for-elementor' ),
	...
	protected function __common_style_controls() {
		...
		$this->add_responsive_control(
			'outer_spacing',
			[
				'label' => __( 'Outer Padding', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'glassy_background',
			[
				'label' => __( 'Glassy Background', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off' => __( 'No', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'inner_border_radius',
			[
				'label' => __( 'Inner Border Radius', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
	...
	protected function __img_desc_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Image & Description', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'image_resize',
			[
				'label' => __( 'Resize', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
