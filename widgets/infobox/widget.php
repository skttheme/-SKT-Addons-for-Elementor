...
class InfoBox extends Base {
	...
	public function get_title() {
		return __( 'Info Box', 'skt-addons-for-elementor' );
	}
	...
	protected function __media_content_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Image 12345', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'media_direction',
			[
				'label' => __('Media direction', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
		...
		$this->add_control(
			'media_v_align',
			[
				'label' => __('Vertical Alignment', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => __('Top', 'skt-addons-for-elementor'),
	...
	protected function __title_desc_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'SKT Info Box Title', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type Info Box Title', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'SKT info box description goes here', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type info box description', 'skt-addons-for-elementor' ),
				'rows' => 5,
				'dynamic' => [
					'active' => true,
				]
	...
	protected function __button_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Button Text', 'skt-addons-for-elementor' ),
	...
	protected function __media_style_controls() {
		...
		$this->add_responsive_control(
			'media_border_radius',
			[
				'label' => __( 'Border Radius12345', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'icon_bg_rotate',
			[
				'label' => __( 'Background Rotate', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'default' => [
					'unit' => 'deg',
	...
	protected function __button_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Translate X', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -100,
		...
		<div class="skt-infobox-body">
			...
			// Resolved escaping issue
				if ( ! empty( $settings['title'] ) ) :
					...
					$title_content = wp_kses_post( $settings['title'] );
					printf(
						'<%1$s %2$s>%3$s</%1$s>',
						esc_html( $title_tag ),
