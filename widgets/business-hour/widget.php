...
class Business_Hour extends Base {
	...
	public function get_title() {
		return __('Business Hour', 'skt-addons-for-elementor');
	}
	...
	protected function __business_hour_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Business Hour', 'skt-addons-for-elementor'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __('Working Hour', 'skt-addons-for-elementor'),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$repeater->add_control(
			'day',
			[
				'label' => __('Day', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('Monday', 'skt-addons-for-elementor'),
				'placeholder' => __('Monday', 'skt-addons-for-elementor'),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
				'placeholder' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
				'dynamic' => [
					'active' => true,
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'day' => __('Monday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Tuesday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Wednesday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Thursday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Friday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Saturday', 'skt-addons-for-elementor'),
						'time' => __('10:00AM - 07:00PM', 'skt-addons-for-elementor'),
					],
					[
						'day' => __('Sunday', 'skt-addons-for-elementor'),
						'time' => __('Closed', 'skt-addons-for-elementor'),
					],
				],
			]
		);
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'title_alignment',
			[
				'label' => __( 'Title Alignment', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'day_alignment',
			[
				'label' => __( 'Day Alignment', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
		...
		$this->add_control(
			'time_alignment',
			[
				'label' => __( 'Time Alignment', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
	...
	protected function __hour_list_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Hour List', 'skt-addons-for-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
