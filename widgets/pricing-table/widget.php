...
class Pricing_Table extends Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'skt-addons-for-elementor' );
	}
	...
	protected function __header_content_controls() {
		...
		$this->start_controls_section(
			'_section_header',
			[
				'label' => __( 'Header', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'default' => __( 'Basic', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
		...
		$this->add_control(
			'media_type',
			[
				'label' => __( 'Media Type', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'after_header'  => __( 'After Title', 'skt-addons-for-elementor' ),
					'before_header'  => __( 'Before Title', 'skt-addons-for-elementor' ),
				],
				'style_transfer' => true,
			]
		);
	...
	protected function __price_content_controls() {
		...
		$this->start_controls_section(
			'_section_pricing',
			[
				'label' => __( 'Pricing', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'currency',
			[
				'label' => __( 'Currency', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					''             => __( 'None', 'skt-addons-for-elementor' ),
					'baht'         => '&#3647; ' . _x( 'Baht', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'bdt'          => '&#2547; ' . _x( 'BD Taka', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'dollar'       => '&#36; ' . _x( 'Dollar', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'euro'         => '&#128; ' . _x( 'Euro', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'franc'        => '&#8355; ' . _x( 'Franc', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'guilder'      => '&fnof; ' . _x( 'Guilder', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'krona'        => 'kr ' . _x( 'Krona', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'lira'         => '&#8356; ' . _x( 'Lira', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'peseta'       => '&#8359 ' . _x( 'Peseta', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'peso'         => '&#8369; ' . _x( 'Peso', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'pound'        => '&#163; ' . _x( 'Pound Sterling', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'real'         => 'R$ ' . _x( 'Real', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'ruble'        => '&#8381; ' . _x( 'Ruble', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'rupee'        => '&#8360; ' . _x( 'Rupee', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'indian_rupee' => '&#8377; ' . _x( 'Rupee (Indian)', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'shekel'       => '&#8362; ' . _x( 'Shekel', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'won'          => '&#8361; ' . _x( 'Won', 'Currency Symbol', 'skt-addons-for-elementor' ),
					'yen'          => '&#165; ' . _x( 'Yen/Yuan', 'Currency Symbol', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'currency_custom',
			[
				'label' => __( 'Custom Symbol', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'currency' => 'custom',
				],
		...
		$this->add_control(
			'original_price',
			[
				'label' => __( 'Original Price', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => '8.99',
				'dynamic' => [
					'active' => true
		...
		$this->add_control(
			'period',
			[
				'label' => __( 'Period', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Per Month', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
		...
		$this->add_control(
			'currency_side',
			[
				'label' => __( 'Currency Position', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'after_header'  => __( 'After Header', 'skt-addons-for-elementor' ),
					'before_button'  => __( 'Before Button', 'skt-addons-for-elementor' ),
				],
				'style_transfer' => true,
			]
		);
	...
	protected function __features_desc_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Features & Description', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Title', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Features', 'skt-addons-for-elementor' ),
				'separator' => 'after',
				'dynamic' => [
					'active' => true
				]
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Exciting Feature', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
		...
		$repeater->add_control(
			'tooltip_text',
			[
				'label' => __( 'Tooltip Text', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true
				]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'icon' => 'fa fa-check',
						'text' => __( 'Standard Feature', 'skt-addons-for-elementor' ),
					],
					[
						'icon' => 'fa fa-check',
						'text' => __( 'Another Great Feature', 'skt-addons-for-elementor' ),
						'tooltip_text' => __( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.', 'skt-addons-for-elementor' ),
					],
					[
						'icon' => 'fa fa-close',
						'text' => __( 'Obsolete Feature', 'skt-addons-for-elementor' ),
					],
					[
						'icon' => 'fa fa-check',
						'text' => __( 'Exciting Feature', 'skt-addons-for-elementor' ),
					],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English.', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type description', 'skt-addons-for-elementor' ),
				'dynamic' => [
					'active' => true
				]
			]
		...
		$this->add_control(
			'features_alignment',
			[
				'label' => __( 'Features Alignment', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
	...
	protected function __footer_content_controls() {
		...
		$this->start_controls_section(
			'_section_footer',
			[
				'label' => __( 'Footer', 'skt-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Subscribe', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'footer_description',
			[
				'label' => __( 'Footer Description', 'skt-addons-for-elementor' ),
				'show_label' => true,
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
	...
	protected function __badge_content_controls() {
		...
		$this->add_control(
			'show_badge',
			[
				'label' => __( 'Show', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Recommended', 'skt-addons-for-elementor' ),
				'placeholder' => __( 'Type badge text', 'skt-addons-for-elementor' ),
				'condition' => [
					'show_badge' => 'yes'
				],
				'dynamic' => [
	...
	protected function __general_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'General', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'overflow',
			[
				'label' => __( 'Overflow', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'' => __( 'Default', 'skt-addons-for-elementor' ),
					'hidden' => __( 'Hidden', 'skt-addons-for-elementor' ),
				],
				'toggle' => false,
				'selectors' => [
	...
	protected function __header_style_controls() {
		...
		$this->add_control(
			'header_area_header',
			[
				'label' => __( 'Container', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			'icon_style_header',
			[
				'label' => __( 'Media', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function __pricing_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Pricing Area', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_responsive_control(
			'currency_spacing',
			[
				'label' => __( 'Side Spacing', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
	...
	protected function __features_desc_style_controls() {
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Features', 'skt-addons-for-elementor' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Container Bottom Spacing', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Container Padding', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Spacing Between', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
	...
	protected function __tooltip_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Features Tooltip', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function __footer_style_controls() {
		...
		$this->add_responsive_control(
			'button_translate_y',
			[
				'label' => __( 'Offset Y', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
	...
	protected function __badge_style_controls() {
		...
		$this->add_responsive_control(
			'badge_translate_x',
			[
				'label' => __( 'Offset X', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'badge_rotate_toggle',
			[
				'label' => __( 'Rotate', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'condition' => [
					'show_badge' => 'yes'
				],
		...
		$this->add_responsive_control(
			'badge_rotate_z',
			[
				'label' => __( 'Rotate Z', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
