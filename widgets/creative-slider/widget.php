...
class Creative_Slider extends Base {
	...
	public function get_title() {
		return __( 'Creative Slider', 'skt-addons-for-elementor' );
	}
	...
	public function __creative_slider_general_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Creative Slider', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			'cc_pre_title',
			[
				'label'   => __( 'Pre Title', 'skt-addons-for-elementor' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Pre Title', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'dynamic' => [
                    'active' => true,
                ],
		...
		$repeater->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Sub Title', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'dynamic' => [
                    'active' => true,
                ],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry...', 'skt-addons-for-elementor' ),
				'label_block' => true,
				'dynamic' => [
                    'active' => true,
                ],
		...
		$repeater->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Explore', 'skt-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'cc_image',
			[
				'label'   => __( 'Choose Slide Image', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				'label' => __('Backgroung Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => __('Hover Backgroung Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => __('Hover Text Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Border Type', 'skt-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				'label' => __('Hover Border Color', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Slider', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'cc_pre_title' => __( 'Pre title', 'skt-addons-for-elementor' ),
						'cc_title' => 'Title',
						'cc_sub_title' => 'Sub Title',
						'cc_description' => __('Lorem Ipsum is simply dummy text of the printing and typesettingLorem Ipsum is simply dummy text of the printing and typesetting industry.', 'skt-addons-for-elementor'),
						'cc_btn_text' => __('Explore', 'skt-addons-for-elementor'),
					],
					[
						'cc_pre_title' => __( 'Pre title', 'skt-addons-for-elementor' ),
						'cc_title' => 'Title',
	...
	public function __creative_slider_settings_controls() {
		...
		$this->add_responsive_control(
			'cs_image_width',
			[
				'label' => __('Slide Image Width', 'skt-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
		...
		$this->add_responsive_control(
			'disable_thumb_img',
			[
				'label' => __( 'Disable Thumbnail Image', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off' => __( 'No', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_flip_view',
			[
				'label' => __( 'Flip Slider', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off' => __( 'No', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'cs_desc_word_limit',
			[
				'label' => __( 'Description Word Limit', 'skt-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Next/Prev Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			'cs_prev_icon',
			[
				'label' => __( 'Prev Icon', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::ICONS,
				'label_block' => false,
				'skin' => 'inline',
				'exclude_inline_options' => ['svg','gif','png'],
	...
	protected function __creative_slider_next_prev_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Next/Prev Thumb', 'skt-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Advance Style', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'skt-addons-for-elementor' ),
				'label_off' => __( 'No', 'skt-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'cs_next_margin',
			[
				'label' => __( 'Next Margin', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'cs_prev_margin',
			[
				'label' => __( 'Prev Margin', 'skt-addons-for-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        <div class="skt_cc_prev_items owl-carousel owl-theme">
            <?php
				foreach ( $sliders as $key => $prevThumb ) { ?>
					<div class="skt_cc_prev_item elementor-repeater-item-<?php echo esc_attr($prevThumb['_id']); ?>">
						<img src="<?php echo esc_url($prevThumb['cc_image']['url']); ?>" alt="Prev Thumb" />
					</div>
				<?php }
			?>
        </div>
    ...
    <div class="skt_cc_inner_wrapper">
		...
		<?php
			foreach ( $sliders as $key => $textSlide ) { ?>
				...
				<div class="skt_cc_info_text_inner elementor-repeater-item-<?php echo esc_attr($textSlide['_id']); ?>">
					<div class="skt_cc_infotext_item">
						...
						<?php
							if( !empty( $textSlide['cc_pre_title'] ) ) { ?>
								<span class="skt_cc_info_text_item_category">
									...
									<?php echo esc_attr($textSlide['cc_pre_title']); ?>
								</span>
						<?php } if( !empty( $textSlide['cc_title'] ) ) { ?>
							<h3 class="skt_cc_info_text_title"><?php echo esc_html($textSlide['cc_title']); ?></h3>
						<?php } if( !empty( $textSlide['cc_sub_title'] )  ) { ?>
							<h4 class="skt_cc_info_text_sub_title"><?php echo esc_html($textSlide['cc_sub_title']); ?></h4>
						<?php } if( !empty( $textSlide['cc_description'] ) ) { ?>
							<p class="skt_cc_info_text_item_description"><?php echo esc_attr($this->skt_get_word_trim($textSlide['cc_description'], $settings['cs_desc_word_limit']));  ?></p>
						<?php } if( !empty( $textSlide['cc_btn_text'] ) ) { ?>
							<a class="skt_cc_info_text_item_btn" href="<?php echo esc_url(isset($textSlide['cc_btn_url']['url']) ? $textSlide['cc_btn_url']['url'] : ''); ?>" <?php echo esc_attr(($textSlide['cc_btn_url']['is_external']) ? 'target="_blank"' : ''); ?>>
								<?php echo esc_attr($textSlide['cc_btn_text']); ?>
							</a>
						<?php } ?>
        ...
        <div class="skt_cc_inner_image_items owl-carousel">
			<?php
				foreach ( $sliders as $key => $slide ) { ?>
					<div class="skt_cc_image_item elementor-repeater-item-<?php echo esc_attr($slide['_id']); ?>">
						<img src="<?php echo esc_url($slide['cc_image']['url']); ?>" alt="Creative Slider" />
					</div>
			<?php }
			?>
        </div>
            ...
            <div class="skt_cc_next_items owl-carousel">
				<?php
					foreach ( $sliders as $key => $nextThumb ) { ?>
						<div class="skt_cc_next_item elementor-repeater-item-<?php echo esc_attr($nextThumb['_id']); ?>">
							<img src="<?php echo esc_url($nextThumb['cc_image']['url']); ?>" alt="Next Thumb" />
						</div>
				<?php }
				?>
            </div>
